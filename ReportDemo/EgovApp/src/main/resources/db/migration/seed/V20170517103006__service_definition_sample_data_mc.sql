INSERT into egpgr_complainttype_category (id,code,name,description,version,tenantid) values (nextval('seq_egpgr_complainttype_category'),'MC','Marriage certificate','Marriage certificate',0,'default');
