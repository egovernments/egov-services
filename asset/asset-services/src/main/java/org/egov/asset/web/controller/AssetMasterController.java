...
public class AssetMasterController {
	...
	public Map<Status, Status> getAssetStatus(){
		Map<Status, Status> map = new HashMap<Status,Status>();
	...
	public Map<AssetCategoryType, AssetCategoryType> getAssetCategoryTypes(){
		...
		Map<AssetCategoryType, AssetCategoryType> map = new HashMap<AssetCategoryType,AssetCategoryType>();
	...
	public Map<DepreciationMethod, DepreciationMethod> getDepreciationMethod(){
		...
		Map<DepreciationMethod, DepreciationMethod> map = 
				new HashMap<DepreciationMethod,DepreciationMethod>();
	...
	public Map<ModeOfAcquisition, ModeOfAcquisition> getModeOfAcquisition(){
		...
		Map<ModeOfAcquisition, ModeOfAcquisition> map = new HashMap<ModeOfAcquisition,ModeOfAcquisition>();
