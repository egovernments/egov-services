...
@Configuration
@EnableKafka
public class TaxHeadMasterConsumerConfig {
	private static final Logger logger = LoggerFactory.getLogger(TaxHeadMasterConsumerConfig.class);
	 ...
	 @Value("${kafka.config.bootstrap_server_config}")
	    ...
	    @Bean
	    public TaxHeadMasterConsumer listener() {
	        return new TaxHeadMasterConsumer();
	    }
