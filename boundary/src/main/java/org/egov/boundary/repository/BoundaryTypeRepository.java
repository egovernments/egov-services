...
package org.egov.boundary.repository;
...
public interface BoundaryTypeRepository extends CrudRepository<BoundaryType, Long> {
	...
	BoundaryType findByCode(String code);  
}
