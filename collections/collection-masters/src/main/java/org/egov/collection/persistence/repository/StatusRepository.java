...
public class StatusRepository {
	@Autowired
	StatusQueryBuilder statusQueryBuilder;

	@Autowired
	JdbcTemplate jdbcTemplate;

	@Autowired
	StatusRowMapper statusRowMapper;

	public List<Status> getStatuses(StatusCriteria criteria) {
		List<Object> preparedStatementValues = new ArrayList<>();
		String queryString = statusQueryBuilder.getQuery(criteria, preparedStatementValues);
		return jdbcTemplate.query(queryString, preparedStatementValues.toArray(), statusRowMapper);
	}
