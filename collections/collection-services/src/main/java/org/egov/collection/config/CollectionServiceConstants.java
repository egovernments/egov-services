...
public class CollectionServiceConstants {
    ...
    public static final String ACCOUNT_CODE_EXCEPTION_MSG="Account codes couldn't be fetched";
    public static final String ACCOUNT_CODE_EXCEPTION_DESC="ISE while fetching account code id for instrument type, instrument service failed to return!";
