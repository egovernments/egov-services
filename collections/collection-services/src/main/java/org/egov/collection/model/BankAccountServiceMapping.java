...
public class BankAccountServiceMapping {
    ...
    public List<BankAccountServiceMapping> toDomainModelList(
            final List<org.egov.collection.web.contract.BankAccountServiceMapping> bankAccountServiceList,
            final RequestInfo requestInfo) {
        return bankAccountServiceList.stream()
                .map(bankAccountServiceMapping -> new BankAccountServiceMapping(bankAccountServiceMapping, requestInfo))
