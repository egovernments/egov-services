...
public class NotificationConsumer {
	...
	private String buildSmsBody(Instrument instrument, Bill bill, BillDetail billDetail, RequestInfo requestInfo) {
		...
		if(!StringUtils.isEmpty(content)) {
			...
			String taxName = fetchContentFromLocalization(requestInfo, billDetail.getTenantId(), 
					BUSINESSSERVICE_LOCALIZATION_MODULE, formatCodes(billDetail.getBusinessService()));
