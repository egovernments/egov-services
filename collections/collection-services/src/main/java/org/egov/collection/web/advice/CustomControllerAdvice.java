//package org.egov.collection.web.advice;
//
...
//import org.egov.collection.exception.InvalidDataException;
//import org.egov.collection.exception.UnauthorizedAccessException;
...
//	public ErrorResponse handleBindingErrors(ValidationException ex) {
//		ErrorResponse errRes = new ErrorResponse();
//
//		ResponseInfo responseInfo = new ResponseInfo();
//		responseInfo.setStatus(HttpStatus.BAD_REQUEST.toString());
