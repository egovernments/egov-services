...
public class ErrorHandler {
	...
	public ResponseEntity<ErrorResponse> exceptionHandler(Exception e) {
		if (LOGGER.isErrorEnabled())
			LOGGER.error("unexpected exception from the application is : " + e);
	...
	public ResponseEntity<ErrorResponse> getErrorResponseEntityForMissingRequestInfo(
	...
	public ResponseEntity<ErrorResponse> getErrorResponseEntityForMissingParameters(
			BindingResult bindingResult, RequestInfo requestInfo) {
		Error error = new Error();
		error.setCode(400);
	...
	public ResponseEntity<ErrorResponse> getResponseEntityForUnexpectedErrors(
			RequestInfo requestInfo) {
		Error error = new Error();
		error.setCode(500);
