...
VALUES (nextval('seq_egcl_clconfiguration'), 'RECEIPT_PREAPPROVED_OR_APPROVED', 
...
INSERT INTO egcl_configuration(id, keyname, description, createdby, createddate, lastmodifiedby, lastmodifieddate, tenantId) 
VALUES (nextval('seq_egcl_clconfiguration'), 'WORKFLOW_MANUAL_OR_AUTO', 
...
VALUES (nextval('seq_egcl_clconfigurationvalues'), (SELECT id from egcl_configuration WHERE keyname = 'RECEIPT_PREAPPROVED_OR_APPROVED'), 
...
INSERT INTO egcl_configurationvalues(id, keyid, value, effectivefrom, createdby, createddate, lastmodifiedby, lastmodifieddate, tenantId) 
VALUES (nextval('seq_egcl_clconfigurationvalues'), (SELECT id from egcl_configuration WHERE keyname = 'WORKFLOW_MANUAL_OR_AUTO'), 
