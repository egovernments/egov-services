...
//    private String mdmsHostUrl;
    ...
    @Value("${egov.services.egf.voucher.manual.receiptdate.enable}")
    private String manualReceiptDateUrl;
    
    @Value("${egov.services.master.mdms.search.url}")
    private String mdmsSearchUrl;
    
//    @Value("${egov.services.instrument.host}")
//    private String instrumentUrl;
    
//    @Value("${egov.services.eg-master.host}")
//    private String egfMasterUrl;
    ...
    @Value("${egov.service.reciept.voucher.default.tenantId}")
