...
@Getter
@Setter
public class ComplaintRouterSearchModel extends Auditable {
	...
	public ComplaintRouterSearchModel toDomain() {
		ComplaintRouterSearchModel router = new ComplaintRouterSearchModel();
	...
	public ComplaintRouterSearchModel toEntity(ComplaintRouterSearchModel router) {
