...
@Getter
@Setter
public class ComplaintRouterSearchEntity extends AuditableEntity {
	...
	public ComplaintRouterSearchEntity toEntity(ComplaintRouterModel router) {

		super.toEntity(router);
