...
@Getter
@Setter
public class WorkflowAction extends AuditableEntity {

    static final String SEQ_WF_ACTION = "SEQ_EG_WF_ACTION";
    public static final String TABLE_NAME = "eg_wf_action";
	public static final String SEQUENCE_NAME = "seq_eg_wf_action";
