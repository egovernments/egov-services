...
public class ProcessInstance {
	 ...
	 * getValueForKey("approvalComments"); }
	 * 
	 * @JsonIgnore public boolean isGrievanceOfficer() { return
	 * getValueForKey("userRole").equals("Grievance Officer"); }
	 */
	/*
	 * public void setStateId(Long stateId) { Value value = new Value("stateId",
	 * String.valueOf(stateId)); List<Value> attributeValues =
