...
'/accountdetailkeys/{id}/_update',null,(select id from service where name='Account Detail key' and contextroot='/egf-masters'),2,'Modify Account Detail Key',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/accountdetailkeys/_search',null,(select id from service where name='Account Detail key' and contextroot='/egf-masters'),3,'Search Account Detail Key',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/banks/{id}/_update',null,(select id from service where name='Bank_MS' and contextroot='/egf-masters'),3,'Modify Bank',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/banks/_search',null,(select id from service where name='Bank_MS' and contextroot='/egf-masters'),3,'Search Bank',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/bankaccounts/{id}/_update',null,(select id from service where name='Bankaccount' and contextroot='/egf-masters'),2,'Modify BankAccount',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/bankaccounts/_search',null,(select id from service where name='Bankaccount' and contextroot='/egf-masters'),3,'Search BankAccount',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/accountcodepurposes/{id}/_update',null,(select id from service where name='AccountCodePurpose' and contextroot='/egf-masters'),2,'Modify Account Code Purpose',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/accountcodepurposes/_search',null,(select id from service where name='AccountCodePurpose' and contextroot='/egf-masters'),3,'Search Account Code Purpose',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/suppliers/{id}/_update',null,(select id from service where name='Supplier' and contextroot='/egf-masters'),2,'Modify Supplier',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/suppliers/_search',null,(select id from service where name='Supplier' and contextroot='/egf-masters'),3,'Search Supplier',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/funds/{id}/_update',null,(select id from service where name='Fund_MS' and contextroot='/egf-masters'),2,'Modify Fund',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/funds/_search',null,(select id from service where name='Fund_MS' and contextroot='/egf-masters'),3,'Search Fund',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/subschemes/{id}/_update',null,(select id from service where name='SubScheme' and contextroot='/egf-masters'),2,'Modify SubScheme',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/subschemes/_search',null,(select id from service where name='SubScheme' and contextroot='/egf-masters'),3,'Search SubScheme',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/functions/{id}/_update',null,(select id from service where name='Function_MS' and contextroot='/egf-masters'),2,'Modify Function',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/functions/_search',null,(select id from service where name='Function_MS' and contextroot='/egf-masters'),3,'Search Function',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/budgetgroups/{id}/_update',null,(select id from service where name='BudgetGroup' and contextroot='/egf-masters'),2,'Modify Budget Group',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/budgetgroups/_search',null,(select id from service where name='BudgetGroup' and contextroot='/egf-masters'),3,'Search Budget Group',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/schemes/{id}/_update',null,(select id from service where name='Scheme' and contextroot='/egf-masters'),2,'Modify Scheme',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/schemes/_search',null,(select id from service where name='Scheme' and contextroot='/egf-masters'),3,'Search Scheme',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/bankbranches/{id}/_update',null,(select id from service where name='BankBranch' and contextroot='/egf-masters'),2,'Modify BankBranch',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/bankbranches/_search',null,(select id from service where name='BankBranch' and contextroot='/egf-masters'),3,'Search BankBranch',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/fundsources/{id}/_update',null,(select id from service where name='FundSource' and contextroot='/egf-masters'),2,'Modify Fund Source',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/fundsources/_search',null,(select id from service where name='FundSource' and contextroot='/egf-masters'),3,'Search Fund Source',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/functionaries/{id}/_update',null,(select id from service where name='Functionary' and contextroot='/egf-masters'),2,'Modify Functionary',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/functionaries/_search',null,(select id from service where name='Functionary' and contextroot='/egf-masters'),3,'Search Functionary',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/chartofaccounts/{id}/_update',null,(select id from service where name='ChartOfAccount' and contextroot='/egf-masters'),2,'Modify Chart Of Accounts',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/chartofaccounts/_search',null,(select id from service where name='ChartOfAccount' and contextroot='/egf-masters'),3,'Search Chart Of Accounts',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/chartofaccountdetails/{id}/_update',null,(select id from service where name='ChartOfAccountDetail' and contextroot='/egf-masters'),2,'Modify Chart Of Accounts Detail',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/chartofaccountdetails/_search',null,(select id from service where name='ChartOfAccountDetail' and contextroot='/egf-masters'),3,'Search Chart Of Accounts Detail',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/accountentities/{id}/_update',null,(select id from service where name='AccountEntiy' and contextroot='/egf-masters'),2,'Modify Account Entity',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/accountentities/_search',null,(select id from service where name='AccountEntiy' and contextroot='/egf-masters'),3,'Search Account Entity',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/financialyears/{id}/_update',null,(select id from service where name='FinancialYear' and contextroot='/egf-masters'),2,'Modify Financial Year',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/financialyears/_search',null,(select id from service where name='FinancialYear' and contextroot='/egf-masters'),3,'Search Financial Year',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/fiscalperiods/{id}/_update',null,(select id from service where name='FiscalPeriod' and contextroot='/egf-masters'),2,'Modify Fiscal Period',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/fiscalperiods/_search',null,(select id from service where name='FiscalPeriod' and contextroot='/egf-masters'),3,'Search Fiscal Period',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/accountdetailtypes/{id}/_update',null,(select id from service where name='AccountDetailType' and contextroot='/egf-masters'),2,'Modify Account Detail Type',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
...
'/accountdetailtypes/_search',null,(select id from service where name='AccountDetailType' and contextroot='/egf-masters'),3,'Search Account Detail Type',false,'/egf-masters',0,1,now(),1,now(),(select id from service where name='Financials_MS' and parentmodule is null));
