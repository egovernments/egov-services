...
insert into eg_action(id,name,url,servicecode,queryparams,parentmodule,ordernumber,displayname,enabled,createdby,createddate,lastmodifiedby,lastmodifieddate,tenantId)values(nextval('SEQ_EG_ACTION'),'ViewAssetCategory','/app/asset/search-asset-category.html','Asset Management',null,(select code from service where name='Asset Category' and tenantId='default'),2,'View Asset Category',true,1,now(),1,now(),'default');


insert into eg_action(id,name,url,servicecode,queryparams,parentmodule,ordernumber,displayname,enabled,createdby,createddate,lastmodifiedby,lastmodifieddate,tenantId)values(nextval('SEQ_EG_ACTION'),'ModifyAssetCategory','/app/asset/create-asset.html','Asset Management',null,(select code from service where name='Asset Category' and tenantId='default'),3,'Modify Asset Category',true,1,now(),1,now(),'default');
