...
insert into service (id, code, name, enabled, displayname, ordernumber, parentmodule, tenantId) values (nextval('SEQ_SERVICE'), 'PTIS_REPORTS', 'Reports', true, 'Reports', 6, (select id from service where name ='Property Tax' and code='PTIS' and tenantId='default'), 'default');
