...
insert into eg_action (id, name, url, servicecode, queryparams, parentmodule, ordernumber, displayname, enabled, createdby, createddate, lastmodifiedby, lastmodifieddate) values(nextval('SEQ_ACTION'),'Ageing By Department Report','/pgr-master/report/ageingByDeptReport','RPT',null,(select id from service where code='RPT' and tenantid ='default'),6,'Ageing By Department Report',true,1,now(),1,now());
insert into eg_action (id, name, url, servicecode, queryparams, parentmodule, ordernumber, displayname, enabled, createdby, createddate, lastmodifiedby, lastmodifieddate) values(nextval('SEQ_ACTION'),'Drill Down By Department Report','/pgr-master/report/drillDownByDeptReport','RPT',null,(select id from service where code='RPT' and tenantid ='default'),7,'Drill Down By Department Report',true,1,now(),1,now());
