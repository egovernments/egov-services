insert into eg_roleaction(roleCode, actionid, tenantId) select 'SUPERUSER', id, 'default' from eg_action where name='SearchDemand' and url = '/billing-service/demand/_search';
...
insert into eg_roleaction(roleCode, actionid, tenantId) select 'SUPERUSER', id, 'default' from eg_action where name='SearchBill' and url = '/billing-service/bill/_search';	
...
insert into eg_roleaction(roleCode, actionid, tenantId) select 'SUPERUSER', id, 'default' from eg_action where name='BS_SearchDemandDetail' and url = '/billing-service/demand/demanddetail/_search';	
