...
UPDATE eg_action SET ordernumber =5 WHERE servicecode = 'RPT' AND name='Grievance Type Wise Report';
UPDATE eg_action SET ordernumber =6 WHERE servicecode = 'RPT' AND name='Functionary Wise Report';
UPDATE eg_action SET ordernumber =7 WHERE servicecode = 'RPT' AND name='Router Escalation Report';
