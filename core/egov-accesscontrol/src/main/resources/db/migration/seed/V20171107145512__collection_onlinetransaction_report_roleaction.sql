...
values(nextval('SEQ_EG_ACTION'),'OnlineTransaction','/collection-services/report/_cash','COLLECTION-REPORTS',NULL, (select id from service where code ='COLLECTION-REPORTS' and tenantid='default'),1,'Online Transaction Report',true,1,now(),1,now());
