...
public class BaseRepositoryTest {
    ...
    @Test
    @Sql(scripts = {"/sql/clearAction.sql", "/sql/clearRole.sql", "/sql/insertActionData.sql", "/sql/insertRoleData.sql"})
    public void testActionValidationWhenAllowed() {
        ValidateActionCriteria criteria = ValidateActionCriteria.builder().
                roleNames(Arrays.asList("Citizen", "Super User")).
                tenantId("ap.public").
                actionUrl("/pgr/receivingmode").build();
    ...
    public void testActionValidationWhenNotAllowed() {
        ValidateActionCriteria criteria = ValidateActionCriteria.builder().
                roleNames(Arrays.asList("Employee")).
                tenantId("ap.public").
                actionUrl("/pgr/receivingmode").build();
    ...
    public void testShouldReturnActionForUserRole() throws Exception {
        ActionSearchCriteria actionSearchCriteria = ActionSearchCriteria.builder().
                tenantId("ap.public").
