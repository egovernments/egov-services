...
public class ActionFinderQueryBuilderTest {
    ...
    public void testQueryToFindRoles(){
        ActionSearchCriteria criteria = ActionSearchCriteria.builder().tenantId("ap.public").roleCodes(Arrays.asList("CITIZEN","EMPLOYEE")).build();
    ...
    public void testQueryToFindRolesWhenNoTenantId(){
        ActionSearchCriteria criteria = ActionSearchCriteria.builder().roleCodes(Collections.singletonList("CITIZEN")).build();
        ActionFinderQueryBuilder builder = new ActionFinderQueryBuilder(criteria);
