...
values(1,'Get all ReceivingMode','/pgr/receivingmode','PGR','tenantId=','PGR',1,'Get all ReceivingMode',false,1,now(),1,now(),'ap.public');
insert into eg_action(id, name,url,servicecode,queryparams,parentmodule,ordernumber,displayname,enabled,createdby,createddate,lastmodifiedby,lastmodifieddate,tenantId)
values(2,'Get all CompaintTypeCategory','/pgr/complaintTypeCategories','PGR','tenantId=','PGR',2,'Get all CompaintTypeCategory',false,1,now(),1,now(),'ap.public');
insert into eg_action(id, name,url,servicecode,queryparams,parentmodule,ordernumber,displayname,enabled,createdby,createddate,lastmodifiedby,lastmodifieddate,tenantId)
values(3,'Get ComplaintType by type,count and tenantId','/pgr/services','PGR','type=&count=&tenantId=','PgrComp',5,'Get ComplaintType by type,count and tenantId',false,1,now(),1,now(),'ap.public');
insert into eg_action(id, name,url,servicecode,queryparams,parentmodule,ordernumber,displayname,enabled,createdby,createddate,lastmodifiedby,lastmodifieddate,tenantId)
values(4,'Get all ReceivingCenters','/pgr/receivingcenter','PGR','tenantId=','PgrComp',4,'Get all ReceivingCenters',false,1,now(),1,now(),'ap.public');
