INSERT INTO eg_businesscategory(
  ...
  VALUES (nextval('seq_eg_businesscategory'),'Trade Application Fee','NEWTRADEAPPLICATIONFEE',true,'default',0,1,
...
INSERT INTO eg_businessdetails(
  ...
  true, 'NEWTRADEAPPLICATIONFEE','B','01','101500',null,null,'HD',false,(select id from eg_businesscategory where code='NEWTRADEAPPLICATIONFEE' 
