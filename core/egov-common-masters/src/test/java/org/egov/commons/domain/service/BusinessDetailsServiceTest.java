...
public class BusinessDetailsServiceTest {
	...
	public void test_should_create_businessDetails() {
		when(businessDetailsRepository.createBusinessDetails(getModelDetails(), getListOfModelAccountDetails(),
				getListOfModelAccountSubledger(), getAuthenticatedUser())).thenReturn(getBusinessDetailsCommonModel());
		BusinessDetailsCommonModel commanModel = businessDetailsService.createBusinessDetails(getModelDetails(),
	...
	public void test_should_update_businessDetails() {
		...
		when(businessDetailsRepository.updateBusinessDetails(getModelDetailsForUpdate(),
		...
		BusinessDetailsCommonModel commanModel = businessDetailsService.updateBusinessDetails(
				getModelDetailsForUpdate(), getListOfModelAccountDetailsForUpdate(),
	...
	public void test_should_verify_boolean_value_returned_isTrue_based_on_whether_nameAndtenantId_isPresent_inDB() {
		when(businessDetailsRepository.checkDetailsByNameAndTenantIdExists("Trade Licence", "default"))
				.thenReturn(true);
