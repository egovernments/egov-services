...
import org.egov.workflow.web.contract.RequestInfoBody;
...
public class ComplaintTypeRepository {
	...
	public ComplaintTypeResponse fetchComplaintTypeByCode(final String code, final String tenantId) {
		...
		return restTemplate.postForObject(url, request, ComplaintTypeServiceResponse.class, code, tenantId)
				.getComplaintTypes().get(0);
	}
