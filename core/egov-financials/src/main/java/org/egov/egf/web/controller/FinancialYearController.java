...
public class FinancialYearController {
	...
	public  FinancialYearContractResponse create(@RequestBody @Valid FinancialYearContractRequest financialYearContractRequest, BindingResult errors) {
	...
	public FinancialYearContractResponse update(@RequestBody @Valid FinancialYearContractRequest financialYearContractRequest, BindingResult errors,
	...
	@PutMapping
	@ResponseStatus(HttpStatus.OK)
	public FinancialYearContractResponse updateAll(@RequestBody @Valid FinancialYearContractRequest financialYearContractRequest, BindingResult errors) {
	...
	@ResponseBody
	@ResponseStatus(HttpStatus.OK)
	public FinancialYearContractResponse search(@ModelAttribute FinancialYearContractRequest financialYearContractRequest,BindingResult errors) {
