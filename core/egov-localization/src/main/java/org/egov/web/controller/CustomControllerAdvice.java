...
public class CustomControllerAdvice {
    ...
    public ErrorResponse handleDuplicateMessageIdentityException() {
        final ErrorField errorField =
            new ErrorField(DUPLICATE_MESSAGE_IDENTITY, UNIQUE_MESSAGE, DUPLICATE_MESSAGE_IDENTITY);
    ...
    public ErrorResponse handleMessagePersistException() {
        final ErrorField errorField =
            new ErrorField(PERSIST_FAILED_CODE, PERSIST_FAILED_MESSAGE, PERSIST_FAILED_CODE);
        return createErrorResponse(Collections.singletonList(errorField));
    }
    ...
    public ErrorResponse handleNotAuthenticatedException() {
        final ErrorField errorField =
            new ErrorField(NOT_AUTHENTICATED_CODE, NOT_AUTHENTICATED_MESSAGE, NOT_AUTHENTICATED_CODE);
        return createErrorResponse(Collections.singletonList(errorField));
    }
