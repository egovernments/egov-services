...
public interface BoundaryRepository extends JpaRepository<Boundary, Long> {
    ...
    List<Boundary> findBoundariesByBoundaryType_IdAndTenantId(@Param("boundaryTypeId") Long boundaryTypeId,
    ...
    List<Boundary> getBoundariesByBndryTypeNameAndHierarchyTypeNameAndTenantId(@Param("boundaryTypeName") String boundaryTypeName,
                                                                               @Param("hierarchyTypeName") String hierarchyTypeName, @Param("tenantId") String tenantId);
