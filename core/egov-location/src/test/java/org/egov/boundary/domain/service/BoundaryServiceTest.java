...
public class BoundaryServiceTest {
	...
	/*
	 * @Test public void
	 * TestShouldFetchBoundariesForBoundarytypeAndHierarchytypeName() {
	 * when(boundaryRepository.
	 * getBoundariesByBndryTypeNameAndHierarchyTypeNameAndTenantId("Ward",
	 * "ADMINISTRATION", "tenantId")) .thenReturn(getExpectedBoundaryDetails());
	 * 
	...
	/*
	 * @Test public void TestShouldFetchBoundariesForBoundarytypeAndTenantId() {
	 * when(boundaryRepository.
	 * findBoundariesByBoundaryType_IdAndBoundaryType_TenantIdAndTenantId(7L,
	 * "tenantId","tenantId")) .thenReturn(getExpectedBoundaryDetails());
	 * 
	 * List<Boundary> boundaryList =
	 * boundaryService.getAllBoundariesByBoundaryTypeIdAndTenantId(7L,
	 * "tenantId");
	 * 
	 * assertEquals("Election Ward No 1", boundaryList.get(0).getName()); }
	 */
