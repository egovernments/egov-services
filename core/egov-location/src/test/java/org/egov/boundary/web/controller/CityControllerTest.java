...
public class CityControllerTest {
	...
	public void test_should_fetch_city_for_given_cityrequest() throws Exception {
		...
		final City expectedCity = City.builder().code("KC").name("Kurnool").domainURL("Localhost").grade("Grade A")
		...
		mockMvc.perform(get("/city/getCitybyCityRequest?city.id=1").header("X-CORRELATION-ID", "someId")
    ...
    public void test_should_return_bad_request_when_city_request_is_empty() throws Exception {
        ...
        mockMvc.perform(get("/city/getCitybyCityRequest").header("X-CORRELATION-ID", "someId")
