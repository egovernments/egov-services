alter table eg_address disable trigger user;
...
alter table eg_address enable trigger user;


alter table eg_userrole disable trigger user;
...
alter table eg_userrole enable trigger user;

alter table eg_user disable trigger user;
...
alter table eg_user enable trigger user;
