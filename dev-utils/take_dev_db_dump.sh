...
kubectl exec -it --namespace=playground ${playground_pod} -- pg_dump -d  egov_dev_ms -U egovdev  -h egov-micro-dev.c6byfp0h9w3r.us-east-1.rds.amazonaws.com --no-owner> /tmp/${local_dump}
