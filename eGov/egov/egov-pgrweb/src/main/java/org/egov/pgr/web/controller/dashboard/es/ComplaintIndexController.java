...
public class ComplaintIndexController {
    ...
    @RequestMapping(value = "/nested", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    public SearchResponse getFromUlbList() throws JsonProcessingException {
        return  complaintIndexRepository.findAllFromUlb();
