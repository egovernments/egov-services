...
<div class="row">
	...
	<div class="tour-section" data-toggle="tooltip" title="Click for demo!"><i class="fa fa-question" aria-hidden="true"></i></div>
		<form:form role="form" action="#" modelAttribute="complaint" commandName="complaint" id="complaintform" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
				...
				<div class="panel-body custom-form ">
					<div class="form-group">
						...
						<div class="col-sm-6 add-margin">
							<form:input  class="form-control patternvalidation" path="complainant.name" data-api-key="first_name" id="f-name" placeholder="Name" data-pattern="alphabetwithspace" required="required"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-2 add-margin">
							<div class="input-group">
								<span class="input-group-addon">+91</span>
								  	<form:input path="complainant.mobile"  data-api-key="mobile" class="form-control is_valid_number" maxlength="10" data-inputmask="'mask': '9999999999'" id="mob-no" placeholder="Mobile Number" required="required"/>
							</div>
						...
						<div class="col-sm-3">
							<form:input  path="complainant.email" class="form-control" data-api-key="email" id="email" placeholder="abc@xyz.com" type="email"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<form:textarea path="complainant.address" data-api-key="requester_address" id="address" placeholder="" maxlength="256" cssClass="form-control autogrow" />
			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body custom-form ">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 add-margin">
							<form:select path="complaintType.category" id="complaintTypeCategory" data-api-key="group"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<form:select path="complaintType" id="complaintType" data-api-key="service_code"
								cssClass="form-control" cssErrorClass="form-control error" required="required">
								<form:option value="">
									<spring:message code="lbl.select" />
								</form:option>
			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body custom-form ">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<form:textarea path="details" data-api-key="description" id="doc" minlength="10" placeholder="Give more details about the complaint to help us solve your issue" maxlength="500" cssClass="form-control autogrow" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<form:textarea path="landmarkDetails" class="form-control" data-api-key="address" id="landmarkDetails" placeholder="" maxlength="200"/>
			...
			<div class="row">
				<div class="text-center">
					<button type="submit" class="btn btn-primary" id="create-anonymous-grievance"><spring:message code="title.complaint.reg"/></button>
...
<div id = "success" hidden="true">
 <%@ include file="../../complaint/reg-success.jsp"%>
</div>
