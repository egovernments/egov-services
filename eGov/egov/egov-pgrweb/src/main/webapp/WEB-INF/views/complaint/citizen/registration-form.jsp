		...
		<form:form role="form" action="register" modelAttribute="complaint" commandName="complaint" id="complaintform" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body custom-form ">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<form:textarea path="details" id="doc" data-api-key="description" placeholder="Give more details about the complaint to help us solve your issue" minlength="10" maxlength="500" cssClass="form-control autogrow" required="required"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<form:textarea path="landmarkDetails" class="form-control" id="landmarkDetails" data-api-key="address" placeholder="" maxlength="200"/>
			...
			<div class="row">
				<div class="text-center">
					<button type="button" class="btn btn-primary" id="create-griev"><spring:message code="title.complaint.reg"/></button>
