...
public class FileStoreService {
	 ...
	 private FileStoreMapperRepository fileStoreMapperRepository;
	    ...
	    public FileStoreService() {
	      /*  if (applicationProperties.fileStoreBaseDir().isEmpty())*/
	    	 ...
	    	 this.fileStoreBaseDir = "/home/parvati" + separator + "egovfilestore";
	       /* else
	...
	public FileStoreMapper store(File sourceFile, String fileName, String mimeType, String moduleName,String tanent) {
	    ...
	    public FileStoreMapper store(InputStream sourceFileStream, String fileName, String mimeType, String moduleName,String tanent) {
	        return store(sourceFileStream, fileName, mimeType, moduleName, true,tanent);
	    }
	 
	    public FileStoreMapper store(InputStream fileStream, String fileName, String mimeType, String moduleName, boolean closeStream,String tanent) {
	        try {
    ...
    public FileStoreMapper store(File file, String fileName, String mimeType, String moduleName, boolean deleteFile,String tanent) {
        try {
    ...
    private Path getFileDirectoryPath(String moduleName) {
        return Paths.get(new StringBuilder().append(this.fileStoreBaseDir).append(separator).
                append("1016").append(separator).append(moduleName).toString());
    }
