...
@Entity
@Table(name = "egf_bank")
@SequenceGenerator(name = BankEntity.SEQ_BANK, sequenceName = BankEntity.SEQ_BANK, allocationSize = 1)
public class  BankEntity extends AbstractAuditable {
	...
	public Bank mapContract(Bank bank) {
		 bank.setId(id);
		 bank.setCode(code);
		 bank.setName(name);
