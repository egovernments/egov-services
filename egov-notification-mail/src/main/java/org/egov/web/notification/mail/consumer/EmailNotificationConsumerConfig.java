...
import org.egov.web.notification.mail.transform.EmailRequestDeserializer;
...
public class EmailNotificationConsumerConfig {
	...
	public Map<String, Object> consumerConfigs() {
		...
		propsMap.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, EmailRequestDeserializer.class);
		return propsMap;
	}

	@Bean
	public EmailNotificationListener listener() {
