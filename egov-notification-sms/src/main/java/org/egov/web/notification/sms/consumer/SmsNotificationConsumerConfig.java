...
import org.egov.web.notification.sms.transform.SmsRequestDeserializer;
...
@Configuration
@EnableKafka
public class SmsNotificationConsumerConfig {
	...
	public Map<String, Object> consumerConfigs() {
		...
		propsMap.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, SmsRequestDeserializer.class);
		return propsMap;
	}

	@Bean
	public SmsNotificationListener listener() {
