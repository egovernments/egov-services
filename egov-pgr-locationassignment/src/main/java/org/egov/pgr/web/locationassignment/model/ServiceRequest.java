package org.egov.pgr.web.locationassignment.model;
...
public class ServiceRequest {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.crn, serviceRequest.crn) && Objects.equals(this.status, serviceRequest.status)
				...
				&& Objects.equals(this.zipcode, serviceRequest.zipcode) && Objects.equals(this.lat, serviceRequest.lat)
				...
				&& Objects.equals(this.phone, serviceRequest.phone) && Objects.equals(this.email, serviceRequest.email)
	...
	@Override
	public int hashCode() {
		return Objects.hash(crn, status, statusDetails, complaintTypeName, complaintTypeCode, details,
				agencyResponsible, serviceNotice, createdDate, lastModifiedDate, escalationDate, landmarkDetails,
				crossHierarchyId, zipcode, lat, lng, mediaUrl, firstName, lastName, phone, email, deviceId, accountId);
	}
