...
package org.egov.pgr.rest.web.controller.core;

import org.egov.infra.web.support.json.adapter.HibernateProxyTypeAdapter;
import org.egov.pgr.rest.web.adapter.DataAdapter;
...
public class PgrRestResponse {
    ...
    public PgrRestResponse() {
        status = new JsonObject();
    }

    public static PgrRestResponse newInstance() {
        return new PgrRestResponse();
    }
    ...
    public PgrRestResponse setFormat(String format) {
        this.format = format;
        return this;
    }
    ...
    public PgrRestResponse setDataAdapter(DataAdapter<?> dataAdapter) {
        this.dataAdapter = dataAdapter;
        return this;
    }

    public PgrRestResponse putStatusAttribute(String key, String value) {
