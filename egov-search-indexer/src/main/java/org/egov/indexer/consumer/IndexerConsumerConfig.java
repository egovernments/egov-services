...
public class IndexerConsumerConfig {
    ...
    @Bean
    KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Map<String, Object>>> kafkaListenerContainerFactory() {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        propsMap.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ComplaintIndexDeserializer.class);
        return propsMap;
    }
