...
import org.egov.web.indexer.transform.SevaRequestDeserializer;
...
@Configuration
@EnableKafka
public class IndexerConsumerConfig {
	...
	@Bean
	KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Map<String, SevaRequest>>> kafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, Map<String, SevaRequest>> factory = new ConcurrentKafkaListenerContainerFactory<>();
	...
	@Bean
	public ConsumerFactory<String, Map<String, SevaRequest>> consumerFactory() {
