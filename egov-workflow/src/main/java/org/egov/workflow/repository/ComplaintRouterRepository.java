...
import org.egov.workflow.entity.Position;
...
public interface ComplaintRouterRepository extends JpaRepository<ComplaintRouter, Long> {
    ...
    public ComplaintRouter findByComplaintType_CodeAndBoundary_Id(String complaintTypeCode, Long location);

    @Query("select cr from ComplaintRouter cr where cr.complaintType.code=:complaintTypeCode and cr.boundary is null")
    public ComplaintRouter findByOnlyComplaintType_Code(@Param("complaintTypeCode") String complaintTypeCode);
