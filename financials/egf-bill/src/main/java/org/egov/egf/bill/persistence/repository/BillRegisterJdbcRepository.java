...
public class BillRegisterJdbcRepository extends JdbcRepository {
    ...
    public BillRegisterJdbcRepository(NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
	...
	if (billRegisterSearchEntity.getSortBy() != null && !billRegisterSearchEntity.getSortBy().isEmpty()) {
	    validateSortByOrder(billRegisterSearchEntity.getSortBy());
	    validateEntityFieldName(billRegisterSearchEntity.getSortBy(), BillRegisterEntity.class);
	}
	String orderBy = "order by name";
	if (billRegisterSearchEntity.getSortBy() != null && !billRegisterSearchEntity.getSortBy().isEmpty()) {
	    orderBy = "order by " + billRegisterSearchEntity.getSortBy();
	}
	searchQuery = searchQuery.replace(":tablename", BillRegisterEntity.TABLE_NAME);
	...
	if (billRegisterSearchEntity.getBillSubType() != null) {
	    ...
	    paramValues.put("billSubType", billRegisterSearchEntity.getBillSubType());
	}
	if (billRegisterSearchEntity.getBillNumber() != null) {
	    if (params.length() > 0)
		params.append(" and ");
	    params.append("billNumber =:billNumber");
	    paramValues.put("billNumber", billRegisterSearchEntity.getBillNumber());
	}
	...
	if (billRegisterSearchEntity.getBillAmount() != null) {
	    ...
	    paramValues.put("billAmount", billRegisterSearchEntity.getBillAmount());
	}
	if (billRegisterSearchEntity.getPassedAmount() != null) {
	    if (params.length() > 0)
		params.append(" and ");
	    params.append("passedAmount =:passedAmount");
	    paramValues.put("passedAmount", billRegisterSearchEntity.getPassedAmount());
	}
	if (billRegisterSearchEntity.getModuleName() != null) {
	    if (params.length() > 0)
		params.append(" and ");
	    params.append("moduleName =:moduleName");
	    paramValues.put("moduleName", billRegisterSearchEntity.getModuleName());
	}
	...
	if (billRegisterSearchEntity.getFunctionId() != null) {
	    ...
	    paramValues.put("function", billRegisterSearchEntity.getFunctionId());
	}
	if (billRegisterSearchEntity.getFundsourceId() != null) {
	    if (params.length() > 0)
		params.append(" and ");
	    params.append("fundsource =:fundsource");
	    paramValues.put("fundsource", billRegisterSearchEntity.getFundsourceId());
	}
	...
	List<BillRegisterEntity> billRegisterEntities = namedParameterJdbcTemplate.query(searchQuery.toString(),
		paramValues, row);
	...
	List<BillRegisterEntity> billregisters = namedParameterJdbcTemplate.query(
		getByIdQuery.get(entity.getClass().getSimpleName()).toString(), paramValues,
		new BeanPropertyRowMapper(BillRegisterEntity.class));
