...
@JsonPropertyOrder({ "id","orderId","chartOfAccount","glcode","debitAmount","creditAmount","function","billPayeeDetails"})
public class BillDetailContract extends AuditableContract {
