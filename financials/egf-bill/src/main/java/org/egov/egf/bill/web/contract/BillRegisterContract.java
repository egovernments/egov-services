...
@JsonPropertyOrder({ "id","billType","billSubType","billNumber","billDate","billAmount","passedAmount","moduleName","status","fund","function","fundsource","scheme","subScheme","functionary","division","department","sourcePath","budgetCheckRequired","budgetAppropriationNo","partyBillNumber","partyBillDate","description","billDetails","checkLists"})
public class BillRegisterContract extends AuditableContract {
