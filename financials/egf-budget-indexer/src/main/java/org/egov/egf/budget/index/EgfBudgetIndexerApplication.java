package org.egov.egf.budget.index;

import java.text.SimpleDateFormat;
import java.util.List;

import org.egov.egf.budget.index.web.interceptor.CorrelationIdInterceptor;
...
public class EgfBudgetIndexerApplication {

	public static void main(String[] args) {
		SpringApplication.run(EgfBudgetIndexerApplication.class, args);
	}
