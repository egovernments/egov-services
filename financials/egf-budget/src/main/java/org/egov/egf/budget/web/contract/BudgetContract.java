...
public class BudgetContract extends AuditableContract {
    ...
    /**
     * financialYear is the attribute to identify to which year the BudgetContract belongs is tagged.
     */
    @NotNull
    ...
    /**
     * primaryBudgetContract is the flag that identifies the root budget. (which has no parent).
     */
    @NotNull
    private Boolean primaryBudget;

    /**
     * referenceBudgetContract is the previous year budget tree id reference to refer previous year budget. When the BE is
     * created, the previous year RE reference is mapped to the BE of current year or for the year for which BE is created.
     */
     ...
     * type,budget type and financial year. example description "ENGINEERING RE RevenueBudgetContract for the year 2015-16"
