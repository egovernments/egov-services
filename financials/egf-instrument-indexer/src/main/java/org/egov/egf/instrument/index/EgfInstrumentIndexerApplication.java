package org.egov.egf.instrument.index;

import java.text.SimpleDateFormat;
import java.util.List;

import org.egov.egf.instrument.index.web.interceptor.CorrelationIdInterceptor;
...
public class EgfInstrumentIndexerApplication {

	public static void main(String[] args) {
		SpringApplication.run(EgfInstrumentIndexerApplication.class, args);
	}
