...
public class InstrumentVoucherRepository {
	...
	@Autowired
	private MastersQueueRepository instrumentVoucherQueueRepository;

	public InstrumentVoucher findById(InstrumentVoucher instrumentVoucher) {
		InstrumentVoucherEntity entity = instrumentVoucherJdbcRepository.findById(new InstrumentVoucherEntity().toEntity(instrumentVoucher));
	...
	public InstrumentVoucher save(InstrumentVoucher instrumentVoucher) {
		InstrumentVoucherEntity entity = instrumentVoucherJdbcRepository.create(new InstrumentVoucherEntity().toEntity(instrumentVoucher));
		return entity.toDomain();
	}

	@Transactional
	public InstrumentVoucher update(InstrumentVoucher instrumentVoucher) {
		InstrumentVoucherEntity entity = instrumentVoucherJdbcRepository.update(new InstrumentVoucherEntity().toEntity(instrumentVoucher));
		return entity.toDomain();
	}
