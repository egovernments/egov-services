...
public class InstrumentTypePropertyJdbcRepositoryTest {
	 ...
	 * test_search() {
	 * 
	 * Pagination<InstrumentTypeProperty> page =
	 * (Pagination<InstrumentTypeProperty>) instrumentTypePropertyJdbcRepository
	 * .search(getInstrumentTypePropertySearch());
	 * 
	 * assertThat(page.getPagedData().get(0).getActive()).isEqualTo(true);
	 * assertThat(page.getPagedData().get(0).getName()).isEqualTo("name");
	 * assertThat(page.getPagedData().get(0).getDescription()).isEqualTo(
	 * "description");
	 * 
	 * }
	 */
	 ...
	 * Pagination<InstrumentTypeProperty> page =
	 * (Pagination<InstrumentTypeProperty>) instrumentTypePropertyJdbcRepository
	 * .search(getInstrumentTypePropertySearch1());
	 ...
	 * @Sql(scripts = { "/sql/instrumenttypeproperty/clearInstrumentTypeProperty.sql",
	 * "/sql/instrumenttypeproperty/insertInstrumentTypePropertyData.sql" }) public void
	 * test_search_invalid_sort_option() {
	 * 
	 * InstrumentTypePropertySearch search = getInstrumentTypePropertySearch();
	 ...
	 * @Sql(scripts = { "/sql/instrumenttypeproperty/clearInstrumentTypeProperty.sql",
	 * "/sql/instrumenttypeproperty/insertInstrumentTypePropertyData.sql" }) public void
	 * test_search_without_pagesize_offset_sortby() {
	 * 
	 * InstrumentTypePropertySearch search = getInstrumentTypePropertySearch();
	 * search.setSortBy(null); search.setPageSize(null); search.setOffset(null);
	 * Pagination<InstrumentTypeProperty> page =
	 * (Pagination<InstrumentTypeProperty>) instrumentTypePropertyJdbcRepository
	 * .search(getInstrumentTypePropertySearch());
	 * assertThat(page.getPagedData().get(0).getActive()).isEqualTo(true);
	...
	/*
	 * private InstrumentTypePropertySearch getInstrumentTypePropertySearch1() {
	 * InstrumentTypePropertySearch instrumentTypePropertySearch = new
	 * InstrumentTypePropertySearch(); instrumentTypePropertySearch.setId("id");
	 * instrumentTypePropertySearch.setName("name");
	 * instrumentTypePropertySearch.setDescription("description");
	 * instrumentTypePropertySearch.setActive(true);
	 * instrumentTypePropertySearch.setTenantId("tenantId");
	 * instrumentTypePropertySearch.setPageSize(500);
	 * instrumentTypePropertySearch.setOffset(0);
	 * instrumentTypePropertySearch.setSortBy("name desc"); return
	 * instrumentTypePropertySearch; }
	 * 
	 * private InstrumentTypePropertySearch getInstrumentTypePropertySearch() {
	 * InstrumentTypePropertySearch instrumentTypePropertySearch = new
	 * InstrumentTypePropertySearch();
	 * instrumentTypePropertySearch.setName("name");
	 * instrumentTypePropertySearch.setDescription("description");
