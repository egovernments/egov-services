...
public class InstrumentVoucherJdbcRepositoryTest {
	 ...
	 * 
	 * @Sql(scripts = { "/sql/instrumentvoucher/clearInstrumentVoucher.sql",
	 * "/sql/instrumentvoucher/insertInstrumentVoucherData.sql" }) public void
	 * test_search() {
	 * 
	 * Pagination<InstrumentVoucher> page = (Pagination<InstrumentVoucher>)
	 ...
	 * 
	 * Pagination<InstrumentVoucher> page = (Pagination<InstrumentVoucher>)
	 * instrumentVoucherJdbcRepository .search(getInstrumentVoucherSearch1());
	 ...
	 * search.setSortBy("desc"); instrumentVoucherJdbcRepository.search(search);
	 * 
	 * }
	 * 
	 * @Test
	 ...
	 * InstrumentVoucherSearch instrumentVoucherSearch = new
	 * InstrumentVoucherSearch(); instrumentVoucherSearch.setId("id");
	 * instrumentVoucherSearch.setName("name");
	 * instrumentVoucherSearch.setDescription("description");
	 * instrumentVoucherSearch.setActive(true);
	 * instrumentVoucherSearch.setTenantId("tenantId");
	 * instrumentVoucherSearch.setPageSize(500);
	 * instrumentVoucherSearch.setOffset(0); instrumentVoucherSearch.setSortBy(
	 * "name desc"); return instrumentVoucherSearch; }
	 * 
	 * private InstrumentVoucherSearch getInstrumentVoucherSearch() {
	 * InstrumentVoucherSearch instrumentVoucherSearch = new
	 * InstrumentVoucherSearch(); instrumentVoucherSearch.setName("name");
	 * instrumentVoucherSearch.setDescription("description");
	 * instrumentVoucherSearch.setActive(true);
	 * instrumentVoucherSearch.setPageSize(500);
	 * instrumentVoucherSearch.setOffset(0); instrumentVoucherSearch.setSortBy(
