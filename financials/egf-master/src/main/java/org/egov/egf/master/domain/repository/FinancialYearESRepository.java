...
@Service
public class FinancialYearESRepository {
	...
	private SearchRequestBuilder getSearchRequest(FinancialYearSearchContract criteria) {
		...
		final SearchRequestBuilder searchRequestBuilder = esClient.prepareSearch(FinancialYear.class.getSimpleName().toLowerCase()).setTypes(FinancialYear.class.getSimpleName().toLowerCase())
