...
public class ChartOfAccountDetailEntity extends AuditableEntity {
	...
	public ChartOfAccountDetailEntity toEntity(ChartOfAccountDetail chartOfAccountDetail) {
		...
		this.chartOfAccountId = chartOfAccountDetail.getChartOfAccount() != null
				? chartOfAccountDetail.getChartOfAccount().getId() : null;
		this.accountDetailTypeId = chartOfAccountDetail.getAccountDetailType() != null
				? chartOfAccountDetail.getAccountDetailType().getId() : null;
		return this;
	}
