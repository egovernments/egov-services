...
public class ChartOfAccountDetailSearchEntity extends ChartOfAccountDetailEntity { private String ids; 
private String  sortBy; 
private Integer pageSize; 
private Integer offset; 
public ChartOfAccountDetail toDomain(){ 
ChartOfAccountDetail chartOfAccountDetail = new ChartOfAccountDetail (); 
super.toDomain( chartOfAccountDetail);return chartOfAccountDetail ;}
...
this.pageSize=chartOfAccountDetailSearch.getPageSize(); this.offset=chartOfAccountDetailSearch.getOffset(); this.sortBy=chartOfAccountDetailSearch.getSortBy(); this.ids=chartOfAccountDetailSearch.getIds(); return this;} 
