package org.egov.egf.master.domain.respository;
...
public class ChartOfAccountDetailRepositoryTest {
	...
	public void testFindById() {
		...
		when(chartofAccountDetailJdbcRepository.findById(any(ChartOfAccountDetailEntity.class))).thenReturn(chartOfAccountDetailEntity);
	...
	public void testSave() {
		ChartOfAccountDetailEntity chartOfAccountDetailEntity = getChartOfAccountDetailEntity();
		ChartOfAccountDetail expectedResult = chartOfAccountDetailEntity.toDomain();
		when(chartofAccountDetailJdbcRepository.create(any(ChartOfAccountDetailEntity.class))).thenReturn(chartOfAccountDetailEntity);
	...
	public void testUpdate() {
		ChartOfAccountDetailEntity chartOfAccountDetailEntity = getChartOfAccountDetailEntity();
		ChartOfAccountDetail expectedResult = chartOfAccountDetailEntity.toDomain();
		when(chartofAccountDetailJdbcRepository.update(any(ChartOfAccountDetailEntity.class))).thenReturn(chartOfAccountDetailEntity);
