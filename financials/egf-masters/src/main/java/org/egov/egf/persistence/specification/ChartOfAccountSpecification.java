...
public class ChartOfAccountSpecification implements Specification<ChartOfAccount> {
    ...
    public Predicate toPredicate(Root<ChartOfAccount> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        ...
        if (criteria != null) {
            ...
            /*
             * if (criteria.getParentId() != null) { predicates.add(criteriaBuilder.equal(parentId, criteria.getParentId())); }
             */
            ...
            /*
             * if (criteria.getChartOfAccountDetails() != null) { predicates.add(criteriaBuilder.equal(chartOfAccountDetails,
