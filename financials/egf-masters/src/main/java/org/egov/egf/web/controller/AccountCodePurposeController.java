...
public class AccountCodePurposeController {
    ...
    public AccountCodePurposeContractResponse create(
            @RequestBody @Valid AccountCodePurposeContractRequest accountCodePurposeContractRequest, BindingResult errors) {
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.OK)
    public AccountCodePurposeContractResponse search(@ModelAttribute AccountCodePurposeContract accountCodePurposeContracts,
