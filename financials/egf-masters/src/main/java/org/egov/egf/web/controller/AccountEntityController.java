...
public class AccountEntityController {
    ...
    public AccountEntityContractResponse create(@RequestBody @Valid AccountEntityContractRequest accountEntityContractRequest,
    ...
    public AccountEntityContractResponse update(@RequestBody @Valid AccountEntityContractRequest accountEntityContractRequest,
            BindingResult errors,
    ...
    @PutMapping
    @ResponseStatus(HttpStatus.OK)
    public AccountEntityContractResponse updateAll(@RequestBody @Valid AccountEntityContractRequest accountEntityContractRequest,
            BindingResult errors) {
