package org.egov.egf.voucher.index;

import java.text.SimpleDateFormat;
import java.util.List;

import org.egov.egf.voucher.index.web.interceptor.CorrelationIdInterceptor;
...
public class EgfVoucherIndexerApplication {

	public static void main(String[] args) {
		SpringApplication.run(EgfVoucherIndexerApplication.class, args);
	}
