...
public class VoucherESRepository extends ESRepository {
    ...
    public BoolQueryBuilder boolQueryBuilderForVouchers(VoucherSearchContract voucherSearchContract) {
        ...
        if (voucherSearchContract.getIds() != null && !voucherSearchContract.getIds().isEmpty())
            elasticSearchUtils.add(voucherSearchContract.getIds(), "id", boolQueryBuilder);

        if (voucherSearchContract.getVoucherNumbers() != null && !voucherSearchContract.getVoucherNumbers().isEmpty())
            elasticSearchUtils.add(voucherSearchContract.getVoucherNumbers(), "voucherNumber", boolQueryBuilder);

        if (voucherSearchContract.getNames() != null && !voucherSearchContract.getNames().isEmpty())
            elasticSearchUtils.add(voucherSearchContract.getVoucherNumbers(), "name", boolQueryBuilder);
...
//            elasticSearchUtils.add(voucherSearchContract.getTypes(), "type", boolQueryBuilder);
        ...
        elasticSearchUtils.add(voucherSearchContract.getSubLedgerAmount(), "ledgers.ledgerDetails.amount",
                boolQueryBuilder);

        elasticSearchUtils.add(voucherSearchContract.getAccountDetailKeyId(),
                "ledgers.ledgerDetails.accountDetailKey.id", boolQueryBuilder);

        elasticSearchUtils.add(voucherSearchContract.getAccountDetailTypeId(),
                "ledgers.ledgerDetails.accountDetailType.id", boolQueryBuilder);
