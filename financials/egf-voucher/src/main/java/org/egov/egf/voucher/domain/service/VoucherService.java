...
import org.egov.egf.master.web.repository.*;
...
public class VoucherService {
    ...
    private BindingResult validate(List<Voucher> vouchers, String method, BindingResult errors, RequestInfo requestInfo) {
        try {
            switch (method) {
        ...
        if (null != vouchers)
            for (Voucher voucher : vouchers) {
                ...
                if (voucher.getStatus() != null) {
                    ...
                    FinancialStatusContract status = financialStatusContractRepository.findById(voucher.getStatus(), requestInfo);
					if (status == null) {
                ...
                if (voucher.getFunction() != null) {
					...
					FunctionContract function = funnctionContractRepository.findById(voucher.getFunction(), requestInfo);
					if (function == null) {
                ...
                if (voucher.getFundsource() != null) {
                    ...
                    FundsourceContract fundsource = fundsourceContractRepository.findById(voucher.getFundsource(), requestInfo);
                    if (fundsource == null) {
                ...
                if (voucher.getSubScheme() != null) {
                    ...
                    SubSchemeContract subScheme = subSchemeContractRepository.findById(voucher.getSubScheme(), requestInfo);
                    if (subScheme == null) {
                ...
                if (voucher.getFunctionary() != null) {
                    ...
                    FunctionaryContract functionary = functionaryContractRepository.findById(voucher.getFunctionary(), requestInfo);
                    if (functionary == null) {
                ...
                fetchRelatedForLedger(vouchers, requestInfo);
                fetchRelatedForLedgerDetail(vouchers, requestInfo);

            }
        return vouchers;
    }

    private void fetchRelatedForLedger(List<Voucher> vouchers, RequestInfo requestInfo) {
    ...
    private void fetchRelatedForLedgerDetail(List<Voucher> vouchers, RequestInfo requestInfo) {
