...
super.toDomain( budgetReAppropriation);budgetReAppropriation.setId(this.id);
...
this.budgetDetailId=budgetReAppropriation.getBudgetDetail()!=null?budgetReAppropriation.getBudgetDetail().getId():null;
