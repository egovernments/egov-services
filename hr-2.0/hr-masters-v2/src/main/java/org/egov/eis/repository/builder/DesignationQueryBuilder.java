...
public class DesignationQueryBuilder {
	...
	private void addWhereClause(StringBuilder selectQuery, List preparedStatementValues,
		...
		if (designationGetRequest.getNames() != null) {
			isAppendAndClause = addAndClauseIfRequired(isAppendAndClause, selectQuery);
			selectQuery.append(" name IN " + getCodesQuery(designationGetRequest.getNames()));
		}
	...
	private void addOrderByClause(StringBuilder selectQuery, DesignationGetRequest designationGetRequest) {
		String sortBy = (designationGetRequest.getSortBy() == null ? "name" : designationGetRequest.getSortBy());
