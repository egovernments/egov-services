...
@Component
public class EmployeeTypeRowMapper implements RowMapper<EmployeeType> {
	...
	public EmployeeType mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		employeeType.setChartOfAccounts(rs.getString("chartOfAccounts"));
		employeeType.setTenantId(rs.getString("tenantId"));
		return employeeType;
	}
}