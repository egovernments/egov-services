...
public class HRConfigurationService {
	...
	public Map<String, List<String>> getHRConfigurations(HRConfigurationGetRequest hrConfigurationGetRequest) {
		return hrConfigurationRepository.findForCriteria(hrConfigurationGetRequest);
	}
