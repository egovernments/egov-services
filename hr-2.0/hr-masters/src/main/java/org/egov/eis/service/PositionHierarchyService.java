...
public class PositionHierarchyService {
	...
	public List<PositionHierarchy> getPositionHierarchies(PositionHierarchyGetRequest positionHierarchyGetRequest) {
		return positionHierarchyRepository.findForCriteria(positionHierarchyGetRequest);
	}
