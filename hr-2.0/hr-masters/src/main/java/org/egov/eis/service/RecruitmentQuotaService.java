...
@Service
public class RecruitmentQuotaService {

	@Autowired
	private RecruitmentQuotaRepository recruitmentQuotaRepository;

	public List<RecruitmentQuota> getRecruitmentQuotas(RecruitmentQuotaGetRequest recruitmentQuotaGetRequest) {
		return recruitmentQuotaRepository.findForCriteria(recruitmentQuotaGetRequest);
	}
