...
public class GroupController {
	...
	public ResponseEntity<?> search(@ModelAttribute @Valid GroupGetRequest groupGetRequest,
		...
		logger.debug("Inside search() of GroupController" + headers);
		...
		return getSuccessResponse(groupsList, headers);
	}
	 ...
	 * @return
	 */
	private ResponseEntity<?> getSuccessResponse(List<Group> groupsList, HttpHeaders headers) {
