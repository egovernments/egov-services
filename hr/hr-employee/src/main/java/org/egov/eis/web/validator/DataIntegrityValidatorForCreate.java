...
public class DataIntegrityValidatorForCreate implements Validator {
	...
	private void validateEmployee(Employee employee, Errors errors) {
		...
		if ((employee.getPassportNo() != null) && employeeCommonValidator.duplicateExists("egeis_employee", "passportNo",
		...
		if ((employee.getGpfNo() != null) && employeeCommonValidator.duplicateExists("egeis_employee", "gpfNo",
	...
	private void validateAssignments(List<Assignment> assignments, Long employeeId, String tenantId, Errors errors) {
		...
		validateAssignmentIds(assignments, employeeId, tenantId, errors);
	}
	 ...
	 */
		...
		private void validateAssignmentIds(List<Assignment> assignments, Long employeeId, String tenantId, Errors errors) {
