...
public class ApplicationProperties {
	...
	public String hrLeaveSearchPageSizeDefault() {
		return this.environment.getProperty(HR_LEAVE_SEARCH_PAGESIZE_DEFAULT);
	}

	public String hrLeaveSearchPageNumberMax() {
		return this.environment.getProperty(HR_LEAVE_SEARCH_PAGENO_MAX);
	}

	public String hrLeaveSearchPageSizeMax() {
		return this.environment.getProperty(HR_LEAVE_SEARCH_PAGESIZE_MAX);
	}
