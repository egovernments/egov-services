...
public class LeaveTypeRowMapper implements RowMapper<LeaveType> {
	...
	public LeaveType mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		leaveType.setHalfdayAllowed(rs.getBoolean("halfdayAllowed"));
		leaveType.setPayEligible(rs.getBoolean("payEligible"));
		leaveType.setAccumulative(rs.getBoolean("accumulative"));
		leaveType.setEncashable(rs.getBoolean("encashable"));
		leaveType.setActive(rs.getBoolean("active"));
		leaveType.setCreatedBy(rs.getLong("createdBy"));
		leaveType.setCreatedDate(rs.getDate("createdDate"));
		leaveType.setLastModifiedBy(rs.getLong("lastModifiedBy"));
