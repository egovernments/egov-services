...
@RestController
@RequestMapping("/compensatoryleaves")
public class CompensatoryLeaveController {
    ...
    public ResponseEntity<?> search(@ModelAttribute @Valid final LeaveSearchRequest leaveSearchRequest,
        ...
        return getSuccessResponse(compensatoryLeaves, requestInfo);
    }

    /**
     * Populate Response object and return leaveApplicationsList
     *
     * @param compensatoryLeaveList
     * @return
     */
    private ResponseEntity<?> getSuccessResponse(final List<CompensatoryLeave> compensatoryLeaveList,
                                                 final RequestInfo requestInfo) {
        final CompensatoryLeaveResponse compensatoryLeaveResponse = new CompensatoryLeaveResponse();
        compensatoryLeaveResponse.setCompensatoryLeaves(compensatoryLeaveList);
        final ResponseInfo responseInfo = responseInfoFactory.createResponseInfoFromRequestInfo(requestInfo, true);
        responseInfo.setStatus(HttpStatus.OK.toString());
        compensatoryLeaveResponse.setResponseInfo(responseInfo);
        return new ResponseEntity<CompensatoryLeaveResponse>(compensatoryLeaveResponse, HttpStatus.OK);
