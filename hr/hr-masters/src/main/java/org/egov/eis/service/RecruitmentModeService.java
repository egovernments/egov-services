...
@Service
public class RecruitmentModeService {

	@Autowired
	private RecruitmentModeRepository recruitmentModeRepository;

	public List<RecruitmentMode> getRecruitmentModes(RecruitmentModeGetRequest recruitmentModeGetRequest) {
		return recruitmentModeRepository.findForCriteria(recruitmentModeGetRequest);
	}
