...
public class RecruitmentTypeService {
	...
	public List<RecruitmentType> getRecruitmentTypes(RecruitmentTypeGetRequest recruitmentTypeGetRequest) {
		return recruitmentTypeRepository.findForCriteria(recruitmentTypeGetRequest);
	}
