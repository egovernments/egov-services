...
ALTER TABLE egeis_designation DROP CONSTRAINT uk_egeis_designation_code;
ALTER TABLE egeis_designation ADD CONSTRAINT uk_egeis_designation_code UNIQUE (code,tenantid);

--EGEIS_DEPARTMENTDESIGNATION

ALTER TABLE egeis_departmentDesignation DROP CONSTRAINT uk_egeis_departmentdesignation_departmentID_designationId;
...
ALTER TABLE egeis_position DROP CONSTRAINT uk_egeis_position_name;
