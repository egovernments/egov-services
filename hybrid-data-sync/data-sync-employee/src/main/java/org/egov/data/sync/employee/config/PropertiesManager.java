...
package org.egov.data.sync.employee.config;
...
public class PropertiesManager {
    ...
    @Value("${kafka.topics.employee.sync.name}")
    private String saveSignatureTopic;

    @Value("${ms.to.ml.procedure.name}")
    private String mstomlProcedureCall;

    @Value("${egov.services.filestore.hostname}")
    private String fileStoreHostName;
