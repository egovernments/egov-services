...
import org.egov.data.sync.employee.repository.DataSyncPositionRepository;
...
import org.egov.data.sync.employee.web.contract.PositionSync;
...
public class DataSyncPositionService {
    ...
    public void create(PositionSyncRequest positionSyncRequest) {
        PositionSync positionSync = positionSyncRequest.getPositionSync();
        dataSyncPositionRepository.executeProcedure(positionSync.getName(), positionSync.getTenantId());
    }
}