...
public class PurchaseOrder {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, tenantId, store, purchaseOrderNumber, purchaseOrderDate, rateType, supplierCode, advanceAmount, advancePercentage, expectedDeliveryDate, deliveryTerms, paymentTerms, description, status, stateId, purchaseMaterials, fileStoreId, auditDetails);
    }
