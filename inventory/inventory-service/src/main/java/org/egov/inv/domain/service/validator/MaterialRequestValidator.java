...
public class MaterialRequestValidator {
    ...
    private void validation(Material material, List<ErrorField> errorFields) {
        ...
        commonMasterValidator.addNotNullForObjectValidationErrors(MINIMUM_QUANTITY, material.getMinQuantity(), errorFields, null);
        commonMasterValidator.addNotNullForObjectValidationErrors(MAXIMUM_QUANTITY, material.maxQuantity(), errorFields, null);
        commonMasterValidator.addNotNullForObjectValidationErrors(STOCK_UOM, material.getStaockingUom(), errorFields, null);
        ...
        commonMasterValidator.validatePattern(TECHNICAL_SPECS, material.getTechincalSpecs(), PATTERN_ALPHANUMERIC, errorFields, null);
