...
public class MaterialsApiController implements MaterialsApi {
    ...
    public MaterialsApiController(ObjectMapper objectMapper,
                                  MaterialService materialService, InventoryUtilityService inventoryUtilityService) {
    ...
    public ResponseEntity<MaterialResponse> materialsCreatePost(@NotNull @ApiParam(value = "Unique id for a tenant.", required = true) @Valid @RequestParam(value = "tenantId", required = true) String tenantId,
        ...
        MaterialResponse materialResponse = buildMaterialResponse(materials, materialRequest.getRequestInfo());
        return new ResponseEntity<MaterialResponse>(materialResponse, HttpStatus.OK);
    }
    ...
    public ResponseEntity<MaterialResponse> materialsUpdatePost(@NotNull @ApiParam(value = "Unique id for a tenant.", required = true) @Valid @RequestParam(value = "tenantId", required = true) String tenantId,
        ...
        return new ResponseEntity<MaterialResponse>(buildMaterialResponse(materials, materialRequest.getRequestInfo()), HttpStatus.OK);
    }

    private MaterialResponse buildMaterialResponse(List<Material> materials, org.egov.common.contract.request.RequestInfo requestInfo) {
