...
public interface ReceiptnotesApi {
    ...
    ResponseEntity<MaterialReceiptResponse> receiptnotesCreatePost(@ApiParam(value = "Details for the new material receipt." ,required=true )  @Valid @RequestBody MaterialReceiptRequest materialReceipt);
    ...
    @RequestMapping(value = "/receiptnotes/_update",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<MaterialReceiptResponse> receiptnotesUpdatePost(@ApiParam(value = "Details for the new material receipts." ,required=true )  @Valid @RequestBody MaterialReceiptRequest materialReceipt);
