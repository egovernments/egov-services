...
public class Store   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, code, name, description, department, officeLocation, billingAddress, deliveryAddress, contactNo1, contactNo2, email, storeInCharge, isCentralStore, active, auditDetails);
  }
