...
public class Supplier   {
  ...
  **/
  ...
  public Supplier active(Boolean active) {
   ...
   /**
   * active or inactive flag of the supplier 
   * @return active
  **/
  @ApiModelProperty(value = "active or inactive flag of the supplier ")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, supplier.id) &&
        ...
        Objects.equals(this.active, supplier.active) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, type, code, name, address, status, inActiveDate, active, contactNo, faxNo, website, email, description, panNo, tinNo, cstNo, vatNo, gstNo, contactPerson, contactPersonNo, bankCode, bankName, bankBranch, acctNo, ifsc, micr, auditDetails);
  }
