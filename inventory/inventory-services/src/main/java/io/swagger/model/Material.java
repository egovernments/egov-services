...
public class Material   {
  ...
  **/
  ...
  public Boolean getOverrideMaterialControlType() {
    return overrideMaterialControlType;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, code, name, description, oldCode, materialType, baseUom, inventoryType, status, purchaseUom, expenseAccount, minQuantity, maxQuantity, stockingUom, materialClass, reorderLevel, reorderQuantity, materialControlType, model, manufacturePartNo, techincalSpecs, termsOfDelivery, overrideMaterialControlType, scrapable, auditDetails);
  }
