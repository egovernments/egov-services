...
public class ReceiptnotesApiController implements ReceiptnotesApi {
    ...
    public ResponseEntity<MaterialReceiptResponse> receiptnotesCreatePost(@NotNull @ApiParam(value = "Unique id for a tenant.", required = true) @RequestParam(value = "tenantId", required = true) String tenantId,
