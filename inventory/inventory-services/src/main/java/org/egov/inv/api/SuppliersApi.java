...
public interface SuppliersApi {
    ...
    @RequestMapping(value = "/suppliers/_transactionused",
            produces = {"application/json"},
            consumes = {"application/json"},
            method = RequestMethod.POST)
    ResponseEntity<TransactionUsedResponse> suppliersTransactionusedPost(@NotNull @ApiParam(value = "Unique id for a tenant.", required = true) @RequestParam(value = "tenantId", required = true) String tenantId, @ApiParam(value = "Parameter to carry Request metadata in the request body") @Valid @RequestBody RequestInfo requestInfo, @ApiParam(value = "code of the supplier ") @RequestParam(value = "code", required = true) String code);
}