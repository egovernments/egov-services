...
public interface TransferinwardsApi {
    ...
    ResponseEntity<TransferInwardResponse> transferinwardsCreatePost(
    ...
    @RequestMapping(value = "/transferinwards/_search",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<TransferInwardResponse> transferinwardsSearchPost( 
    		@NotNull@ApiParam(value = "Unique id for a tenant.", required = true) 
    		@RequestParam(value = "tenantId", required = true) String tenantId,
    ...
    @RequestMapping(value = "/transferinwards/_update",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<TransferInwardResponse> transferinwardsUpdatePost( 
    		@NotNull@ApiParam(value = "Unique id for a tenant.", required = true)
    		@RequestParam(value = "tenantId", required = true) String tenantId,
    		@ApiParam(value = "common Request info"  )  @Valid 
    		@RequestBody TransferInwardRequest transferInwardRequest);
