...
/**
 * An Object to hold the Application workflow details for a given Object like Indent, Material Transfer, Purchase Order, Material Issue, Outward Notice, Inward Notice etc.
 */
@ApiModel(description = "An Object to hold the Application workflow details for a given Object like Indent, Material Transfer, Purchase Order, Material Issue, Outward Notice, Inward Notice etc.")
...
public class WorkFlowDetails   {
   ...
   * @return type
  **/
  @ApiModelProperty(value = "Workflow type to be processed for an application the Inventory Object")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, businessKey, department, designation, assignee, action, status, comments, senderName, details, workFlowDetails, stateId);
  }
