...
public class StoreEntity {
    ...
    public Object toEntity(Store store) {
        ...
        this.department = null != store.getDepartment() ? store.getDepartment().getCode() : null;
        this.storeInCharge = null != store.getStoreInCharge() ? store.getStoreInCharge().getCode() : null;
