...
public interface SuppliersApi {
    ...
    @ApiOperation(value = "Get the list of suppliers", nickname = "suppliersSearchPost", notes = "suppliers", response = SupplierResponse.class, tags={ "Supplier", })
    @ApiResponses(value = { 
