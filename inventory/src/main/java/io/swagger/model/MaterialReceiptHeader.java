...
public class MaterialReceiptHeader   {
  ...
  /**
   * Shows the current status of the receipt. By default the value will be \"CREATED\".
   */
  ...
  **/
  ...
  public MaterialReceiptHeader mrnStatus(MrnStatusEnum mrnStatus) {
   ...
   * @return mrnStatus
  **/
  @ApiModelProperty(required = true, value = "Shows the current status of the receipt. By default the value will be \"CREATED\".")
  @NotNull
  ...
  **/
  ...
  public MaterialReceiptHeader fileStoreId(String fileStoreId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, materialReceiptHeader.id) &&
        ...
        Objects.equals(this.mrnStatus, materialReceiptHeader.mrnStatus) &&
        ...
        Objects.equals(this.fileStoreId, materialReceiptHeader.fileStoreId) &&
        Objects.equals(this.auditDetails, materialReceiptHeader.auditDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, mrnNumber, receiptDate, receiptType, receivingStore, supplierCode, supplierBillNo, supplierBillDate, challanNo, challanDate, description, receivedBy, designation, mrnStatus, inspectedBy, inspectionDate, inspectionRemarks, totalReceiptValue, receiptDetails, fileStoreId, auditDetails);
  }
