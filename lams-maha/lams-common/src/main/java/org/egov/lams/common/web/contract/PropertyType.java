...
public class PropertyType   {
  ...
  public PropertyType id(String id) {
    this.id = id;
    return this;
  }
 ...
 @Size(min=1,max=256)
  ...
  public PropertyType tenantId(String tenantId) {
 ...
 @Size(min=1,max=128)
  ...
  public PropertyType isActive(Boolean isActive) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, propertyType.id) &&
        Objects.equals(this.tenantId, propertyType.tenantId) &&
        Objects.equals(this.code, propertyType.code) &&
        Objects.equals(this.name, propertyType.name) &&
        Objects.equals(this.isActive, propertyType.isActive);
  }
