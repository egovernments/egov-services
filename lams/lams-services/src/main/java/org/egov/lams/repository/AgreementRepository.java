...
public class AgreementRepository {
	...
	public void updateExistingAgreementAsHistory(Agreement agreement, String userId) {

		String query = "update eglams_agreement set status='HISTORY',last_modified_by=:lastmodifiedBy,last_modified_date=now() where agreement_no=:agreementNumber and status ='ACTIVE' ";
		Map<String, Object> params = new HashMap<>();
		params.put("agreementNumber", agreement.getAgreementNumber());
		params.put("lastmodifiedBy", userId);
		logger.info("updating existing agreement as history,agreementNo :: " + agreement.getAgreementNumber());
		try {
