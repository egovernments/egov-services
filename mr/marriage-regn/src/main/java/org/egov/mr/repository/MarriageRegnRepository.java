...
public class MarriageRegnRepository {
	...
	public void save(MarriageRegn marriageRegn) {
		Object[] obj = new Object[] { marriageRegn.getRegnUnit().getId(), marriageRegn.getMarriageDate(),
				...
				marriageRegn.getStateId(), marriageRegn.getIsActive(), marriageRegn.getApprovalDetails().getDepartment(),
				...
				marriageRegn.getApprovalDetails().getComments(), marriageRegn.getAuditDetails().getCreatedBy(),
	...
	public void update(MarriageRegn marriageRegn) {
		...
		Object[] obj = new Object[] { marriageRegn.getRegnUnit().getId(), marriageRegn.getMarriageDate(),
				...
				marriageRegn.getPriest().getName(), marriageRegn.getPriest().getReligion(),
				marriageRegn.getPriest().getAddress(), marriageRegn.getPriest().getAadhaar(),
				marriageRegn.getPriest().getMobileNo(), marriageRegn.getPriest().getEmail(), marriageRegn.getSerialNo(), marriageRegn.getVolumeNo(),
			    marriageRegn.getRegnNumber(), marriageRegn.getRegnDate(), marriageRegn.getStatus().toString(),
				marriageRegn.getSource().toString(), marriageRegn.getStateId(), marriageRegn.getIsActive(), marriageRegn.getApprovalDetails().getDepartment(),
				marriageRegn.getApprovalDetails().getDesignation(), marriageRegn.getApprovalDetails().getAssignee(),
				marriageRegn.getApprovalDetails().getAction(), marriageRegn.getApprovalDetails().getStatus(),
				marriageRegn.getApprovalDetails().getComments(), marriageRegn.getAuditDetails().getLastModifiedBy(),
				marriageRegn.getAuditDetails().getLastModifiedTime(), marriageRegn.getApplicationNumber(), marriageRegn.getTenantId() };
