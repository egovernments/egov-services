...
@WebMvcTest(FeeQueryBuilder.class)
...
public class FeeQueryBuilderTest {
	...
	public void testGetQuery() {
		...
		ids.add("123");
		FeeCriteria feeCriteriaQuery = FeeCriteria.builder().tenantId("defualt").id(ids).
				feeCriteria("2017-2018").fromDate(123456789l).toDate(23456789l).build();
