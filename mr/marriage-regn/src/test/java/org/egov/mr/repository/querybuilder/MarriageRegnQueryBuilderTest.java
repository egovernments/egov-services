...
public class MarriageRegnQueryBuilderTest {
	...
	public void testSelectQuery() {
		...
		String expectedQueryString = "SELECT mr.marriagedate as mr_marriagedate, mr.venue as mr_venue,"
				...
				+ " mr.priestemail as mr_priestemail, mr.serialno as mr_serialno, mr.volumeno as mr_volumeno, mr.applicationnumber as mr_applicationnumber,"
				+ " mr.regnnumber as mr_regnumber, mr.status as mr_status, mr.source as mr_source, mr.stateid as mr_stateid, mr.tenantid as mr_tenantid,"
				...
				+ " mpb.city as mpb_city, mpb.aadhaar as mpb_aadhaar, mpb.mobileno as mpb_mobileno, mpb.email as mpb_email, mpb.religionpractice as mpb_religionpractice,"
				+ " mpb.religion as mpb_religion, mpb.occupation as mpb_occupation, mpb.education as mpb_education, mpb.handicapped as mpb_handicapped,"
				+ " mpb.residenceaddress as mpb_residenceaddress, mpb.photo as mpb_photo, mpb.nationality as mpb_nationality, mpbg.id as mpbg_id,"
				+ " mpbg.name as mpbg_name, mpbg.parentname as mpbg_parentname, mpbg.dob as mpbg_dob, mpbg.status as mpbg_status, mpbg.street as mpbg_street,"
				+ " mpbg.locality as mpbg_locality, mpbg.city as mpbg_city, mpbg.aadhaar as mpbg_aadhaar, mpbg.mobileno as mpbg_mobileno, mpbg.email as mpbg_email,"
				+ " mpbg.religionpractice as mpbg_religionpractice, mpbg.religion as mpbg_religion, mpbg.occupation as mpbg_occupation, mpbg.education as mpbg_education,"
				+ " mpbg.handicapped as mpbg_handicapped, mpbg.residenceaddress as mpbg_residenceaddress, mpbg.photo as mpbg_photo, mpbg.nationality as mpbg_nationality,"
