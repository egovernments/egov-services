...
let reqRequired = [];
class acknowldgeDepreciation extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    console.log(formData);
          ...
          const renderBody = function() {
            var ackCode = [];
            if(formData && formData.hasOwnProperty("Depreciation") && formData.Depreciation.hasOwnProperty("DepreciationDetail") && formData.Depreciation.DepreciationDetail.length){
              if(formData.Depreciation.DepreciationDetail.length >= 0){
                ...
                console.log(ackCode);
                console.log(formData.Depreciation.DepreciationDetail[0].status);
                return(
                  <div>
