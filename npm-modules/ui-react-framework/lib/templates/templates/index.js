...
if(process.env.NODE_ENV == "production") {
  assetImmovableReport = require('egov-asset/templates/assetImmovableReport');
  assetMovableReport = require('egov-asset/templates/assetMovableReport');
  landRegisterReport = require('egov-asset/templates/landRegisterReport');
} else {
