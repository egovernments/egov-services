...
public class EscalationHoursRepositoryTest {
    ...
    public void setUp() throws Exception {
        ...
        String designationUrl = "escalation-hours/v1/_search?tenantId={tenantId}&grievanceType={complaintTypeId}&designation={designationId}";
    ...
    public void test_should_return_escalation_hours_for_given_search_criteria() throws Exception {
        ...
        String expectedUrl = "http://host/escalation-hours/v1/_search?tenantId=tenantId&grievanceType=1&designation=2";
