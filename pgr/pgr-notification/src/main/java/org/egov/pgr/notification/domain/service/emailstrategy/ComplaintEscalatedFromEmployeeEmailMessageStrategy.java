...
public class ComplaintEscalatedFromEmployeeEmailMessageStrategy implements EmailMessageStrategy {
    private static final String EMAIL_BODY_EN_TEMPLATE = "complaint_escalated_from_employee_email_body_en";
    ...
    public boolean matches(NotificationContext context) {
        return context.getServiceType().isComplaintType()
            ...
            && isNotEmpty(context.getPreviousEmployee().getEmail())
    ...
    public EmailMessageContext getMessageContext(NotificationContext context) {
        return EmailMessageContext.builder()
            ...
            .email(context.getPreviousEmployee().getEmail())
            .build();
    }
