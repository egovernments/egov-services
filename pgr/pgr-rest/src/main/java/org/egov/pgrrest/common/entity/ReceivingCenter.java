...
public class ReceivingCenter extends AbstractPersistable<Long> {
  ...
  public  org.egov.pgrrest.common.model.ReceivingCenter toDomain()
    {
        return org.egov.pgrrest.common.model.ReceivingCenter.builder().id(id).name(name).crnRequired(crnRequired)
