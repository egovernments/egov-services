...
public class InvalidDateTimeAttributeEntryExceptionAdapter implements ErrorAdapter<String> {

    private static final String MESSAGE = "Invalid date time data type format.";
    private static final String CODE = "PGR.INVALID_DATE_TIME_DATA_TYPE_FORMAT";
