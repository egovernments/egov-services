...
public class InvalidTextAreaAttributeEntryExceptionAdapter implements ErrorAdapter<String> {

    private static final String MESSAGE = "Invalid Text Area data type format.";
    private static final String CODE = "PGR.INVALID_TEXT_AREA_DATA_TYPE_FORMAT";
