...
public class OtpValidationNotCompleteExceptionAdapter implements ErrorAdapter<Void> {

    private static final String OTP_VALIDATION_NOT_COMPLETE_MESSAGE = "OTP validation is not completed";
    private static final String MANDATORY_CRN_CODE = "PGR.OTP_VALIDATION_NOT_COMPLETE";
    private static final String FIELD_NAME = "PGR.OTP_VALIDATION_NOT_COMPLETE";
