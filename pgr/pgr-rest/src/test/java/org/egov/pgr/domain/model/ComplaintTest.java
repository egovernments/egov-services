...
public class ComplaintTest {
    ...
    @Test(expected = InvalidComplaintException.class)
    public void test_should_fail_validation_when_neither_cross_hierarchy_id_nor_coordinates_are_present_on_creating_a_complaint() {
    ...
    @Test
    public void test_should_not_fail_validation_when_mandatory_complainant_attributes_are_present_on_complaint_creation_by_employee() {
        final ComplaintLocation complaintLocation = ComplaintLocation.builder()
                .coordinates(new Coordinates(1.1, 2.2))
                .build();
        final Complainant complainant = Complainant.builder()
    ...
    @Test(expected = InvalidComplaintException.class)
    public void test_should_fail_validation_when_receiving_center_is_not_present_when_employee_creates_a_complaint_with_manual_receiving_mode() {
        final ComplaintLocation complaintLocation = ComplaintLocation.builder()
                .coordinates(new Coordinates(1.1, 2.2))
                .build();
        final Complainant complainant = Complainant.builder()
