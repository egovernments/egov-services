...
public class ComplaintRepositoryTest {
	...
	public void test_complaint_repository_should_get_complaints_modified_for_a_user_from_jpa_repository() {
		...
		when(complaintJpaRepository.getAllModifiedComplaintsForCitizen(lastAccessedTime, 1L))
				.thenReturn(Arrays.asList(complaintEntityMock1, complaintEntityMock2));

		List<org.egov.pgr.domain.model.Complaint> actual = complaintRepository
				.getAllModifiedComplaintsForCitizen(lastAccessedTime, 1L);
