...
public class AttributeValuesValidatorTest {
    ...
    @Test(expected = InvalidAttributeEntryException.class)
    public void test_should_throw_exception_when_key_size_is_greater_than_50_chars_in_attribute_value() {
        final AttributeValuesValidator validator = new AttributeValuesValidator();
        final String key = StringUtils.repeat("k", 51);
    ...
    @Test(expected = InvalidAttributeEntryException.class)
    public void test_should_throw_exception_when_code_size_is_greater_than_50_chars_in_attribute_value() {
        final AttributeValuesValidator validator = new AttributeValuesValidator();
        final String code = StringUtils.repeat("k", 51);
