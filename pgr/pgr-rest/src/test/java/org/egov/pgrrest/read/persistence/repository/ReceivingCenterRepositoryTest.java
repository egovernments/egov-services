...
public class ReceivingCenterRepositoryTest {
    ...
    public void test_should_find_receivingCenter_by_id_and_tenantId()
    {
        ...
        org.egov.pgrrest.common.model.ReceivingCenter receivingCenter1=receivingCenterRepository.findReceivingCenterByIdAndTenantId(1L,"ap.public");
    ...
    public void test_should_return_all_receivingcenters_by_tenantId()
    {
       ...
       List<org.egov.pgrrest.common.model.ReceivingCenter> receivingCenters1= receivingCenterRepository.findAllReceivingCentersByTenantId("ap.public");
