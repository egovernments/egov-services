...
public class DraftReadExceptionAdapterTest {

    @InjectMocks
    private DraftReadExceptionAdapter draftReadExceptionAdapter;

    @Test
    public void test_should_capture_draft_not_found_exception() {

        final ErrorResponse errorResponse = draftReadExceptionAdapter.adapt(null);
