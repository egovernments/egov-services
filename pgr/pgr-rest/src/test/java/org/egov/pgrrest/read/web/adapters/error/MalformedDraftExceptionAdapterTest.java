...
public class MalformedDraftExceptionAdapterTest {

    @InjectMocks
    private MalformedDraftExceptionAdapter malformedDraftExceptionAdapter;

    @Test
    public void test_should_capture_draft_not_found_exception() {

        final ErrorResponse errorResponse = malformedDraftExceptionAdapter.adapt(null);
