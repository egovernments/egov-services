...
lastmodifiedby, slahours, hasfinancialimpact, attributes, category, metadata, type, keywords, tenantid) VALUES (6,'Absenteesim of door to door garbage collector'
,18,0,'AODTDGC','t','garbage collector absent','2010-01-01 00:00:00','2015-01-01 00:00:00',1,1,24,'f',null,4,'t','realtime',null,'tenantId');
