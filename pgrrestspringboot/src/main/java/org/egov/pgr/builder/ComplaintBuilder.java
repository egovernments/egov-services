...
public class ComplaintBuilder {
    ...
    private void setLocationDetails() {
        String locationId = this.serviceRequest.attributeForName("LOCATION_ID");
        String childLocationId = this.serviceRequest.attributeForName("CHILD_LOCATION_ID");
    ...
    private void setAssigneeId() {
        String assigneeId = this.serviceRequest.attributeForName("ASSIGNEE_ID");
