class PropertyType extends React.Component {
  constructor(props) {
    ...
    name:"",
  },isSearchClicked:false,propertyTypeList:[],type:""}
  ...
  search(e)
  {
    ...
    console.log(this.state.type);
      if(this.state.type==="Update")
        ...
        return (  window.location.href='app/create/create-property-type.html?type=Update')
        //console.log(type);
      //
      //
      else
        ...
        return (  window.location.href='app/create/create-property-type.html?type=View')
            ...
            <div className="row">
                <div className="col-sm-9">
                  ...
                  onChange={(e)=>{  handleChange(e,"name")}} required>
                                  ...
                                  {renderOption(this.state.propertyTypeList)}
                ...
                <button type="button" className="btn btn-danger" onClick={(e)=>{window.location.href='app/create/create-property-type.html?type=Create'}}>Create</button>
                &nbsp;
