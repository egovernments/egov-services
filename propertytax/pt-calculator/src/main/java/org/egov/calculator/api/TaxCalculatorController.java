...
public class TaxCalculatorController {
	...
	public CalculationFactorResponse createFactor(@RequestParam String tenantId,
		...
		return calculatorService.createFactor(tenantId, calculationFactorRequest);
	}
	...
	public CalculationFactorResponse updateFactor(@RequestParam String tenantId,
		...
		return calculatorService.updateFactor(tenantId, calculationFactorRequest);
	}
	...
	public CalculationFactorResponse getFactor(@RequestBody RequestInfoWrapper requestInfo,
		...
		return calculatorService.getFactor(requestInfo.getRequestInfo(), tenantId, factorType, validDate, code);
	...
	public GuidanceValueResponse createGuidanceValue(@RequestParam String tenantId,
		...
		return calculatorService.createGuidanceValue(tenantId, guidanceValueRequest);
	}
	...
	public GuidanceValueResponse updateGuidanceValue(@RequestParam String tenantId,
		...
		return calculatorService.updateGuidanceValue(tenantId, guidanceValueRequest);
	}
	...
	public GuidanceValueResponse getGuidanceValue(@RequestBody RequestInfoWrapper requestInfo,
		...
		return calculatorService.getGuidanceValue(requestInfo.getRequestInfo(), tenantId, boundary, structure, usage,
	...
	public TaxRatesResponse getTaxRate(@RequestBody RequestInfoWrapper requestInfo,
		...
		return calculatorService.getTaxRate(requestInfo.getRequestInfo(), tenantId, taxHead, validDate, validARVAmount,
				parentTaxHead);
	...
	public TaxPeriodResponse getTaxPeriod(@RequestBody RequestInfoWrapper requestInfo,
		...
		return calculatorService.getTaxPeriod(requestInfo.getRequestInfo(), tenantId, validDate, code);
