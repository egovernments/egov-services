...
public class PropertyMasterRepository {
    ...
    /**
     * This will check whether any record exists with the given tenantId & code in database or not
     * 
     * @param tenantId
     * @param code
    ...
    /**
     * This will return the list of depreciations based on the given search terms
     * 
     * @param tenantId
     * @param ids
     * @param fromYear
    ...
    /**
     * This will check whether there is any record in the mutation with the given code
     * 
     * @param code
    ...
    /**
     * Checks whether Record with tenantId, name, Application name values exists or not
     * 
     * @param tenantId
     * @param name
    ...
    /**
     * This will check whether any record exists with the given tenantId & diff b/t occupancy year & current year in database or
     * not
     * 
     * @param tenantId
     * @param diff b/t current date & current date
     * @return True / false if record exists / record does n't exists
     */
