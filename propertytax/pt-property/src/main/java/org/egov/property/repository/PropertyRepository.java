...
public class PropertyRepository {
	...
	public void updateVacancyRemissionDocument(Document document, Long vacancyRemissionId) {

		String documentUpdate = VacancyRemissionDocumentBuilder.updateVacancyRemissionDocumentQuery();
		Object[] documentArgs = { document.getFileStore(), document.getAuditDetails().getLastModifiedBy(),
				document.getAuditDetails().getLastModifiedTime(), document.getDocumentType(), vacancyRemissionId,
				document.getId() };

		jdbcTemplate.update(documentUpdate, documentArgs);
	}

	public void updateVacancyRemission(VacancyRemission vacancyRemission) throws Exception {
	...
	public void updateDemolitionDocument(VacancyRemission vacancyRemission, RequestInfo requestInfo) throws Exception {
