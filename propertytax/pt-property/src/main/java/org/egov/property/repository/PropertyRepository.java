...
public class PropertyRepository {
     ...
     * 
     * @param object that need to be cast to Boolean
     * @return {@link String}
     */
    ...
    /**
     * Query for property history This will copy property to property history based on id
     * 
     * @param id
     */
    ...
    /**
     * Query for propertydetails history This will copy propertydetails to propertydetails history based on id
     * 
     * @param id
     */
    ...
    /**
     * Query for address history This will copy address to address history based on id
     * 
     * @param id
     */
    ...
    /**
     * Query for document history This will copy document to document history based on id
     * 
     * @param id
     */
    ...
    /**
     * Query for vacant land history This will copy vacant land to vacand land history based on id
     * 
     * @param id
     */
    ...
    /**
     * Query for property owner history This will copy property owner to property owner history based on id
     * 
     * @param id
     */
    ...
    /**
     * Query for property location history This will copy property location to property location history based on id
     * 
     * @param id
     */
