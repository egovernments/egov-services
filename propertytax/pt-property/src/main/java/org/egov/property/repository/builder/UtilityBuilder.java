...
/**
 * 
 * @author Prasad This class will have all the common queries which will be use in the master & property as well
 *
 */
public class UtilityBuilder {
    ...
    public static String getAgeQuery(String tableName, Integer diffValue,
            String tenantId, List<Object> preparedStatementValues) {
