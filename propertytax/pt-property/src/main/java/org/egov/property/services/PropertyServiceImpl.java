...
import org.egov.property.consumer.TitleTransferProducer;
...
public class PropertyServiceImpl implements PropertyService {
    ...
    @Autowired
    TitleTransferProducer titleTransferProducer;
    ...
    /**
     * <p>
     * This method will search the documents in Database(Postgres) with the given parameters
     * </p>
     * 
     * @author Prasad
     * @param requestInfo
    ...
    /**
     * <p>
     * This method will add the property details to the given list of property objects ,such as floors,owners etc
     * </p>
     * 
     * @author Prasad
     * @param properties
    ...
    public TitleTransferResponse createTitleTransfer(TitleTransferRequest titleTransferRequest) throws Exception {
        ...
        if (isPropertyUnderWorkflow) {
            ...
            if (!isValidated) {
                ...
                titleTransferProducer.send(environment.getProperty("egov.propertytax.property.title.transfer"),
    ...
    /**
     * This method will validate  title transfer object(Currently not yet have any validations)
