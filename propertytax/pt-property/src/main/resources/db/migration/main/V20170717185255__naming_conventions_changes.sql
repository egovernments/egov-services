...
ALTER TABLE egpt_propertydetails ALTER COLUMN reason TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN status TYPE character varying(8);
ALTER TABLE egpt_propertydetails ALTER COLUMN exemptionReason TYPE character varying(32);
ALTER TABLE egpt_propertydetails ALTER COLUMN propertyType TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN category TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN usage TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN department TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN apartment TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN landOwner TYPE character varying(128);
ALTER TABLE egpt_propertydetails ALTER COLUMN floorType TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN woodType TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN roofType TYPE character varying(16);
ALTER TABLE egpt_propertydetails ALTER COLUMN wallType TYPE character varying(16);
...
ALTER TABLE egpt_unit ALTER COLUMN usage TYPE character varying(16);
ALTER TABLE egpt_unit ALTER COLUMN occupancy TYPE character varying(16); 
...
ALTER TABLE egpt_unit ALTER COLUMN structure TYPE character varying(16); 
ALTER TABLE egpt_unit ALTER COLUMN age TYPE character varying(16);  
ALTER TABLE egpt_unit ALTER COLUMN exemptionReason TYPE character varying(32); 
...
ALTER TABLE egpt_mstr_department ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mstr_floortype ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mstr_floortype ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mstr_occuapancy ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mstr_occuapancy ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mstr_propertytype ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mstr_propertytype ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mstr_rooftype ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mstr_rooftype ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mstr_structureclass ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mstr_structureclass ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mstr_usage ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mstr_usage ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mstr_walltype ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mstr_walltype ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mstr_woodtype ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mstr_woodtype ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_depreciation ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_depreciation ALTER COLUMN code TYPE character varying(16);
ALTER TABLE egpt_mutation_master ALTER COLUMN tenantId TYPE character varying(128);
ALTER TABLE egpt_mutation_master ALTER COLUMN code TYPE character varying(16);
