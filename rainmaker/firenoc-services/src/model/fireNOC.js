...
//     "description": "APIs for Fire NOC module. This modules handles Below functionality.\n  1. Apply Fire NOC.\n  2. Search existing Fire NOC with different fiters.\n  3. Update exiting Fire NOC.\n",
//     "contact": {
...
//         "description": "To create new Fire NOC in the system. API supports bulk creation with max limit as defined in the Fire NOC Request. Please note that either whole batch succeeds or fails, there's no partial batch success. To create one Fire NOC, please pass array with one Fire NOC object.\n\n\nFollowing Conditions are applied -\n  1. Support Documents for a given Fire NOC will created. In case of not attaching the Mandatory Supported Documents creation of Fire NOC Fails.\n  2. Noc Number will be autogenerated on final approval for new License.\n  3. ApplicationNumber will be autogenerated for new Fire NOC\n",
//         "parameters": [
//           {
//             "name": "FireNOCRequest",
//             "in": "body",
...
//         "description": "To update existing Fire NOC in the system. API supports bulk updation with max limit as defined in the Fire NOC Request. Please note that either whole batch succeeds or fails, there's no partial batch success. To update one Fire NOC, please pass array with one Fire NOC object.\n\nFollowing Conditions are applied -\n  1. Before payment Employee or Citizen can update any details of Fire NOC\n  2. After payment Citizen or Employee can't change any details of Fire NOC.\n",
//         "parameters": [
//           {
//             "name": "FireNOCRequest",
//             "in": "body",
