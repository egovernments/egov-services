...
public class APRDetailTableRowMapper implements RowMapper<APRDetail> {
	...
	public APRDetail mapRow(ResultSet rs, int rowNum) throws SQLException, DataAccessException {
		...
		APRDetail aprDetail = APRDetail.builder()
				.id((Long) rs.getObject("id"))
				.yearOfSubmission((Integer) rs.getObject("yearOfSubmission"))
				.detailsSubmitted((Boolean) rs.getObject("detailsSubmitted"))
