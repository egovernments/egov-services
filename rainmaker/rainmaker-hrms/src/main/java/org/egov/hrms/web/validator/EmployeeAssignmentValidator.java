...
import org.egov.hrms.service.DepartmentService;
import org.egov.hrms.service.DesignationService;
import org.egov.hrms.web.contract.DesignationGetRequest;
	...
	public void validate(Object targetObject, Errors errors) {
		...
		for (int index = 0; index < assignments.size(); index++) {
			...
			if (null != assignments.get(index).getDesignation()) {
				...
				List<Designation> designations = designationService
