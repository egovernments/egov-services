...
public class WaterConnectionValidator {
	 ...
	 * 4. For every applicationType there is a specific set of documentTypes allowed, validates them.
	 * 
	 * We don't check for duplicate record here since the ids are generated by the system and they don't repeat.
	 * 
