...
ALTER TABLE egswm_routecollectionpointmap ADD COLUMN id varchar(256) NOT NULL;
...
ALTER TABLE egswm_routecollectionpointmap ADD COLUMN endingDumpingGroundPoint varchar(256) NOT NULL;

ALTER TABLE egswm_routecollectionpointmap ADD COLUMN distance numeric NOT NULL;

ALTER TABLE egswm_routecollectionpointmap ADD COLUMN garbageEstimate numeric NOT NULL;
