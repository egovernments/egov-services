        ...
        if (!action.equals("uploads")) {
            switch (value) {
                ...
                case "assessmentNumber":
                    ...
                    break;
                case "aboveUser":
                    value = scenarioContext.getUser();
                    break;
                case "abovePassword":
                    value = scenarioContext.getPassword();
                    break;
                default:
...
//    @Given("^(Intent):(.*):$")
//    public void intentSample(String a, String intentId, DataTable dataTable) throws Throwable {
//        List<List<String>> data = dataTable.raw();
//        int x = 0;
//
//        for (List<String> aData : data) {
//            String username = aData.get(x++);
//            String password = aData.get(x);
//            scenarioContext.setUser(username);
//            scenarioContext.setPassword(password);
//        }
//        intent.run(intentId);
//    }
