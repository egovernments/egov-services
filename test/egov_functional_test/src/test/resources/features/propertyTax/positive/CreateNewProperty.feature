Feature: In this feature we are going to test Create New Property
  ...
  Scenario Outline: Create New Property With Workflow
    ...
    And user on CreateNewProperty screen will see the isRoomInFlat
...
#    And user on CreateNewProperty screen types on annualRent value <Annual Rent>
    ...
    Examples:
      ...
      | 202422321144   | 9167251234   | Chatri     | Male   | Chatri@gmail.com | ABCDE4703E | Father            | K Suraj  | 55                      | 101211111111100           | NA             | 30003   | AndharAli | Prabhag 1     | Zone A  | Prabhag 2 | NA       | NA     | NA             | 560038 | 2            | New Property        | Building      | Shop              | Residential | Slum           | 5000       | 1           | 1234                       | 01/08/2017               | 1             | 2           | 3           | 4              | Ground Floor | Flat      | Yes             | 100     | 505     | RCC Load bearing   | Non Residential  | Shop                 | Firm      | Owner     | Sunil          | 2000        | NA                   | 200           | 02/05/2012              | 03/05/2012            | 04/05/2012          | Yes               | NA     | NA      | 3000         | 500         | 200           | 10                          | 200000        | 50000     | Assessment Department | Tax Inspector | Ramakrishna |
