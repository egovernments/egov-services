Feature: In this feature we are going to test Create New Property
  ...
  Scenario Outline: Create New Property With Workflow
    ...
    And user on CreateNewProperty screen forceClicks on primaryOwner
#    And user on CreateNewProperty screen clicks radio button or checkbox on primaryOwner
    ...
    And user on CreateNewProperty screen types on flatNo value <Flat No>
    And user on CreateNewProperty screen selects on isRoomInFlat value <Is Room In Flat>
