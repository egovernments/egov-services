...
#    And user on PropertyTax screen types on breadth value <Breadth>
    ...
    ### On Login Screen ###
    Given user on Login screen verifies signInText has visible value Sign In
    And user on Login screen types on username value bimalroha
    And user on Login screen types on password value 12345678
    And user on Login screen clicks on signIn
...
#    And user on PropertyTax screen types on annualRent value <Annual Rent>
    ...
    And user on PropertyTax screen types on constructionEndDateQA value <Construction end Date>
    And user on PropertyTax screen types on effectiveFromDateQA value <Effective from Date>
    And user on PropertyTax screen selects on unStructuredLand value <Unstructured Land>
#    And user on PropertyTax screen types on length value <length>
#    And user on PropertyTax screen types on breadth value <Breadth>
    And user on PropertyTax screen types on buildUpArea value <BuildUp Area>
    ...
    ### On Create Data Entry Screen entering Construction Details ###
    And user on PropertyTax screen types on currentAssessmentDateQA value <Current Assessment date>
    And user on PropertyTax screen types on firstAssessmentDateQA value <First Assessment Date>
    And user on PropertyTax screen types on revisedAssessmentDateQA value <Revised Assessment Date>
    And user on PropertyTax screen types on lastAssessmentDateQA value <Last assessment date>
    And user on PropertyTax screen types on commencementDateQA value <Commencement date>
    And user on PropertyTax screen types on certificateNumber value <Cerficate number>
    And user on PropertyTax screen types on certificateCompletionDateQA value <Cerficate Complition Date>
    And user on PropertyTax screen types on certificateReceivedDateQA value <Cerficate Received Date>
    And user on PropertyTax screen types on agencyName value <Agency name>
    And user on PropertyTax screen types on licenseType value <License Type>
    And user on PropertyTax screen types on licenseNumber value <License Number>
