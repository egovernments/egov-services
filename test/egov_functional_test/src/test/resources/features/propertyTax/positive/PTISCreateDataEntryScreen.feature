Feature: Creating a Property Tax with Data Entry Screen
  ...
  Scenario Outline: Create A DataEntryScreen in MAHA-ULB
    ...
    And user on PTISDataEntry screen clicks radio button or checkbox on primaryOwner
...
#    And user on PTISDataEntry screen selects on revenueCircle value <Revenue Circle>
    ...
    And user on PTISDataEntry screen selects on noOfFloors value <Total Floors>
    ...
    And user on PTISDataEntry screen selectDate on buildingPermissionDate value <Building Permission Date>
...
#    And user on PTISDataEntry screen types on annualRent value <Annual Rent>
    ...
    And user on PTISDataEntry screen selectDate on constructionStartDate value <Construction Start Date>
    And user on PTISDataEntry screen selectDate on constructionEndDate value <Construction end Date>
    And user on PTISDataEntry screen selectDate on effectiveFromDate value <Effective from Date>
...
#    And user on PTISDataEntry screen types on breadth value <Breadth>
    ...
    And user on PTISDataEntry screen selectDate on currentAssessmentDate value <Current Assessment date>
    And user on PTISDataEntry screen selectDate on firstAssessmentDate value <First Assessment Date>
    And user on PTISDataEntry screen selectDate on revisedAssessmentDate value <Revised Assessment Date>
    And user on PTISDataEntry screen selectDate on lastAssessmentDate value <Last assessment date>
    And user on PTISDataEntry screen selectDate on commencementDate value <Commencement date>
    And user on PTISDataEntry screen types on certificateNumber value <Cerficate number>
    And user on PTISDataEntry screen selectDate on certificateCompletionDate value <Cerficate Complition Date>
    And user on PTISDataEntry screen selectDate on certificateReceivedDate value <Cerficate Received Date>
  ...
  Scenario Outline: Create A DataEntryScreen in Micro-QA with tenantId mh.rohatest
    ...
    ### On Login Screen ###
    Given user on Login screen verifies signInText has visible value Sign In
    And user on Login screen types on username value 30003
    And user on Login screen types on password value 12345678
    And user on Login screen clicks on signIn
...
#      | 7615000062      | 201722311994   | 1453215765   | Ravi       | Male   | ravi@gmail.com     | XYZHT4703K | Father            | Ramesh    | 47                      | 121031100111226           | NA             | 1936    | Kasar Ali         | Prabhag 2     | Zone A  | Prabhag 5 | NA       | NA     | NA             | 121031 | 3            | New Property        | Religious                   | Options           | Library     | null           | 6000       | 5           | 8890                       | 01/08/2016               | 4             | 3           | 2           | 1              | 4th Floor    | Room      | 222     | RCC Load bearing   | Mixed            | Mixed                | Firm      | Owner     | Sandeep        | 2000        | 2800                 | 300           | 02/08/2016              | 03/08/2016            | 02/08/2016          | Yes               | null   | null    | 3200         | 570         | 300           | 12                          | 240000        | 12000     | 05/08/2016              | 06/08/2016            | 07/08/2016              | 08/08/2016           | 09/08/2016        | 111              | 10/08/2016                | 11/08/2016              | Ravi        | A5           | 3245           |
...
#      | 7772000090      | 202022314477   | 2212315400   | Sudheer    | Male   | sudheer@gmail.com  | PPDHT4703Y | Father            | Jay       | 78                      | 333231111117821           | NA             | 1177    | AndharAli         | Prabhag 5     | Zone A  | Prabhag 4 | NA       | NA     | NA             | 333333 | 2            | New Property        | Shop                        | Options           | Residential | Residential    | 5100       | 3           | 3390                       | 01/08/2017               | 8             | 2           | 3           | 4              | 2nd Floor    | Room      | 999     | RCC Load bearing   | Residential      | Other                | Firm      | Owner     | Sudeep         | 1800        | 2800                 | 200           | 02/08/2017              | 03/08/2017            | 04/08/2017          | Yes               | null   | null    | 3000         | 600         | 200           | 10                          | 850000        | 60000     | 05/08/2017              | 06/08/2017            | 07/08/2017              | 08/08/2017           | 09/08/2017        | 111              | 10/08/2017                | 11/08/2017              | Sujit       | A8           | 5555           |
#      | 2212000045      | 505022314499   | 9886496040   | Manu       | Male   | manu@gmail.com     | DDDHT4703K | Father            | Viru      | 66                      | 661231111117834           | NA             | 4449    | Aambedkar Nagar   | Prabhag 1     | Zone A  | Prabhag 4 | NA       | NA     | NA             | 444455 | 2            | New Property        | Building                    | Options           | Residential | Residential    | 5900       | 9           | 7790                       | 01/08/2017               | 8             | 2           | 3           | 4              | 3rd Floor    | Room      | 999     | RCC Load bearing   | Residential      | Other                | Firm      | Owner     | Sudeep         | 1700        | 2700                 | 200           | 02/08/2011              | 03/08/2011            | 04/05/2017          | Yes               | null   | null    | 3000         | 550         | 200           | 10                          | 860000        | 65000     | 05/08/2017              | 06/08/2017            | 07/08/2017              | 08/08/2017           | 09/08/2017        | 111              | 10/08/2017                | 11/08/2017              | Sujit       | A8           | 5555           |
#      | 7615000062      | 201722311994   | 9843619659   | Manju      | Male   | manju@gmail.com    | XYZHT4703K | Father            | Ramesh    | 47                      | 121031100111226           | NA             | 1936    | Kasar Ali         | Prabhag 2     | Zone A  | Prabhag 5 | NA       | NA     | NA             | 121031 | 3            | New Property        | Building                    | Options           | Library     | null           | 6000       | 5           | 8890                       | 01/08/2017               | 4             | 3           | 2           | 1              | 4th Floor    | Room      | 222     | RCC Load bearing   | Mixed            | Mixed                | Firm      | Owner     | Sandeep        | 2000        | 2800                 | 300           | 02/08/2017              | 03/08/2017            | 04/08/2017          | Yes               | null   | null    | 3200         | 570         | 300           | 12                          | 240000        | 12000     | 05/08/2017              | 06/08/2017            | 07/08/2017              | 08/08/2017           | 09/08/2017        | 111              | 10/08/2017                | 11/08/2017              | Ravi        | A5           | 3245           |
#      | 8688000062      | 505022314499   | 9966436667   | Saketh     | Male   | saketh@gmail.com   | KLMHT1238G | Father            | Imran     | 35                      | 994961100111345           | NA             | 1995    | Kasar Ali         | Prabhag 2     | Zone A  | Prabhag 5 | NA       | NA     | NA             | 234567 | 4            | New Property        | Shop                        | Options           | Industrial  | null           | 4500       | 4           | 4578                       | 01/08/2017               | 9             | 3           | 5           | 2              | 6th Floor    | Room      | 678     | RCC Load bearing   | Mixed            | Mixed                | Firm New  | Owner     | Imran          | 2000        | 1900                 | 250           | 02/08/2017              | 03/08/2017            | 04/08/2012          | Yes               | null   | null    | 1800         | 360         | 150           | 14                          | 134000        | 9000      | 05/08/2017              | 06/08/2017            | 07/08/2017              | 08/08/2017           | 09/08/2017        | 111              | 10/08/2017                | 11/08/2017              | Imran       | A7           | 4634           |
#      | 8688000062      | 199022311994   | 1994915765   | Rahim      | Male   | rahim@xyz.com      | KLMHT1238G | Father            | Imran     | 35                      | 994961100111345           | NA             | 1995    | Kasar Ali         | Prabhag 2     | Zone A  | Prabhag 5 | NA       | NA     | NA             | 234567 | 4            | New Property        | Shop                        | Options           | Industrial  | null           | 4500       | 4           | 4578                       | 01/08/2017               | 9             | 3           | 5           | 2              | 6th Floor    | Room      | 678     | RCC Load bearing   | Mixed            | Mixed                | Firm New  | Owner     | Imran          | 2000        | 1900                 | 250           | 02/08/2017              | 03/08/2017            | 02/08/2017          | Yes               | null   | null    | 1800         | 360         | 150           | 14                          | 134000        | 9000      | 05/08/2017              | 06/08/2017            | 07/08/2017              | 08/08/2017           | 09/08/2017        | 111              | 10/08/2017                | 11/08/2017              | Imran       | A7           | 4634           |
#      | 8688004567      | 199022398706   | 7004922100   | Mukesh     | Male   | mukesh@xyz.com     | ABCDG12765 | Father            | Somesh    | 47                      | 994961100111345           | NA             | 1995    | Kasar Ali         | Prabhag 2     | Zone A  | Prabhag 5 | NA       | NA     | NA             | 234567 | 4            | New Property        | Shop                        | Options           | Industrial  | null           | 4500       | 4           | 4578                       | 01/08/2017               | 9             | 3           | 5           | 2              | 6th Floor    | Room      | 678     | RCC Load bearing   | Mixed            | Mixed                | Firm New  | Owner     | Imran          | 2000        | 1900                 | 250           | 02/08/2017              | 03/08/2017            | 02/08/2017          | Yes               | null   | null    | 1800         | 360         | 150           | 14                          | 134000        | 9000      | 05/08/2017              | 06/08/2017            | 07/08/2017              | 08/08/2017           | 09/08/2017        | 111              | 10/08/2017                | 11/08/2017              | Imran       | A7           | 4634           |
#      | 8681234567      | 199022391234   | 7111922100   | Tarun      | Male   | tarun@xyz.com      | QWERT12765 | Father            | Basker    | 59                      | 994961100111345           | NA             | 1995    | Kasar Ali         | Prabhag 2     | Zone A  | Prabhag 5 | NA       | NA     | NA             | 234567 | 4            | New Property        | Shop                        | Options           | Industrial  | null           | 4500       | 4           | 4578                       | 01/08/2017               | 9             | 3           | 5           | 2              | 6th Floor    | Room      | 678     | RCC Load bearing   | Mixed            | Mixed                | Firm New  | Owner     | Imran          | 2000        | 1900                 | 250           | 02/08/2017              | 03/08/2017            | 02/08/2017          | Yes               | null   | null    | 1800         | 360         | 150           | 14                          | 134000        | 9000      | 05/08/2017              | 06/08/2017            | 07/08/2017              | 08/08/2017           | 09/08/2017        | 111              | 10/08/2017                | 11/08/2017              | Imran       | A7           | 4634           |
      | 8689876543      | 662422314422   | 7223322100   | Vijay      | Male   | vijay@xyz.com      | BGDHT4705T | Father            | Ajay      | 35                      | 994961100111345           | NA             | 1995    | Kasar Ali         | Prabhag 2     | Zone A  | Prabhag 5 | NA       | NA     | NA             | 234567 | 4            | New Property        | Shop                        | Options           | Industrial  | null           | 4500       | 4           | 4578                       | 01/08/2017               | 9             | 3           | 5           | 2              | 6th Floor    | Room      | 678     | RCC Load bearing   | Mixed            | Mixed                | Firm New  | Owner     | Imran          | 2000        | 1900                 | 250           | 02/08/2017              | 03/08/2017            | 02/08/2017          | Yes               | null   | null    | 1800         | 360         | 150           | 14                          | 134000        | 9000      | 05/08/2017              | 06/08/2017            | 07/08/2017              | 08/08/2017           | 09/08/2017        | 111              | 10/08/2017                | 11/08/2017              | Imran       | A7           | 4634           |
