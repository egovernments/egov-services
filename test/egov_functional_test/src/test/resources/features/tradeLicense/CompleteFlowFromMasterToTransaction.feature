Feature: Completing the workflow for new license application from creating master till end of the workflow
  ...
  Scenario: Complete workflow for new license with rate type FLAT BY RANGE
    ...
    And user on TLFeeMatrixMaster screen types on AmountValue value 10
...
#    And user on Home screen clicks on text value Acknowledged
...
#    And user on TradeLicensse screen clicks on text value Ok
#    And user on Home screen will wait until the page loads
#
#    ### Logout ###
