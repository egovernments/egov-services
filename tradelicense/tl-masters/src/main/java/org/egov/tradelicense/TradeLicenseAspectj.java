...
/**
 * This is aspectj class for tl-tradelicense
 * 
...
@Aspect
@Component
public class TradeLicenseAspectj {

	private static final Logger logger = LoggerFactory.getLogger(TradeLicenseApplication.class);
