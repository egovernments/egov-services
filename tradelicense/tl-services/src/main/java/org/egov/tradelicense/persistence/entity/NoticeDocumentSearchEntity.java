...
public class NoticeDocumentSearchEntity {
    ...
    public NoticeDocumentSearch toDomain() {
        ...
        noticeDocument.setApplicationType(this.applicationType == null ? null : ApplicationTypeEnum.fromValue(this.applicationType));
    ...
    public NoticeDocumentSearchEntity toEntity(NoticeDocumentSearch noticeDocument) {
        ...
        this.setApplicationType(noticeDocument.getApplicationType() == null ? null : noticeDocument.getApplicationType().toString());
