...
public class InvalidFeeDetailAdapter {
	...
	private static final String INVALID_FEE_DETAIL_EXCEPTION_MESSAGE = "tl.error.invalid.feedetails";
	...
	private Error getError(String customMsg) {
		return Error.builder().code(HTTP_CLIENT_ERROR_CODE).message(INVALID_FEE_DETAIL_EXCEPTION_MESSAGE)
