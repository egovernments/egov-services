...
public class InvalidPropertyAssesmentAdapter {
	...
	private static final String INVALID_PROPERTY_ASSESMENT_EXCEPTION_MESSAGE = "tl.error.invalid.property.assesment";
	...
	private ErrorField getErrorField() {
		return ErrorField.builder().code(INVALID_PROPERTY_ASSESMENT_EXCEPTION_FIELD_CODE)
				.field(INVALID_PROPERTY_ASSESMENT_EXCEPTION_FIELD).message("").build();
	}
}