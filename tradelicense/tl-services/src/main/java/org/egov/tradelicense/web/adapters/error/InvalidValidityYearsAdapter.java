...
public class InvalidValidityYearsAdapter {
	...
	private static final String INVALID_VALIDITY_YEARS_EXCEPTION_MESSAGE = "tl.error.invalid.validityyears";
	...
	private ErrorField getErrorField(String customMsg) {
		return ErrorField.builder().code(INVALID_VALIDITY_YEARS_EXCEPTION_FIELD_CODE)
				.field(INVALID_VALIDITY_YEARS_EXCEPTION_FIELD).message(customMsg).build();
	}
}