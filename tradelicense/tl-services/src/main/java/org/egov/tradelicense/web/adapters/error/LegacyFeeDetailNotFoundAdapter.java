...
public class LegacyFeeDetailNotFoundAdapter {

	private static final int HTTP_CLIENT_ERROR_CODE = 400;
	private static final String FEE_DETAILS_NOT_FOUND_EXCEPTION_MESSAGE = "tl.error.feedetails.notfound";
	private static final String FEE_DETAILS_NOT_FOUND_EXCEPTION_FIELD = "feeDetails";
	private static final String FEE_DETAILS_NOT_FOUND_EXCEPTION_FIELD_CODE = "tl.error.feeDetails.notfound";
