...
public class NoticeDocumentController {
    ...
    public NoticeDocumentResponse searchNoticeDocument(@Valid @ModelAttribute NoticeDocumentGetRequest noticeDocumentGetRequest,
            BindingResult errors, @RequestBody @Valid final RequestInfoWrapper requestInfoWrapper,
        ...
        List<NoticeDocument> noticeDocuments = noticeDocumentService.getNoticeDocuments(noticeDocumentGetRequest, requestInfo);

        final NoticeDocumentResponse response = new NoticeDocumentResponse();
        response.setNoticeDocument(noticeDocuments);
