...
public class SequenceNumberGeneratorTest {
    ...
    @Test
    public void test_sequence_number_generator_should_return_value() throws SQLException {
        final Serializable value = sequenceNumberGenerator.getNextSequence(LICENSE_NUMBER_SEQ_NAME);
        assertEquals(1, value);
    }

    @SuppressWarnings("unchecked")
    @Test
    public void test_sequence_number_generator_should_throw_exception() throws SQLException {
        when(jdbcTemplate.queryForObject(Mockito.anyString(), Mockito.any(Object[].class), eq(Integer.class)))
                .thenThrow(SQLException.class);
        thrown.expect(SQLException.class);
        sequenceNumberGenerator.getNextSequence(LICENSE_NUMBER_SEQ_NAME);
    }
