...
import org.egov.tl.workflow.repository.contract.DepartmentResponse;
...
public class DepartmentRepository {
	...
	private final String departmentByNameUrl;

	@Autowired
	public DepartmentRepository(final RestTemplate restTemplate,
			@Value("${egov.services.common_masters.hostname}") final String departmentServiceHostname,
			@Value("${egov.services.common_masters.department.by.name}") final String departmentByNameUrl) {
