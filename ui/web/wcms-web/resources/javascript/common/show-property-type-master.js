...
class ShowPropertyType extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const renderAction=function(type,id){
      if (type==="Update") {
              ...
              return (
                      <a href={`app/create/create-property-type-master.html?id=${id}&type=${type}`} className="btn btn-default btn-action"><span className="glyphicon glyphicon-pencil"></span></a>
              );

    }else {
            return (
                    <a href={`app/create/create-property-type-master.html?id=${id}&type=${type}`} className="btn btn-default btn-action"><span className="glyphicon glyphicon-modal-window"></span></a>
            );
        }
}
        ...
        <table id="usagetyepTable" className="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th><center>Property  Type</center></th>
                    <th><center>Pipe SIze (mm) </center> </th>
