...
public class ApplicationDocumentRepository {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(ApplicationDocumentRepository.class);

    @Autowired
    private JdbcTemplate jdbcTemplate;

    public void persistApplicationDocuments(final WaterConnectionReq waterConnectionRequest, final Long connectionId) {
        if (connectionId > 0) {
