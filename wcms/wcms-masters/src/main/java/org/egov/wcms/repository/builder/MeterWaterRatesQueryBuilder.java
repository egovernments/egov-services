...
public class MeterWaterRatesQueryBuilder {
    ...
    private static final String BASE_QUERY = "SELECT meterwater.id as meterwater_id,meterwater.code as meterwater_code, meterwater.billingtype as billingtype,meterwater.sourcetypeid "
            ...
            + " meterwater.subusagetypeid as meterwater_subusagetypeid,"
    ...
    public static String insertMeterWaterRatesQuery() {
        return "INSERT INTO egwtr_meter_water_rates(id,code,billingtype,usagetypeid,subusagetypeid,sourcetypeid,pipesizeid,fromdate,todate,active,"
                + "createdby,lastmodifiedby,createddate,lastmodifieddate,tenantid) values "
                + "(:id,:code,:billingtype,:usagetypeid,:subusagetypeid,:sourcetypeid,:pipesizeid,:fromdate,:todate,:active,"
    ...
    public static String updateMeterWaterRatesQuery() {
        return "UPDATE egwtr_meter_water_rates SET billingtype = :billingtype,usagetypeid = :usagetypeid, subusagetypeid = :subusagetypeid,sourcetypeid = :sourcetypeid,pipesizeid = :pipesizeid ,fromdate = :fromdate "
