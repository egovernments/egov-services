...
public class PipeSizeQueryBuilder {
    ...
    public String getQuery(final PipeSizeGetRequest pipeSizeGetRequest, List preparedStatementValues) {
    ...
    private void addOrderByClause(StringBuilder selectQuery, final PipeSizeGetRequest pipeSizeGetRequest) {
    ...
    public static String insertPipeSizeQuery() {
        return "INSERT INTO egwtr_pipesize(id,code,sizeinmilimeter,sizeininch,active,createdby,lastmodifiedby,createddate,lastmodifieddate,tenantid) values "
                + "(?,?,?,?,?,?,?,?,?,?)";
    }
