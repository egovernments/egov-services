...
public class PropertyPipeSizeService {
    ...
    public static final Logger logger = LoggerFactory.getLogger(PropertyPipeSizeService.class);
    ...
    public PropertyPipeSizeRequest create(final PropertyPipeSizeRequest propertyPipeSizeRequest) {
        return propertyPipeSizeRepository.persistCreatePropertyPipeSize(propertyPipeSizeRequest);
    }

    public PropertyPipeSize createPropertyPipeSize(final String topic, final String key,
    ...
    public boolean checkPropertyByPipeSize(final Long id, final Long properyType, final Long pipeSize, final String tenantId) {
        return propertyPipeSizeRepository.checkPropertyByPipeSize(id, properyType, pipeSize, tenantId);
    }

    public List<PropertyPipeSize> getPropertyPipeSizes(final PropertyPipeSizeGetRequest propertyPipeSizeGetRequest) {
