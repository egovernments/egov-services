...
import org.egov.wcms.service.WaterChargesConfigService;
...
@RestController
@RequestMapping("/waterchargesconfig")
public class WaterChargesConfigController {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(WaterChargesConfigController.class);

    @Autowired
    private WaterChargesConfigService waterchargesConfigService;
    ...
    public ResponseEntity<?> search(
            @ModelAttribute @Valid final WaterChargesConfigGetRequest waterchargesConfigGetRequest,
