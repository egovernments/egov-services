...
public class GapcodeControllerTest {
	    ...
	    public void test_should_create_gapcode() throws Exception {
	        ...
	        when(gapcodeService.createGapcode(applicationProperties.getCreateGapcodeTopicName(),"gapcode-create", getGapcodeRequest())).thenReturn(getListOfGapcode());
	        ...
	        ResultActions msb = mockMvc.perform(post("/gapcode/_create").contentType(MediaType.APPLICATION_JSON_UTF8)
