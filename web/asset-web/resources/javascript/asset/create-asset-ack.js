          ...
          <div>
            <div className="form-section">
                <form>
                  ...
                  <h3>
                      <center><font color="ass"> Successfully  {getUrlVars()["value"] == "update" ? "Updated" : "Created"} an Asset {getUrlVars()["type"] ? "Category" : ""} with Asset {getUrlVars()["type"] ? "Category" : ""} Name <strong style={{'fontWeight':700}}>
