    ...
    render(){
      ...
      return(
        <div className="AddNewDetailedCode">
            <Card>
                <CardHeader
                    title={<strong style={{color:brown500}}>Add Detailed Chart Of Accounts</strong>}
                />
                <CardText>
                      <Card>
                          <CardText>
                              <Grid>
                                <Row>
                                  <Col xs={12} md={6}>
                                    <TextField errorText={fieldErrors.name
                                      ? fieldErrors.name
                                      : ""} value={AddNewDetailedCode.name?AddNewDetailedCode.name:""} onChange={(e) => handleChange(e, "name", false, "")} hintText="Parent Account Code" floatingLabelText="Parent Account Code" />
                                  </Col>
                                  <Col xs={12} md={6}>
                                ...
                                <Row>
                                  <Col xs={12} md={6}>
                                    <TextField errorText={fieldErrors.name
                                      ? fieldErrors.name
                                      : ""} value={AddNewDetailedCode.name?AddNewDetailedCode.name:""} onChange={(e) => handleChange(e, "name", false, "")} hintText="Name" floatingLabelText="Name" />
                                  </Col>
                                  <Col xs={12} md={6}>
                                ...
                                <Row>
                                  <Col xs={12} md={6}>
                                    <SelectField errorText={fieldErrors.purpose
                                      ? fieldErrors.purpose
...
const mapStateToProps = state => ({AddNewDetailedCode: state.form.form, fieldErrors: state.form.fieldErrors, isFormValid: state.form.isFormValid,isTableShow:state.form.showTable,buttonText:state.form.buttonText});
