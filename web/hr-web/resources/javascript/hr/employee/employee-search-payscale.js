...
class EmployeeSearch extends React.Component {
  ...
  render() {
    ...
    const renderAction = function (type, value, id) {
      ...
      if (type === "update") {
        return (
          <a href={`app/hr/employee/employee-payscale.html?id=${id}&type=${type}`}>Update Payscale</a>
        );
      } else if (type === "view") {
        return (
          <a href={`app/hr/employee/employee-payscale.html?id=${id}&type=${type}`}>View Payscale</a>
        );
      } else {
        return (
          <a href={`app/hr/employee/employee-payscale.html?id=${id}`} >Create Payscale</a>
        );
      }
