class LeaveType extends React.Component {
  ...
  render() {
    ...
    let { name, payEligible, encashable, halfdayAllowed, accumulative, description,
      active, encloseHoliday, includePrefixSuffix, maxDays } = this.state.LeaveType;
        ...
        <fieldset>
          ...
          <div className="row">
            ...
            <div className="col-sm-6">
              <div className="row">
                <div className="col-sm-6 label-text">
                  <label htmlFor="">Max days allowed <span> * </span></label>
                </div>
                <div className="col-sm-6">
                  <input type="number" name="maxDays" id="maxDays" value={maxDays} min="0" max="999"
                    onChange={(e) => { handleChange(e, "maxDays") }} required />
                </div>
              </div>
            </div>
          </div>
