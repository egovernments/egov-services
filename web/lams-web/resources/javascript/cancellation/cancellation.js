class CancellationAgreement extends React.Component {
  ...
  componentDidMount() {
    ...
    $('#cancel-title').text("Cancellation Of Agreement");
  ...
  render(){
    ...
    let {cancelReasons} = this.state;
    let {cancellation,legacyDemands,agreementNumber,natureOfAllotment,paymentCycle,rent,timePeriod,commencementDate,expiryDate} = this.state.agreement;
   ...
   return(
     <div className="form-section hide-sec" id="agreementCancelDetails">
         ...
         <div className="form-section-inner">
                     ...
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                           <div className="text-no-ui">
                             ...
                             <input type="text" className="datepicker" name="orderDate" id="orderDate"/>
                           </div>
                         </div>
                     </div>
                 </div>
             ...
             <div className="row">
                 <div className="col-sm-6" id="terminationDate">
                     <div className="row">
                         <div className="col-sm-6 label-text">
                         ...
                         <div className="text-no-ui">
                             <span className="glyphicon glyphicon-calendar"></span>
                           <input type="text" className="datepicker" name="terminationDate" id="terminationDate"/>
                         </div>
                         </div>
                     </div>
                 </div>
                 <div className="col-sm-6">
                     <div className="row">
                         <div className="col-sm-6 label-text">
                             <label for="reasonForCancellation">Reason For Cancellation
                              <span>*</span>
                             </label>
                         </div>
                         <div className="col-sm-6">
                                 <select name="reasonForCancellation" id="reasonForCancellation" className="selectStyle">
    ...
    return(
      ...
      <form  id="cancelAgreementForm" name="cancelAgreementForm" >
      <fieldset>
              {renderAssetDetails()}
              {renderAllottee()}
              ...
              <div className="text-center">
                <button type="button" className="btn btn-submit" id="close">Close</button>&nbsp;&nbsp;
                  <button type="button" id="cancelAgreement" className="btn btn-submit">Submit</button>
              </div>
