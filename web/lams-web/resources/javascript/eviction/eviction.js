class EvictionAgreement extends React.Component {
      ...
      agreement:
        {
            ...
            "eviction": {
              	...
              	"evictionProceedingNumber":"",
                  "evictionProceedingDate":"",
  ...
  componentDidMount() {
    ...
    $('#eviction-title').text("Eviction Of Agreement");
    ...
    let evictionReasons = {...this.state.evictionReasons}
  ...
  render(){
    ...
    let {evictionReasons} = this.state;
    let {eviction,legacyDemands,agreementNumber,natureOfAllotment,paymentCycle,rent,timePeriod,commencementDate,expiryDate} = this.state.agreement;
 ...
 const renederEvictionDetails = function(){
   return(
             ...
             <div className="row">
                 <div className="col-sm-6">
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                             <input type="text" name="evictionProceedingNumber" id="evictionProceedingNumber" />
                         </div>
                     </div>
                 </div>
                 <div className="col-sm-6">
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                           <div className="text-no-ui">
                             ...
                             <input type="text" className="datepicker" name="evictionProceedingDate" id="evictionProceedingDate"/>
                           </div>
                         </div>
                     </div>
                 </div>
           ...
           <div className="row">
                 <div className="col-sm-6" id="courtReferenceNumber">
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                             <input type="text" name="courtReferenceNumber" id="courtReferenceNumber" />
                         </div>
                         </div>
                     </div>
                 </div>
                 <div className="col-sm-6">
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                                 <select name="reasonForEviction" id="reasonForEviction" className="selectStyle">
    ...
    return(
      ...
      <form  id="evictionAgreementForm" name="evictionAgreementForm" >
      <fieldset>
              {renderAssetDetails()}
              {renderAllottee()}
              {renderAgreementDetails()}
              {renederEvictioDetails()}
              //work flow details
              ...
              <div className="text-center">
                <button type="button" className="btn btn-submit" id="close">Close</button>&nbsp;&nbsp;
                  <button type="button" id="evictionAgreement" className="btn btn-submit">Submit</button>
              </div>
