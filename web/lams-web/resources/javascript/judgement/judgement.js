                       ...
                       <div className="col-sm-6">
                           <div className="row">
                               ...
                               <div className="col-sm-6">
                                   <div className="styled-file">
                                       <input type="file" multiple id="documents" value={judgement.documents}
                                       onChange={(e)=>{handleChangeTwoLevel(e, "judgement", "documents")}} />
                                   </div>
                               </div>
                           </div>
                       </div>
                         <div className="col-sm-6">
                             <div className="row">
                                 ...
                                 <div className="col-sm-6">
                                     <textarea name="remarks" id="remarks" value={judgement.remarks}
                                     onChange={(e)=>{handleChangeTwoLevel(e, "judgement", "remarks")}} ></textarea>
                                 </div>
                             </div>
                         </div>
                     </div>
