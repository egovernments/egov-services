class JudgementAgreement extends React.Component {
  ...
  render(){
    ...
    let {judgement,legacyDemands,agreementNumber,natureOfAllotment,paymentCycle,rent,timePeriod,commencementDate,expiryDate} = this.state.agreement;
 ...
 const renederJudgementDetails = function(){
   return(
                     ...
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                           <div className="text-no-ui">
                             ...
                             <input type="text" className="datepicker" name="judgementDate" id="judgementDate"/>
                           </div>
                         </div>
                     </div>
                 </div>
                 ...
                 <div className="col-sm-6">
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                           <div className="text-no-ui">
                               <span>₹</span>
                             <input type="number" min="0" name="judgementRent" id="judgementRent"/>
                           </div>
                         </div>
                     </div>
                 </div>
    ...
    return(
      ...
      <form  id="judgementAgreementForm" name="judgementAgreementForm" >
      <fieldset>
              {renderAssetDetails()}
              {renderAllottee()}
              ...
              <div className="text-center">
                <button type="button" className="btn btn-submit" id="close">Close</button>&nbsp;&nbsp;
                  <button type="button" id="judgementAgreement" className="btn btn-submit">Submit</button>
              </div>
