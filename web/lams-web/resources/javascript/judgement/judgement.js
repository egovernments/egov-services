class JudgementAgreement extends React.Component {
                  ...
                  $.ajax({
                    ...
                    success: function (res1) {
                      ...
                      if (res1 && res1.Employee && res1.Employee[0].name)
                        window.location.href = `app/acknowledgement/common-ack.html?wftype=Judgement&action=forward&name=${res1.Employee[0].name}&ackNo=${res.Agreements[0].acknowledgementNumber}`;
                      else
                        window.location.href = `app/acknowledgement/common-ack.html?wftype=Judgement&action=forward&name=&ackNo=${res.Agreements[0].acknowledgementNumber}`;
  ...
  componentWillMount() {
    ...
    $('#lams-title').text("Judgement On Agreement");
    var _this = this;
