class UpdateJudgement extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            agreement: {
    ...
    componentWillMount() {
        ...
        $('#lams-title').text("Judgement Of Agreement");
        var _this = this;
    ...
    componentDidMount() {
        ...
        if (this.state.wfStatus === "Rejected") {
            ...
            $("#judgementNo").prop("disabled", false)
            $("#judgementDate").prop("disabled", false)
            $("#judgementRent").prop("disabled", false)
    ...
    render() {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-6">
                                        <input type="text" name="judgementNo" id="judgementNo" value={judgement.judgementNo}
                                            onChange={(e) => { handleChangeTwoLevel(e, "judgement", "judgementNo") }} required disabled />
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-6">
                                    ...
                                    <div className="col-sm-6">
                                        <div className="text-no-ui">
                                            ...
                                            <input type="text" className="datepicker" name="judgementDate" id="judgementDate" value={judgement.judgementDate}
                                                onChange={(e) => { handleChangeTwoLevel(e, "judgement", "judgementDate") }} required disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="col-sm-6">
                                        <div className="text-no-ui">
                                            ...
                                            <input type="text" min="0" name="judgementRent" id="judgementRent" value={judgement.judgementRent}
                                                onChange={(e) => { handleChangeTwoLevel(e, "judgement", "judgementRent") }} required disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="col-sm-6">
                                        <div className="text-no-ui">
                                            ...
                                            <input type="text" className="datepicker" name="effectiveDate" id="effectiveDate" value={judgement.effectiveDate}
                                                onChange={(e) => { handleChangeTwoLevel(e, "judgement", "effectiveDate") }} required disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        return (
            <div>
                <h3>Judgement Of Agreement </h3>
                <form className="update-judgement" id="update-judgement" >
                    <fieldset>
                        {renderAssetDetails()}
                        {renderAllottee()}
