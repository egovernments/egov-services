class ObjectionAgreement extends React.Component {
        ...
        this.makeAjaxUpload(agreement.documents[i], function (err, res) {
          if (breakout == 1) {
            ...
            if (counter == 0 && breakout == 0) {
              ...
              $.ajax({
                url: baseUrl + "/lams-services/agreements/_objection?tenantId=" + tenantId,
                type: 'POST',
                dataType: 'json',
  ...
  componentWillMount() {
    ...
    var agreementType = "Objection Municipality Agreement";
    if (cityGrade.toLowerCase() === 'corp') {
      agreementType = "Objection Corporation Agreement";
    }
                  ...
                  <div className="col-sm-6">
                    <div className="text-no-ui">
                      ...
                      <input type="text" className="datepicker" name="courtCaseDate" id="courtCaseDate" value={objection.courtCaseDate}
                        onChange={(e) => { handleChangeTwoLevel(e, "objection", "courtCaseDate") }} required />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="col-sm-6">
                    <div className="text-no-ui">
                      ...
                      <input type="text" className="datepicker" name="effectiveDate" id="effectiveDate" value={objection.effectiveDate}
                        onChange={(e) => { handleChangeTwoLevel(e, "objection", "effectiveDate") }} required />
                    </div>
                  </div>
                </div>
              </div>
