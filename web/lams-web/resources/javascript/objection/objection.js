                       ...
                       <div className="col-sm-6">
                           <div className="row">
                               ...
                               <div className="col-sm-6">
                                   <div className="styled-file">
                                       <input type="file" multiple id="documents" value={objection.documents}
                                       onChange={(e)=>{handleChangeTwoLevel(e, "objection", "documents")}}/>
                                   </div>
                               </div>
                           </div>
                       </div>
                         <div className="col-sm-6">
                             <div className="row">
                                 ...
                                 <div className="col-sm-6">
                                     <textarea name="remarks" id="remarks" value={objection.remarks}
                                     onChange={(e)=>{handleChangeTwoLevel(e, "objection", "remarks")}} ></textarea>
                                 </div>
                             </div>
                         </div>
                     </div>
