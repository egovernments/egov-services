class UpdateObjection extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            agreement: {
    ...
    componentDidMount() {
        ...
        if (this.state.wfStatus === "Rejected") {
            ...
            $("#courtCaseNo").prop("disabled", false)
            $("#courtCaseDate").prop("disabled", false)
            $("#courtFixedRent").prop("disabled", false)
        ...
        $('#courtCaseDate').on('changeDate', function (e) {
            _this.setState({
                agreement: {
                    ..._this.state.agreement,
                    objection: {
                        ..._this.state.agreement.objection,
                        "courtCaseDate": $("#courtCaseDate").val()
                    }
                }
            });
        });
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (res1) {
                                                    ...
                                                    if (res1 && res1.Employee && res1.Employee[0].name)
                                                        window.location.href = `app/acknowledgement/common-ack.html?wftype=Objection&action=${ID}&name=${res1.Employee[0].code}::${res1.Employee[0].name}&ackNo=${res.Agreements[0].acknowledgementNumber}`;
                                                    else
                                                        window.location.href = `app/acknowledgement/common-ack.html?wftype=Objection&action=${ID}&name=&ackNo=${res.Agreements[0].acknowledgementNumber}`;
    ...
    render() {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-6">
                                        <input type="text" name="courtCaseNo" id="courtCaseNo" value={objection.courtCaseNo}
                                            onChange={(e) => { handleChangeTwoLevel(e, "objection", "courtCaseNo") }} required disabled />
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-6">
                                <div className="row">
                                    ...
                                    <div className="col-sm-6">
                                        <div className="text-no-ui">
                                            ...
                                            <input type="text" className="datepicker" name="courtCaseDate" id="courtCaseDate" value={objection.courtCaseDate}
                                                onChange={(e) => { handleChangeTwoLevel(e, "objection", "courtCaseDate") }} required disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="col-sm-6">
                                        <div className="text-no-ui">
                                            ...
                                            <input type="number" min="0" name="courtFixedRent" id="courtFixedRent" value={objection.courtFixedRent}
                                                onChange={(e) => { handleChangeTwoLevel(e, "objection", "courtFixedRent") }} required disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-6">
                                <div className="row">
                                    ...
                                    <div className="col-sm-6">
                                        <div className="text-no-ui">
                                            <span className="glyphicon glyphicon-calendar"></span>
                                            <input type="text" className="datepicker" name="effectiveDate" id="effectiveDate" value={objection.effectiveDate}
                                                onChange={(e) => { handleChangeTwoLevel(e, "objection", "effectiveDate") }} required disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        return (
            <div>
                <h3>Objection Of Agreement </h3>
                <form className="update-objection" id="update-objection" >
                    <fieldset>
                        {renderAssetDetails()}
                        {renderAllottee()}
