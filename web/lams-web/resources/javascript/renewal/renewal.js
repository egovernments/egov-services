                  ...
                  $.ajax({
                    ...
                    success: function (res1) {
                      ...
                      if (res1 && res1.Employee && res1.Employee[0].name)
                        window.location.href = `app/acknowledgement/common-ack.html?wftype=Renewal&action=${ID}&name=${res1.Employee[0].name}&ackNo=${res.Agreements[0].acknowledgementNumber}`;
                      else
