                  ...
                  $.ajax({
                    ...
                    success: function (res1) {
                      ...
                      if (res1 && res1.Employee && res1.Employee[0].name)
                        window.location.href = `app/acknowledgement/common-ack.html?wftype=Renewal&action=forward&name=${res1.Employee[0].name}&ackNo=${res.Agreements[0].acknowledgementNumber}`;
                      else
                        window.location.href = `app/acknowledgement/common-ack.html?wftype=Renewal&action=forward&name=&ackNo=${res.Agreements[0].acknowledgementNumber}`;
                  ...
                  <div className="col-sm-6">
                    <div className="text-no-ui">
                      ...
                      <input type="text" className="datepicker" name="renewalOrderDate" id="renewalOrderDate" value={renewal.renewalOrderDate}
                        onChange={(e) => { handleChangeTwoLevel(e, "renewal", "renewalOrderDate") }} />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-sm-6">
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <select name="reasonForRenewal" id="reasonForRenewal" className="selectStyle" onChange={(e) => { handleChangeTwoLevel(e, "renewal", "reasonForRenewal") }}>
