class RenewalAgreement extends React.Component {
  ...
  componentDidMount() {
    ...
    $('#renewal-title').text("Renewal Of Agreement");
    ...
    let renewalReasons = {...this.state.renewalReasons}
     asset = commonApiPost("asset-services", "assets", "_search", { id: getUrlVars()["assetId"], tenantId }).responseJSON["Assets"][0] || {};
     agreement = commonApiPost("lams-services", "agreements", "_search", { agreementNumber: getUrlVars()["agreementNumber"], tenantId }).responseJSON["Agreements"][0] || {};
    console.log(asset);
  ...
  handleChange(e,name) {
    ...
    switch (name) {
      case "renewalRent":
        if(name){
          $('#renewal.securityDeposit').val(e.target.value * 3);
        }
        break;
      }
        this.setState({
  ...
  render(){
    ...
    let {renewalReasons} = this.state;
    let {renewal,legacyDemands,agreementNumber,natureOfAllotment,paymentCycle,rent,timePeriod,commencementDate,expiryDate} = this.state.agreement;
    ...
    const renderOption=function(data) {
        if(data)
        {
          ...
          const renderLand=function(){
       return(
       <div className="form-section" id="landAssetDetailsBlock">
           <h3>Asset Details </h3>
 ...
 const renederRenewalDetails = function(){
   return(
         ...
         <div className="form-section-inner">
             ...
             <div className="row">
                 <div className="col-sm-6">
                     <div className="row">
                         <div className="col-sm-6 label-text">
                             ...
                             <label for="renewal.rent" className="categoryType">Rent
                             <span>*</span>
                             </label>
                         </div>
                         <div className="col-sm-6">
                           <div className="text-no-ui">
                               <span>₹</span>
                             <input type="number" min="0" name="renewal.rent" id="renewal.rent" onChange={(e)=>{handleChange(e,"renewalRent")}} />
                           </div>
                         </div>
                     </div>
                 </div>
                 <div className="col-sm-6">
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                             <select name="timePeriod" id="timePeriod" className="selectStyle">
             ...
             <div className="row">
               <div className="col-sm-6">
                   <div className="row">
                       <div className="col-sm-6 label-text">
                           <label for="renewal.securityDeposit">Security Deposit
                           <span>*</span>
                           </label>
                       </div>
                       <div className="col-sm-6">
                           <input type="number" min="0" id="renewal.securityDeposit" name="renewal.securityDeposit"/>
                       </div>
                   </div>
               </div>
                 <div className="col-sm-6">
                     <div className="row">
                         ...
                         <div className="col-sm-6">
                           <div className="text-no-ui">
                               <span className="glyphicon glyphicon-calendar"></span>
                             <input type="text" className="datepicker" id="securityDepositDate" name="securityDepositDate"/ >
                         </div>
                       </div>
                     </div>
                 </div>
             ...
             <div className="row">
                 <div className="col-sm-6" id="rendCalculatedMethod">
                     <div className="row">
                         <div className="col-sm-6 label-text">
                             <label for="rentIncrementMethod">Method by increase in rent is calculated during renewal
                             <span>*</span>
                             </label>
                         </div>
                         <div className="col-sm-6">
                                 <select name="rentIncrementMethod" id="rentIncrementMethod" className="selectStyle">
                 ...
                 <div className="col-sm-6">
                     <div className="row">
                         <div className="col-sm-6 label-text">
                             <label for="reasonForRenewal">reasonForRenewal
                             <span>*</span>
                             </label>
                         </div>
                         <div className="col-sm-6">
                                 <select name="reasonForRenewal" id="reasonForRenewal" className="selectStyle">
    ...
    return(
      ...
      <form  id="renewalAgreementForm" name="renewalAgreementForm" >
      <fieldset>
              {renderLand()}
              {renderAllottee()}
              ...
              <div className="text-center">
                <button type="button" className="btn btn-submit" id="close">Close</button> &nbsp;&nbsp;
                  <button type="button" id="renewalAgreement" className="btn btn-submit">Submit</button>
              </div>
