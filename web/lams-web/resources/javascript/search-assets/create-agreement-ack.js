        ...
        <div>
          <div className="form-section">
            <form>
              ...
              <h3> <center><font color="ass"> {getUrlVars()["action"] ? (getUrlVars()["action"].toLowerCase() == "approve" ? "Approve: Agreement Approved." : (getUrlVars()["action"].toLowerCase() == "forward" ? "Forward: Agreement forwarded to " + (getUrlVars()["name"] ? decodeURIComponent(getUrlVars()["name"]) : "-") : "Agreement rejected and forwarded to " + (getUrlVars()["name"] ? decodeURIComponent(getUrlVars()["name"]) : "-"))) : "Agreement Created"} </font> </center></h3>
