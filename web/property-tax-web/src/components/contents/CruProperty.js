      ...
      <div className="unitsList">
          ...
          <Col xs={12} md={3} sm={6}>
              <SelectField
                ...
                errorText={fieldErrors.unit ?(fieldErrors.unit.unitType ? <span style={{position:"absolute", bottom:-11}}>{fieldErrors.unit.unitType}</span>:"" ): ""}
                value={cruProperty.unit ? cruProperty.unit.roomType : ""}
                onChange={(event, index, value) => {
                    var e = {
                      target: {
                        value: value
                    ...
                    handleChangeNextOne(e,"unit" ,"roomType", true, "")}
                }
                floatingLabelFocusStyle={styles.floatingLabelFocusStyle}
                underlineStyle={styles.underlineStyle}
                underlineFocusStyle={styles.underlineFocusStyle}
              >
                  {renderOption(this.state.roomtypes)}
              </SelectField>
          </Col>
          <Col xs={12} md={3} sm={6}>
              <SelectField
          ...
          <Col xs={12} md={3} sm={6}>
              <DatePicker
                ...
                defaultDate={cruProperty.unit ? new Date(cruProperty.unit.constructionDate) : new Date()}
                onChange={(event,date) => {
                    var e = {
                      target:{
                          value: date
          ...
          <Col xs={12} md={3} sm={6}>
              <DatePicker
                ...
                defaultDate={cruProperty.unit ? new Date(cruProperty.unit.effectiveDate) : new Date()}
                onChange={(event,date) => {
                    var e = {
                      target:{
                          value: date
          ...
          <Col xs={12} md={3} sm={6}>
              <DatePicker
                ...
                defaultDate={cruProperty.unit ? new Date(cruProperty.unit.bpaDate) : new Date()}
                onChange={(event,date) => {
                    var e = {
                      target:{
                          value: date
                                              ...
                                              if(i){
                                                return (<tr key={index}>
                                                    ...
                                                    <td>
                                                     ...
                                                     <FloatingActionButton mini={true} style={styles.floatButtonMargin} onClick={ () => {deleteObject("floors", index);}}>
                                              ...
                                              if(i){
                                                return (<tr key={index}>
                                                    ...
                                                    <FloatingActionButton mini={true} style={styles.floatButtonMargin} onClick={ () => {
                                                     ...
                                                     <FloatingActionButton mini={true} style={styles.floatButtonMargin} onClick={ () => {deleteNestedObject("floor", "units", index);}}>
                                                         <i className="material-icons">delete</i>
                                                     </FloatingActionButton>
                                                    </td>
                                                  </tr>)
