...
export default class GisAnalysisReport extends Component {
  ...
  componentDidMount() {
    Promise.all([
      Api.commonApiPost(
        ...
        { size: TOP_COMPLAINTS_REPORT_LENGTH },
  ...
  render() {
    ...
    const city =
      this.state.cityDetails && this.state.cityDetails.tenant[0].city;
            ...
            <Card>
              ...
              <div style={{ width: '100%', height: 400 }}>
                <CommonGisReportView
                  kml={kml}
                  cityLatLng={cityLatLng}
                  params={{ type: 'wardwiseregistered' }}
                  color={'#F44336'}
                />
              </div>
            </Card>
