...
class ClosureNote extends Component{
  ...
  generatePdf = (ulbLogo, stateLogo, ulbName) => {
    ...
    console.log(this.props.grievance);
        ...
        //Pdf header
        {
          columns: [
            ...
            },
            {
              ...
              text: [
                {text : `${ulbName}\n`, style:'title'},
                {text: `${translate('pgr.title.ClosureNote')}`, style:'subTitle'}
              ],
              margin:[0,12,0,0],
              alignment: 'center'
            },
...

        {
            ...
            widths:['*','auto', 'auto', 'auto'],
						body: [
							...
							['', {text : writeMultiLanguageText("No / क्रमांक")}, {text:':', alignment:'left'}, {text:`${grievance[0].serviceRequestId}`, alignment:'left'}]
						]
					},
          layout: 'noBorders',
          margin:[0, 10, 0, 10]
  ...
  render(){
      return(
        <PdfViewer pdfData={this.state.pdfData} title={translate('pgr.title.ClosureNote')}>
