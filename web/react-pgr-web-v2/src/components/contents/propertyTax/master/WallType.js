...
class WallType extends Component {
  ...
  handleChange = (event, index, value) => this.setState({value});
    ...
    render(){
      return(
        <div className="wallType">
            <Card>
                <CardHeader
                    title={<strong style={{color:brown500}}>Search Wall Type</strong>}
                />
                <CardText>
                      <Card>
                          <CardText>
                                  ...
                                  <Row>
                                    ...
                                    <SelectField
                                      ...
                                      >
                                        ...
                                        <MenuItem value={2} primaryText="Brick with Cement" />
                                        <MenuItem value={3} primaryText="Brick with Mud" />
