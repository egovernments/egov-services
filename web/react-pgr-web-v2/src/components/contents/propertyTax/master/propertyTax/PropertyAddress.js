            ...
            <Row>
              <Col xs={12} md={3} sm={6}>
                <TextField
                  ...
                  value={
                    propertyAddress.refPropertyNumber
                      ? propertyAddress.refPropertyNumber
                      : ''
                  }
                  onChange={e =>
              ...
              <Col xs={12} md={3} sm={6}>
                <SelectField
                  ...
                  value={
                    propertyAddress.appComplexName
                      ? propertyAddress.appComplexName
                      : ''
                  }
              ...
              <Col xs={12} md={3} sm={6}>
                <SelectField
                  ...
                  value={
                    propertyAddress.locality ? propertyAddress.locality : ''
                  }
                  onChange={(event, index, value) => {
                    value == -1 ? (value = '') : '';
                    var e = {
                ...
                <div className="addMoreAddress" style={{ width: '100%' }}>
                  <Col xs={12} md={3} sm={6}>
                    <TextField
                      ...
                      value={
                        propertyAddress.cDoorno ? propertyAddress.cDoorno : ''
                      }
                  ...
                  <Col xs={12} md={3} sm={6}>
                    <TextField
                      ...
                      floatingLabelText={
                        <span>
                          {translate(
                            'pt.create.groups.propertyAddress.fields.address1'
                          )}
                          <span style={{ color: '#FF0000' }}> *</span>
                        </span>
                      }
                      ...
                      value={
                        propertyAddress.correspondenceAddress
                          ? propertyAddress.correspondenceAddress
                          : ''
                      }
                      onChange={e =>
                        handleChange(e, 'correspondenceAddress', true, '')
                      }
                      hintText="Address"
                      id="addressTwo"
                      floatingLabelFocusStyle={styles.floatingLabelFocusStyle}
                  ...
                  <Col xs={12} md={3} sm={6}>
                    <TextField
                      ...
                      value={
                        propertyAddress.correspondencePincode
                          ? propertyAddress.correspondencePincode
                          : ''
                      }
                      onChange={e =>
