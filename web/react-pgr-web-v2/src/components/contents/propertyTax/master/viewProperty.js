                ...
                <Card className="uiCard">
                  ...
                  <CardText>
                    <Col xs={12} md={12}>
                      ...
                      >
                        <thead
                          style={{ backgroundColor: '#607b84', color: 'white' }}
                        >
                          <tr>
                            <th>#</th>
                            <th>
                        ...
                        <Row>
                          <Col xs={4} md={3} style={styles.bold}>
                            ...
                            {item.propertyDetail.hasOwnProperty(
                              ...
                              ? item.propertyDetail.assessmentDates[1] !=
                                undefined
                                ? item.propertyDetail.assessmentDates[1].date ||
                                  translate(
                                    'pt.search.searchProperty.fields.na'
                                  )
                                : translate(
                          ...
                          <Col xs={4} md={3} style={styles.bold}>
                            ...
                            {item.propertyDetail.hasOwnProperty(
                              ...
                              ? item.propertyDetail.assessmentDates[0] !=
                                undefined
                                ? item.propertyDetail.assessmentDates[0].date ||
                                  translate(
                                    'pt.search.searchProperty.fields.na'
                                  )
                                : translate(
                          ...
                          <Col xs={4} md={3} style={styles.bold}>
                            ...
                            {item.propertyDetail.hasOwnProperty(
                              ...
                              ? item.propertyDetail.assessmentDates[2] !=
                                undefined
                                ? item.propertyDetail.assessmentDates[2].date ||
                                  translate(
                                    'pt.search.searchProperty.fields.na'
                                  )
                                : translate(
                          ...
                          <Col xs={4} md={3} style={styles.bold}>
                            ...
                            {item.propertyDetail.hasOwnProperty(
                              ...
                              ? item.propertyDetail.assessmentDates[3] !=
                                undefined
                                ? item.propertyDetail.assessmentDates[3].date ||
                                  translate(
                                    'pt.search.searchProperty.fields.na'
                                  )
                                : translate(
                          ...
                          <Col xs={4} md={3} style={styles.bold}>
                            ...
                            {item.propertyDetail.hasOwnProperty(
                              ...
                              ? item.propertyDetail.builderDetails.agencyName ||
                                translate('pt.search.searchProperty.fields.na')
                              : translate('pt.search.searchProperty.fields.na')}
                          </Col>
                          <Col xs={4} md={3} style={styles.bold}>
                ...
                <Card className="uiCard">
                  <CardHeader
                    ...
                    title={
                      <div style={styles.headerStyle}>
                        {translate(
                          'pt.create.groups.propertyAddress.taxDetails'
                        )}
                      </div>
                    }
                  />
                        ...
                        >
                          <thead>
                            <tr>
                              ...
                              <th>
                                {translate(
                                  'pt.create.groups.propertyAddress.propertyTax'
                                )}
                              </th>
                              <th>
                                {translate(
                                  'pt.create.groups.propertyAddress.educationCess'
                                )}
                              </th>
                              <th>
                                {translate(
                                  'pt.create.groups.propertyAddress.libraryCess'
                                )}
                              </th>
                              <th>
                                {translate(
                                  'pt.create.groups.propertyAddress.totalTax'
                                )}
                              </th>
                              <th>
                                {translate(
                                  'pt.create.groups.propertyAddress.totalTaxDue'
                                )}
                              </th>
                            </tr>
                          </thead>
                    ...
                    <RaisedButton
                      ...
                      onClick={() => {
                        this.props.history.push(
                          '/propertyTax/view-dcb/' + item.upicNumber
                        );
                      }}
                    />
                  </div>
