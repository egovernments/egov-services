...
class SpecialNoticeCertificate extends Component{
  ...
  var docDefinition = {
    ...
    content: [
      ...
      },
      {
        table: {
          ...
          body: [
            ...
            ['', {text : writeMultiLanguageText("Notice No. / नोटीस क्रं")}, {text:':', alignment:'left'}, {text:`${specialNotice.noticeNumber || '-'}`, alignment:'left'}]
          ]
        },
        layout: 'noBorders',
        margin:[0, 0, 0, 10]
      ...
      {
        text : writeMultiLanguageText(`Subject / विषय :  Special Notice – New Assessment\nReference / संदर्भ : आपला अर्ज क्रमांक ${specialNotice.applicationNo || "ERROR"} दिनांक ${epochToDate(specialNotice.applicationDate) || "ERROR"}`),
        margin:[0, 0, 0, 10],
        alignment: 'center'
      },
      ...
      {
        text : writeMultiLanguageText(`संदर्भिय विषयांन्वये कळविण्यात येते की, आपल्या मालमत्तेची नवीन / सुधारीत कर आकारणी करण्यात आलेली आहे.  मालमत्ता क्रमांक ${specialNotice.upicNo || "ERROR"} - ${ownersText || "ERROR"} यांच्या नावे नोंद असून, मालमत्ता कर आकारणीचा तपशील खालीलप्रमाणे आहे.`),
        margin:[0, 0, 0, 10]
      },
          ...
          widths: ['*', '*', '*', '*', '*', '*', '*'],
            ...
            //header
  					[
  					    ...
  					    {text: 'Unit Details', style: 'tableHeader', alignment: 'left'},
                {text: 'Usage', style: 'tableHeader', alignment: 'left'},
                {text: 'Construction', style: 'tableHeader', alignment: 'left'},
                {text: 'Assessable Area', style: 'tableHeader', alignment: 'left'},
...

      {
        ...
        margin:[0, 0, 0, 10],
          ...
          widths: ['auto', 'auto'],
            ...
            //header
  					[
  					    {text: 'Tax Description', style: 'tableHeader', alignment: 'left'},
      ...
      {
        text : writeMultiLanguageText("सदर आकारणी जर तुम्हाला मान्य नसेल तर ही नोटीस मिळाल्या पासून 1 महिन्याचे मुदतीचे आत मुख्यधिकारी यांचकडे फेर तपासणी करता अर्ज करावा. जर 1 महिन्याचे आत सदरहून आकारणी विरुध्द तक्रार अर्ज प्राप्त झाला नाही तर वर नमुद केल्या प्रमाणे आकारणी कायम करण्यात येईल, याची नोंद घ्यावी."),
      },
