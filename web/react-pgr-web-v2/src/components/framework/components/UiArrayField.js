					        	...
					        	<Row>
									<Col xs={12} md={8}>
										<TextField 
											...
											errorText = {this.state.currentValue && this.props.item.pattern && !new RegExp(this.props.item.pattern).test(this.state.currentValue) ? (this.props.item.patternErrMsg || "Invalid Pattern") : ""}
											onChange = {(e) => {
												if(e.target.value) {
									...
									<Col xs={12} md={4}>
										<FlatButton
											...
											disabled = {!this.state.currentValue || (this.state.currentValue && this.props.item.pattern && !new RegExp(this.props.item.pattern).test(this.state.currentValue))}
											secondary = {true}
											style = {{"marginTop": 39}}
											onClick = {(e) => {
												...
												this.setState({ 
													...
													this.props.handler({target: { value: this.state.valueList }}, this.props.item.jsonPath, this.props.item.isRequired ? true : false, '', this.props.item.requiredErrMsg, this.props.item.patternErrMsg)
												});
