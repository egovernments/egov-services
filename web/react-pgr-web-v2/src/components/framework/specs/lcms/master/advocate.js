var dat = {
  'lcms.search': {
    ...
    result: {
      ...
      resultIdKey: 'code',
      rowClickUrlUpdate: '/update/lcms/advocate/{code}',
      rowClickUrlView: '/view/lcms/advocate/{code}',
    },
  },
  'lcms.create': {
    numCols: 4,
      ...
      // },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            type: 'window',
            displayField: 'firstName',
            subPath: 'lcms/master/addadvocate',
            isRequired: false,
            isDisabled: true,
            requiredErrMsg: '',
            patternErrMsg: '',
