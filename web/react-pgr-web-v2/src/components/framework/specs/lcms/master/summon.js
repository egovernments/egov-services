  ...
  'lcms.search': {
    ...
    result: {
      ...
      actionItems: [
        {
          label: 'Assign ADV',
          url: '/update/lcms/assignadvocate/',
        },
        {
          label: 'Case Reg',
          url: '/update/lcms/caseregistration/',
        },
        {
          label: 'Vakalat',
          url: '/update/lcms/vakalatnama/',
        },
        {
          label: 'Hearing',
          url: '/update/lcms/hearingdetails/',
        },
        {
          label: 'ParaWise',
          url: '/update/lcms/parawisecomments/',
        },
        {
          label: 'Ref Evidence',
          url: '/update/lcms/referenceevidence/',
        },
      ],
      header: [
        {
      ...
      resultPath: 'cases',
      rowClickUrlUpdate: '/update/lcms/casedetails/{code}',
      rowClickUrlView: '/view/lcms/casedetails/{code}',
    },
  },
  'lcms.create': {
    numCols: 4,
