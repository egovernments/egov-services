...
class Transaction extends Component {
  ...
  initData() {
    let self = this;
    specifications = require(`../../framework/specs/asset/transaction/transferAsset`)
      .default;
  ...
  handleChange = (
    ...
    if (
      property.search('isRadio') != -1 &&
      property.indexOf('transactionType') == -1
    ) {
      let _indexVal = property.split('[')[1].split(']')[0];
      if (
        formData.Disposal.Assets &&
        self.props.formData.Disposal.Assets.length
      ) {
  ...
  create = e => {
    ...
    if (formData.Disposal['assetId']) {
      ...
      if (
        !formData.Disposal.remarks ||
        formData.Disposal.remarks == null ||
        formData.Disposal.remarks == ''
      ) {
        ...
        if (
          !formData.Disposal.buyerName ||
          formData.Disposal.buyerName == null ||
          formData.Disposal.buyerName == ''
        ) {
          self.props.toggleSnackbarAndSetText(
            true,
            'Please enter Asset Transfer/Sold to',
            false,
            true
          );
        }
        ...
        if (
          !formData.Disposal.saleValue ||
          formData.Disposal.saleValue == null ||
          formData.Disposal.saleValue == ''
        ) {
          self.props.toggleSnackbarAndSetText(
            true,
        ...
        if (
          !formData.Disposal.disposalReason ||
          formData.Disposal.disposalReason == null ||
          formData.Disposal.disposalReason == ''
        ) {
          self.props.toggleSnackbarAndSetText(
            true,
        ...
        if (
          !formData.Disposal.orderDate ||
          formData.Disposal.orderDate == null ||
          formData.Disposal.orderDate == ''
        ) {
          self.props.toggleSnackbarAndSetText(
            true,
        ...
        if (
          !formData.Disposal.orderNumber ||
          formData.Disposal.orderNumber == null ||
          formData.Disposal.orderNumber == ''
        ) {
          self.props.toggleSnackbarAndSetText(
            true,
        ...
        Api.commonApiPost(
          '/asset-services-maha/assets/dispose/_create',
          '',
          formData,
          '',
          true
      ...
      <div className="SearchResult">
        ...
        >
          ...
          <div style={{ textAlign: 'center' }}>
            <br />
            <UiButton
              item={{ label: 'Search', uiType: 'submit' }}
              ui="google"
            />
            <br />
          </div>
