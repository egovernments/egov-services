              ...
              <tbody>
                ...
                <tr>
                  <td colSpan={3}>
                    ...
                    <br />
                    <div style={{ textAlign: 'center' }}>
                      <b>Subject</b> /विषय : सन 2017 - 18 थकबाकी नसल्याचे
                      प्रमाणपत्र मिळणेबाबत.<br />
                      <b>Reference</b> / संदर्भ : आपला अर्ज क्रमांक Application
                      No दिनांक{' '}
                      {getVal('Receipt[0].Bill[0].billDetails[0].billDate')}
                    </div>
                    <br />
                    <div style={{ textAlign: 'left' }}>महोद्य / महोद्या ,</div>
                    <br />
                    <div style={{ textAlign: 'center' }}>
                      संदर्भिय विषयांन्वये प्रमाणित करण्यात येते की, पाणी
                      क्रमांक Consumer No,
                      {getVal('Receipt[0].Bill[0].payeeName')} यांच्या नावे नोंद
                      असून, सन financial year पर्यंतचा संपुर्ण पाणी रक्कम भरलेली
                      असून, कोणतीही थकबाकी येणे नाही.
                    </div>
                    <br />
                    <div style={{ textAlign: 'right' }}>
                      कर अधिक्षक,<br />
