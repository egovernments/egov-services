...
class Report extends Component {
  ...
  autoComHandler = (autoObject, path) => {
    ...
    Api.commonApiPost(
      ...
      {},
      false,
      specifications['wc.create'].useTimestamp
    ).then(
      function(res) {
  ...
  generateReceipt = response => {
    ...
    ServiceRequest.moduleObject.Connection.acknowledgementNumber =
  ...
  pay = () => {
    ...
    var ServiceRequest = {
      ...
      deviceId: 'deviceId',
      accountId: 'accountId',
      firstName: ConnectionObject.Connection.withProperty
        ? ConnectionObject.Connection.property.nameOfApplicant
        : ConnectionObject.Connection.connectionOwner.name,
      lastName: 'firstName',
      phone: 'phone',
      description: '',
      consumerCode: '',
