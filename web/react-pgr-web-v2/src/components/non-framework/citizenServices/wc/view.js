  ...
  updateStatusAndComments = ServiceRequest => {
    ...
    if (ServiceRequest.documents && ServiceRequest.documents.length) {
      for (var i = 0; i < ServiceRequest.documents.length; i++) {
        ...
        if (ServiceRequest.documents[i].isFinal !== true) delete ServiceRequest.documents[i].isFinal;
      }
    }
  ...
  render() {
    ...
    return (
      <div className="Report">
        ...
        {!self.state.showReceipt ? (
          <form id="printable">
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              self.state.ServiceRequest &&
              (self.state.ServiceRequest.additionalFee > 0 && self.state.ServiceRequest.additionalFee != 12345) ? (
                <RaisedButton primary={true} label={'Pay Fee'} onClick={self.payFee} />
              ) : (
                ''
              )}
            </div>
                  ...
                  <Table responsive style={{ fontSize: 'bold' }} id="ReceiptForWcAPartOne1" bordered condensed>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: 'center' }}>Receipt For : Water Connection</td>
                  ...
                  <Table id="ReceiptForWcAPartTwo" responsive bordered condensed>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colSpan={6}>Application for New Water Connection</td>
                      </tr>
        ...
        <Dialog title="Mark documents as Final" modal={false} open={self.state.open2} autoScrollBodyContent={true}>
          <div>
