      ...
      <div>
        ...
        >
          <Tabs>
            ...
            <Tab label={translate('employee.Jurisdictions.title')}>
              <div>{self.renderJurisdiction()}</div>
            </Tab>
            <Tab label={translate('employee.service.title')}>
              <div>{self.renderService()}</div>
            </Tab>
            <Tab label={translate('employee.other.title')}>
