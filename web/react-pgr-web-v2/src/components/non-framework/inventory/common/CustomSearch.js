...
export default class CustomSearch extends Component {
  ...
  render() {
    ...
    let isEnableUpdateViewBtn =
      (tableSelectionData && tableSelectionData.length === 1) || false;
    let isEnableDeleteBtn =
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <UiButton
              item={{
                ...
                uiType: 'button',
                primary: true,
                isDisabled: !isEnableUpdateViewBtn,
              }}
              ui="google"
              handler={this.view}
            />&nbsp;&nbsp;
            ...
            <UiButton
              item={{
                ...
                uiType: 'button',
                primary: true,
                isDisabled: !isEnableDeleteBtn,
              }}
              ui="google"
              handler={this.delete}
            />&nbsp;&nbsp;
            <UiButton
              item={{ label: 'Add', uiType: 'button', primary: true }}
              ui="google"
              handler={this.redirectToUrl.bind(this, 'rowClickUrlAdd')}
            />
            <br />
            {showResult && (
              <CustomUiTable
