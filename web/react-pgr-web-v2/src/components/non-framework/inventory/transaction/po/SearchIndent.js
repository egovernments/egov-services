...
import SearchForCreate from '../../common/SearchForCreate';

import template from '../../../../framework/specs/inventory/transaction/searchIndentPO'

class SearchIndent extends Component {
  ...
  render(){
    ...
    return (
      <SearchForCreate {...this.props} templateObj={template}
