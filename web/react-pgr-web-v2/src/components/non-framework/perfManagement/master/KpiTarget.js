            ...
            self.props.toggleSnackbarAndSetText(
              ...
              translate(
                self.props.actionName == 'create'
                  ? 'Created Successfully Ref No. is ' + response.summons[0].summonReferenceNo
          ...
          <Row>
            ...
            <Col xs={6} md={6}>
              <div style={{ textAlign: 'right', marginRight: '16px' }}>
                ...
                {actionName == 'create' && (
                  <UiButton
                    item={{ label: 'Save', uiType: 'submit', isDisabled: isFormValid ? false : true }}
                    icon={
                ...
                {actionName == 'update' && (
                  <UiButton
                    item={{ label: 'Update', uiType: 'submit', isDisabled: isFormValid ? false : true }}
                    icon={
                      <i style={{ color: 'white' }} className="material-icons">
                        update
                      </i>
