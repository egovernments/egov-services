...
class CreateLicenseDocumentType extends Component {
  ...
  initData() {
    ...
    specifications = require(`../../../framework/specs/tl/master/LicenseDocumentType`)
      .default;
  ...
  autoComHandler = (autoObject, path) => {
    ...
    Api.commonApiPost(
      ...
      {},
      false,
      specifications[`tl.create`].useTimestamp
    ).then(
      function(res) {
  ...
  create = e => {
    ...
    for (var i = 0; i < documentTypeArr.length; i++) {
      ...
      if (
        formData &&
        formData.hasOwnProperty('documentTypesPartOne') &&
        formData.documentTypesPartOne.hasOwnProperty('applicationType')
      ) {
        documentTypeArr[i]['applicationType'] =
          formData.documentTypesPartOne.applicationType;
      }

      if (
        formData &&
        formData.hasOwnProperty('documentTypesPartOne') &&
        formData.documentTypesPartOne.hasOwnProperty('category')
      ) {
      ...
      if (
        formData &&
        formData.hasOwnProperty('documentTypesPartOne') &&
        formData.documentTypesPartOne.hasOwnProperty('subCategory')
      ) {
        documentTypeArr[i]['subCategory'] =
          formData.documentTypesPartOne.subCategory;
      }
