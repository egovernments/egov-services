...
class updatePenaltyRates extends Component {
  state = {
    pathname: '',
  };
  constructor(props) {
  ...
  calculatefeeMatrixDetails = (isAdd = false) => {
    ...
    console.log(penaltyLocalResult[0].applicationType);
    self.props.handleChange(
      { target: { value: penaltyLocalResult } },
      'penaltyRates'
    );
    ...
    if (isAdd) {
      ...
      if (
        currentData.penaltyRates[0].fromRange >= 0 &&
        currentData.penaltyRates[0].fromRange != null
      ) {
        if (
          ...
          if (
            ...
            let penaltyRatesTwo = {
              applicationType: penaltyLocalResult[0].applicationType,
              fromRange:
                currentData.penaltyRates[currentData.penaltyRates.length - 1]
                  .toRange,
              toRange: '',
                  ...
                  <tr key={index}>
                    <td>
                      {index == 0 ? (
                        <TextField
                          ...
                          errorText={
                            fieldErrors['penaltyRates[' + index + '].fromRange']
                          }
                          onChange={e =>
                            handleChange(
                              e,
                    ...
                    <td>
                      <TextField
                        ...
                        errorText={
                          fieldErrors['penaltyRates[' + index + '].toRange']
                        }
                        onChange={e =>
                          handleChange(
                            e,
                    ...
                    <td>
                      <TextField
                        ...
                        errorText={
                          fieldErrors['penaltyRates[' + index + '].rate']
                        }
                        onChange={e =>
                          handleChange(
                            e,
...
export default connect(mapStateToProps, mapDispatchToProps)(updatePenaltyRates);
