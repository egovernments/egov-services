  ...
  initData() {
    ...
    Api.commonApiPost('/works-masters/v1/scheduleofrates/_search')
      .then(response => {
        if (response) {
          ...
          let values = jp.query(
            response,
            '$.scheduleOfRates.*.scheduleCategory'
          );
          let dropDownData = [];
          ...
          self.props.setDropDownData(
            'detailedEstimate.scheduleOfRates',
            dropDownData
          );
        }
      })
    ...
    Api.commonApiPost('/works-estimate/v1/abstractestimates/_search', {
      ...
      .then(function(response) {
        console.log(
          '----locality----' + response.abstractEstimates[0].ward.code
        );
        handleChange(
          response.abstractEstimates[0].abstractEstimateDetails[0].projectCode
            .code,
        ...
        handleChange(
          new Date(),
          'detailedEstimates[0].estimateDate',
          '',
          '',
          '',
          ''
        ...
        handleChange(
          response.abstractEstimates[0].abstractEstimateNumber,
          'detailedEstimates[0].estimateNumber',
          '',
          '',
          '',
        ...
        handleChange(
          response.abstractEstimates[0].abstractEstimateDetails[0]
            .estimateAmount,
          'detailedEstimates[0].workValue',
          '',
          '',
          '',
          ''
        ...
        handleChange(
          response.abstractEstimates[0].department.code,
          'detailedEstimates[0].department.code',
          '',
          '',
          '',
          ''
        ...
        handleChange(
          response.abstractEstimates[0].natureOfWork.code,
          'detailedEstimates[0].natureOfWork.code',
          '',
          '',
          '',
          ''
        ...
        handleChange(
          response.abstractEstimates[0].ward.code,
          'detailedEstimates[0].ward.code',
          '',
          '',
          '',
          ''
        ...
        handleChange(
          response.abstractEstimates[0].locality.code,
          'detailedEstimates[0].locality.code',
          '',
          '',
          '',
          ''
        ...
        handleChange(
          response.abstractEstimates[0].workCategory,
          'detailedEstimates[0].workCategory',
          '',
          '',
          '',
          ''
        ...
        handleChange(
          response.abstractEstimates[0].beneficiary,
          'detailedEstimates[0].beneficiary',
          '',
          '',
          '',
          ''
        ...
        handleChange(
          response.abstractEstimates[0].abstractEstimateDetails[0].nameOfWork,
          'detailedEstimates[0].nameOfWork',
          '',
          '',
          '',
          ''
          ...
          if (i) {
            ...
            if (queryStringObject[i].split('=')[1].search('{') > -1) {
              if (
                ...
                let part1 = queryString.substring(
                  0,
                  queryString.lastIndexOf('{')
                );
                // console.log(queryString, queryString.length);
                let part2 = queryString.substring(
                ...
                if (part1.length > 0) {
                  ...
                  id[queryStringObject[i].split('=')[0]] = `${part1}${
                    e.target.value
                  }${part2}`;
                } else {
          ...
          <Card style={styles.marginStyle}>
            <CardHeader
              ...
              title={
                ...
                >
                  {translate('works.create.group.title.sor')}
                </div>
              }
            />
            <CardText>
              <SelectField
                ...
                floatingLabelText={
                  <span>{translate('works.create.scheduleCategory')} </span>
                }
                value={getVal('detailedEstimate.scheduleOfRates')}
                onChange={(event, key, value) => {
                  handleChange(
                    { target: { value: value } },
                    'detailedEstimates[0].estimateActivities[0].scheduleOfRate.name',
                    false
                  );
                }}
              >
                ...
                {this.state.sanctionAuthority &&
                  this.state.sanctionAuthority.map((authority, index) => (
                    <MenuItem
                      value={authority.id}
                      key={index}
                      primaryText={authority.name}
                    />
                  ))}
              </SelectField>
            </CardText>
