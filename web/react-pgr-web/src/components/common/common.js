var localization_EN_Data = {
  ...
  "error.license.number.decimal" : "Please enter only numbers (with optional 2 decimal values)",
    ...
    "pgr.dashboard.top5.complaint.types":"Top 5 Compliant type Trends",
...
"reports.collection.total.count":"Total Receipt Count",
  ...
  //  #--adapter custom messages
    ...
    "ac.create.Plinth.Area": "Plinth Area",
    "ac.create.Cubic.Contents": "Cubic Contents",
    "ac.create.Dimension.of.Structure": "Dimension of Structure (L)",
    "ac.create.Dimension.breadth": "Dimension of Structure (B)",
    "ac.create.Dimension.height": "Dimension of Structure (H)",
    ...
    "ac.create.Security.deposit.retained": "Security deposit retained",
    "ac.create.Security.deposit.realized": "Security deposit realized",
