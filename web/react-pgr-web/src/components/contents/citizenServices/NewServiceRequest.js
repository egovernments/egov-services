...
class NewServiceRequest extends Component{
    ...
    fieldGrouping = (response) => {
      ...
      let formFields = fieldsSortedByOrder.filter((field) => field.variable
