...
class CreateDepartment extends Component {
    submitForm = (e) => {
        ...
        if (this.props.match.params.id) {
            Api.commonApiPost("/egov-common-masters/departments/v1/_update", {}, body).then(function (response) {
                current.setState({
                    open: true
                });
            ...
            Api.commonApiPost("/egov-common-masters/departments/v1/_create", {}, body).then(function (response) {
                current.props.setLoadingStatus('hide');
                current.setState({
                    open: true
                });
                ...
                <form autoComplete="off" onSubmit={(e) => {
                    ...
                    <Card style={styles.marginStyle}>
                        <CardHeader style={{paddingBottom: 0}}
                                    title={< div style={styles.headerStyle}> Create/Update Department
                                        <
                                        /div>}/>
                    ...
                    <div style={{textAlign: 'center'}}>
                        ...
                        <RaisedButton style={{margin: '15px 5px'}} type="submit" disabled={!isFormValid}
