...
// <SelectField fullWidth={true} floatingLabelText="Receiving Center" value={grievanceCreate.receivingcenter?grievanceCreate.receivingcenter:""} onChange={(event, index, value) => {
//   var e = {
//     target: {
//       value: value
//     }
//   };
//   handleChange(e, "receivingcenter", false, "")}} >>
...
//  ))}
//   setCategoryandType({serviceCode : grievanceCreate.serviceCode, groupId : grievanceCreate.serviceCategory})
//  :
//    {this.state.grievanceType.map((grievanceType, index) => (
//        <MenuItem value={grievanceType.serviceCode} key={index} primaryText={grievanceType.serviceName} />
//    ))}
