  ...
  generatePdf = (ulbLogo, stateLogo, ulbName) => {
    ...
    var docDefinition = {
      ...
      content: [
        //Pdf header
        {
          columns: [
            ...
            },
            {
              ...
              text: [
                {text : `${ulbName}\n`, style:'title'},
                {text: `${translate('pgr.title.rejectionLetter')}`, style:'subTitle'}
              ],
              margin:[0,12,0,0],
              alignment: 'center'
            },
        ...
        {
          text :writeMultiLanguageText(`Your Ticket No: ${grievance[0].serviceRequestId} dated ${grievance[0].requestedDatetime.split(' ')[0]} for ${grievance[0].serviceName} is rejected due to following reasons.`),
          margin:[40, 5, 0, 2]
        },
