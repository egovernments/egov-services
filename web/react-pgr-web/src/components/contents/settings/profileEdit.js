                  ...
                  <CardText style={{padding:0}}>
                      <Grid>
                          <Row>
                            ...
                            <Col xs={12}  md={2} sm={3}>
                                <SelectField style={styles.customWidth} errorText={fieldErrors.title
                                  ? fieldErrors.title
                                  : ""} value={profileEdit.title?profileEdit.title:""} onChange={(event, index, value) => {
                                    var e = {
                                      target: {
                                        value: value
                                      }
                                    };
                                    handleChange(e, "title", false, "")}} floatingLabelText="Title " >
                            ...
                            <div className="clearfix"></div>
                              ...
                              <Col xs={12}  md={3} sm={6}>
                                  <DatePicker
                                    floatingLabelText="DOB"
                                      hintText="Full Name"
                                    errorText={fieldErrors.dob ? (fieldErrors.dob ? <span style={{position:"absolute", bottom:-13}}>{fieldErrors.dob}</span> :""): ""}
                                    onChange={(event,date) => {
                                        var e = {
                                          target:{
                                              value: date
                              ...
                              <Col xs={12} md={3} sm={3}>
                                  <SelectField  fullWidth={true} errorText={fieldErrors.preferredLanguage
                                    ? fieldErrors.preferredLanguage
                                    : ""} value={profileEdit.preferredLanguage?profileEdit.preferredLanguage:""} onChange={(event, index, value) => {
                                      var e = {
                                        target: {
                                          value: value
                                        }
                                      };
                                      handleChange(e, "preferredLanguage", false, "")}} floatingLabelText="Preferred Language " >
...
const mapStateToProps = state => {
  return ({profileEdit : state.form.form, files: state.form.files, fieldErrors: state.form.fieldErrors, isFormValid: state.form.isFormValid,isTableShow:state.form.showTable,buttonText:state.form.buttonText});
}
