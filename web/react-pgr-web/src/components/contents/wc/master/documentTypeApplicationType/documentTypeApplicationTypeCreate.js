        ...
        <div className="createDocumentTypeApplicationType">
          <form autoComplete="off" onSubmit={(e) => {submitForm(e)}}>
              <Card style={styles.marginStyle}>
                  <CardHeader  style={{paddingBottom:0}} title={< div style = {styles.headerStyle} > {this.state.id != '' ? 'Update Application Type Document Type' : 'Create Application Type Document Type'} < /div>} />
                          ...
                          <Row>
                              ...
                              {console.log(createDocumentTypeApplicationType.active)}
                                  <Checkbox
                                    ...
                                    defaultChecked = { this.state.id != '' ? (createDocumentTypeApplicationType.active || false) : (createDocumentTypeApplicationType.active || true)}
                                    onCheck = {(e, i, v) => { console.log(createDocumentTypeApplicationType.active, i);
                              ...
                              {console.log(createDocumentTypeApplicationType.Mandatory)}
                                  <Checkbox
                                    ...
                                    onCheck = {(e, i, v) => { console.log(createDocumentTypeApplicationType.Mandatory, i);
          ...
          <Dialog
               title={this.state.id != '' ? "Category Type "+createDocumentTypeApplicationType.name+" Updated Successfully" : "Category Type "+createDocumentTypeApplicationType.name+" Created Successfully"}
               actions={<FlatButton
...
const mapStateToProps = state => {
  return ({createDocumentTypeApplicationType : state.form.form, files: state.form.files, fieldErrors: state.form.fieldErrors, isFormValid: state.form.isFormValid,isTableShow:state.form.showTable,buttonText:state.form.buttonText});
}
