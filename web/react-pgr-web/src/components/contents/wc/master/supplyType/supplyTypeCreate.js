...
class SupplyTypeCreate extends Component {
    ...
    componentWillMount() {
        ...
        if(this.props.match.params.id) {
          console.log();
            ...
            Api.commonApiPost("/wcms/masters/supplytype/_search",{id:this.props.match.params.id},body,false,true).then(function(response){
    ...
    submitForm = (e) => {
      ...
      if(this.props.match.params.id){
          ...
          Api.commonApiPost("/wcms/masters/supplytype/"+body.SupplyType.code+"/_update",{},body,false,true).then(function(response){
          ...
          Api.commonApiPost("/wcms/masters/supplytype/_create",{},body,false,true).then(function(response){
              console.log(response);
              current.setState({
                open: true
              });
