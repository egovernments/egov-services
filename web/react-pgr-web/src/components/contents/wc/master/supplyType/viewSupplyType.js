...
class ViewSupplyType extends Component {
    constructor(props) {
      super(props);
      this.state = {
          id:'',
    ...
    componentWillMount() {
        ...
        if(this.props.match.params.id) {
            ...
            Api.commonApiPost("/wcms/masters/supplytype/_search",{id:this.props.match.params.id},{},false,true).then(function(response){
      ...
      return(
        <div className="viewCategoryType">
              <Card style={styles.marginStyle}>
                  <CardHeader  style={{paddingBottom:0}} title={< div style = {styles.headerStyle} >View Supply Type< /div>} />
...
export default connect(mapStateToProps, mapDispatchToProps)(ViewSupplyType);
