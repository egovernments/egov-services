...
class ViewWaterSourceType extends Component {
    constructor(props) {
      super(props);
      this.state = {
          id:'',
    ...
    componentWillMount() {
        ...
        if(this.props.match.params.id) {
            ...
            Api.commonApiPost("/wcms/masters/sourcetype/_search",{id:this.props.match.params.id},{},false,true).then(function(response){
                                    ...
                                    <ListGroupItem>
                                      ...
                                      <ListGroupItem>
                                        <Row>
                                          ...
                                          <Col xs={8} md={10}>
                                              {viewWaterSourceType.active? "true": 'false'}
                                          </Col>
                                        </Row>
                                      </ListGroupItem>
                                  </ListGroup>
...
const mapStateToProps = state => {
  return ({viewWaterSourceType : state.form.form, files: state.form.files, fieldErrors: state.form.fieldErrors, isFormValid: state.form.isFormValid});
}
