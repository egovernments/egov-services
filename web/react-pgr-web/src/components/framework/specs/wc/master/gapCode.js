var dat = {
	"wc.create": {
		"numCols": 12/3,
		"url": "/wcms/masters/gapcode/_create",
			...
			},
      {
				...
				"fields": [
          {
            ...
            "url": "/wcms/masters/gapcode/logic/_search?&active=true|$..key|$..object",
            "isRequired": true,
            "isDisabled": false,
            "requiredErrMsg": "",
            "patternErrMsg": ""
          },
          {
            ...
            "pattern": "",
            "type": "singleValueList",
            "url": "/wcms/masters/gapcode/lastmonths/_search?&active=true|$..key|$..object",
            "isRequired": true,
            "isDisabled": false,
            "requiredErrMsg": "",
            "patternErrMsg": ""
	...
	"wc.search": {
		"numCols": 12/3,
		"url": "/wcms/masters/gapcode/_search",
		"tenantIdRequired": true,
		...
		"groups": [
				...
				"fields": [
          {
            ...
            "pattern": "",
            "type": "singleValueList",
            "url": "/wcms/masters/gapcode/_search?&active=true|$..name|$..name",
            "isRequired": false,
            "isDisabled": false,
            "requiredErrMsg": "",
            "patternErrMsg": ""
	...
	"wc.view": {
		"numCols": 12/3,
		"url": "/wcms/masters/gapcode/_search?ids={id}",
		"tenantIdRequired": true,
		"useTimestamp": true,
		"objectName": "Gapcodes",
		"groups": [
	...
	"wc.update" : {
		"numCols": 12/3,
		"searchUrl": "/wcms/masters/gapcode/_search?ids={id}",
    "url":"/wcms/masters/gapcode/_update",
		"tenantIdRequired": true,
		"useTimestamp": true,
		"objectName": "Gapcodes",
		"groups": [
