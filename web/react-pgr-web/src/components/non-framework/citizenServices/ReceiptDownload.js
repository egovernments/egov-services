		...
		return (
			<div>
				...
				{self.state.Receipt && self.state.Receipt[0] ? (
					<div id="allCertificates">{Receipt && Receipt[0] ? <Col md={12} >
                      <Card>
                        <CardHeader title={<strong>Receipt for: {this.props.match.params.page == "watercharge" ? "Water Charge" : "Property Tax"}</strong>}/>
                        <CardText>
                      ...
                      <img src="./temp/images/AS.png" height="60" width="60"/>
                                      ...
                                      <tr>
                                          <td colSpan={3} style={{textAlign:"left"}}>
                                            {this.props.match.params.page == "watercharge" ? "Consumer code" : "Assessment number"} : {Receipt[0].Bill[0].billDetails[0].consumerCode}<br/>
                              ...
                              <Table id="ReceiptForWcAPartTwo" responsive bordered condensed>
                                  <tbody>
                                      ...
                                      <tr>
                                          <td >
                                            {Receipt[0].Bill[0].billDetails[0].billNumber + "-" + getFullDate(Receipt[0].Bill[0].billDetails[0].receiptDate)}

                                          </td>
                                          <td>
                                            {self.props.match.params.page == "watercharge" ? "Water" : "Property"} No dues
                                          </td>
                                          <td>
                                            00
                                          </td>
                                      ...
                                      <tr>
                                          <td colSpan={4}>Amount Paid (in words): Rupees {self.int_to_words(Receipt[0].Bill[0].billDetails[0].amountPaid).charAt(0).toUpperCase() + self.int_to_words(Receipt[0].Bill[0].billDetails[0].amountPaid).slice(1)} only</td>
                                          <td colSpan={4}></td>
                                      </tr>
                                      <tr>
                                        <td colSpan={8}>
                    ...
                    <td colSpan={2}>
                      ...
                      <span>{
                        ...
                        ? "" 
                        : <Col md={12}>{
                        	self.props.match.params.page == "extract" ? (<Card>
		                      ...
		                      <CardText>
		                            <Table responsive style={{fontSize:"bold", "marginBottom": "20px"}} id="CertificateForWc" bordered condensed>
			                            ...
			                            <CardHeader title={<strong>{"Certificate for: "+(this.props.match.params.page == "propertytax" ? "Property Tax" : "Water Charges")+ " No due"}</strong>}/>
			                            <CardText>
			                                          ...
			                                          <tr>
			                                              <td colSpan={3}>
			                                                ...
			                                                <div style={{textAlign:"center"}}>
			                                                  ...
			                                                  Reference / संदर्भ : {this.props.match.params.sid} आपला अर्ज क्रमांक {Receipt[0].Bill[0].billDetails[0].applicationNo} दिनांक {getFullDate(Receipt[0].Bill[0].billDetails[0].receiptDate)}
			                                                ...
			                                                <div style={{textAlign:"center"}}>
			                                                  ...
			                                                  {Receipt[0].Bill[0].billDetails[0].consumerCode} यांच्या नावे नोंद असून, सन 2017-18  {this.props.match.params.page != "propertytax" ? "पर्यंतचा संपुर्ण पाणी रक्कम भरलेली असून, कोणतीही थकबाकी येणे नाही." : "पर्यंतचा संपुर्ण मालमत्ता कराची रक्कम भरलेली असून, कोणतीही थकबाकी येणे नाही."}
				...
				<div style={{"textAlign": "center"}}>
					{Receipt && Receipt[0] ? <RaisedButton primary={true} label="Download" onClick={() => {self.generatePDF()}}/> : ""}	
				</div>
			</div>
		);
	}
