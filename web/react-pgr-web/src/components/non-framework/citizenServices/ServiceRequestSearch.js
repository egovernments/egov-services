...
class Report extends Component {
  ...
  rowClickHandler = (item) => {
    if(item.serviceCode == "WATER_NEWCONN") {
      var _url = "/non-framework/citizenServices/wc/view/" + encodeURIComponent(item.serviceRequestId);
    } else {
      var _url = "/non-framework/citizenServices/fireNoc/view/" + encodeURIComponent(item.serviceRequestId);
    }
  ...
  render() {
    ...
    return (
      <div className="SearchResult">
        ...
        {!_.isEmpty(mockData) && mockData["wc.search"] && <ShowFields groups={mockData["wc.search"].groups} noCols={mockData["wc.search"].numCols} ui="google" handler={handleChange} getVal={getVal} fieldErrors={fieldErrors} useTimestamp={mockData["wc.search"].useTimestamp || false} addNewCard={""} removeCard={""}/>}
          <div style={{"textAlign": "center"}}>
            <br/>
            <UiButton item={{"label": "Search", "uiType":"submit", "isDisabled": isFormValid ? false : true}} ui="google"/>
            <br/>
            {showResult && <Card className="uiCard">
              ...
              <Table id="searchTable">
                                    ...
                                    <tbody>
                                        {resultList && resultList.length ? resultList.map((item, key)=>{
                                          return (<tr key={key} onClick={() => {rowClickHandler(item)}}>
