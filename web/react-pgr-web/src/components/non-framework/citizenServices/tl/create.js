  ...
  initData() {
    ...
    if(self.props.match.params.status == "pay") {
      ...
      if (this.props.match.params.paymentGateWayRes == "success") {
        Api.commonApiPost("/citizen-services/v1/pgresponse/_validate", {}, {PGResponse:paymentGateWayRes}, null, metaData["tl.create"].useTimestamp, false, null, JSON.parse(localStorage.userRequest)).then(function(res){
          ...
          return (<form onSubmit={(e) => {
                  ...
                  <Row>
                    ...
                    <div style={{"textAlign": "center"}}>
                      ...
                      <br/>
                        <RaisedButton label="Pay" primary={true} onClick={(e) => {self.pay()}} disabled={isFormValid ? false : true}/>
                      <br/>
                    </div>
                  </form>);
        case 1:
