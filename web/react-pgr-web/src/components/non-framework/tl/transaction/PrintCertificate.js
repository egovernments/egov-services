...
class PrintCertificate extends Component{
  ...
  doInitialStuffs = ()=>{
    ...
    Promise.all([
      ...
      Api.commonApiPost("/collection-services/receipts/_search",{consumerCode:applicationNumber, businessCode:TL_BUSINESS_CODE},{tenantId:this.getTenantId(), pageSize:"500"}, false, true)
    ]).then((response) => {
    ...
    content: [
...

      {
        style: 'tableExample',
          ...
          widths:[90, '*', '*', '*', '*', '*'],
            ...
            //header
  					[
  					    {text: 'License Type /\n Sub-Type', style: 'tableHeader', rowSpan: 2, alignment: 'center'},
  					    {text: 'Measurements', style: 'tableHeader', colSpan: 3, alignment: 'center'},
  					    {},
                {},
  					    {text: 'Fee Details', style: 'tableHeader', colSpan: 2, alignment: 'center'},
  					    {}
  					],

  					[
                {},
  					    {text: 'Measuring Parameters', style: 'tableHeader', alignment: 'center'},
  					    {text: 'Input Values', style: 'tableHeader', alignment: 'right'},
  					    {text: 'Units', style: 'tableHeader', alignment: 'center'},
  					    {text: 'Fee Type', style: 'tableHeader', alignment: 'center'},
  					    {text: 'Fee Amount', style: 'tableHeader', alignment: 'right'}
  					],
            ...
            [
              ...
              {text: this.getApplicationFee(license, "NEW"), alignment:'right'}
            ],
...

      {
        table: {
          ...
          body: [
            [
              {text : "Total License Fee"}, {text:':', alignment:'left'}, {text:`${this.getApplicationFee(license, "NEW")}`, alignment:'left'},
              '','',''
            ],
            [
            ...
            [
              ...
              {text : "Expiry Date"}, {text:':', alignment:'left'}, {text: `${epochToDate(license.expiryDate)}`, alignment : 'left'}
            ]
          ]
        },
        layout: 'noBorders',
