...
export default(state = defaultState, action) => {
  switch (action.type) {
    ...
    case "HANDLE_CHANGE_VERSION_TWO":
      ...
      // return {
      //   ...state,
      //   form: _.set(state.form,action.property,action.value),
      //   fieldErrors: {
      //     ...state.fieldErrors,
      //     [action.property]: validationData.errorText
      //   },
...
function validate(isRequired, pattern, name, value, validationData,requiredErrMsg,patternErrMsg) {
  let errorText = "";
  if (isRequired) {
