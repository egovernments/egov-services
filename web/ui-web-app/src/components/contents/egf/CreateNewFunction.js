                                  ...
                                  <Row>
                                    ...
                                    <Col xs={12} md={6}>
                                      <TextField errorText={fieldErrors.name
                                        ? fieldErrors.name
                                        : ""} value={NewFunction.name?NewFunction.name:""} onChange={(e) => handleChange(e, "name", false, "")} hintText="Name" floatingLabelText="Name" />
                                    </Col>
                                    <Col xs={12} md={6}>
                                    <TextField errorText={fieldErrors.code
                                      ? fieldErrors.code
                                      : ""} value={NewFunction.code?NewFunction.code:""} onChange={(e) => handleChange(e, "code", false, "")} hintText="Code " floatingLabelText="Code" />
                                    </Col>
                                  </Row>
                                  <Row>
                                    <Col xs={12} md={6}>
                                      <TextField errorText={fieldErrors.level
                                        ? fieldErrors.level
                                        : ""} value={NewFunction.level?NewFunction.level:""} onChange={(e) => handleChange(e, "level", false, "")} hintText="Level" floatingLabelText="Level" />
                                    </Col>
                                    <Col xs={12} md={6}>
                                      <Checkbox
                                        label="Active"
                                  ...
                                  <Row>
                                    <Col xs={12} md={6}>
                                      <SelectField errorText={fieldErrors.parentType
                                        ...
                                        : ""} value={NewFunction.parentType?NewFunction.parentType:""} onChange={(event, index, value) => {
                                          var e = {
                                            target: {
                                              value: value
                                            }
