    ...
    content: [
...

      {
        table: {
          ...
          body: [
            [{text : "Application No : ", bold:true}, {text:applicationNumber, alignment:'left'}, {text: `Application Date :`, alignment : 'left', bold:true}, {text:applicationDate , alignment : 'left'}],
...

      {
        table: {
          widths:['*','auto'],
          body: [
            ['', {text : writeMultiLanguageText("\n\n\n\n\Signature"), bold:true, alignment:"center"}],
            ['', {text : writeMultiLanguageText(this.getCurrentUserName()), bold:true, alignment:"center"}],
            ['', {text : writeMultiLanguageText(`${ulbName}`), bold:true, alignment:"center"}]
          ]
        },
        layout: 'noBorders',
        margin:[0, 0, 0, 10]
