                                  ...
                                  <ListGroup>
                                    <ListGroupItem>
                                      <Row>
                                        ...
                                        <Col xs={8} md={10}>
                                            {viewDocumentType.code ? viewDocumentType.code : ''}
                                        </Col>
                                      </Row>
                                    </ListGroupItem>
                                      <ListGroupItem>
                                        <Row>
                                          ...
                                          <Col xs={8} md={10}>
                                              {viewDocumentType.name ? viewDocumentType.name : ''}
                                          </Col>
                                        </Row>
                                      </ListGroupItem>
                                      <ListGroupItem>
                                      ...
                                      <ListGroupItem>
                                        <Row>
                                          ...
                                          <Col xs={8} md={10}>
                                              {viewDocumentType.active? "true": 'false'}
                                          </Col>
                                        </Row>
                                      </ListGroupItem>
                                  </ListGroup>
...
const mapStateToProps = state => {
  return ({viewDocumentType : state.form.form, files: state.form.files, fieldErrors: state.form.fieldErrors, isFormValid: state.form.isFormValid});
}
