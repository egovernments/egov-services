...
class CertificateView extends Component {
	...
	getProperty = (cb) => {
    let self = this;
    Api.commonApiPost("pt-property/properties/_search", {"upicNumber": this.props.match.params.srn}, {}, null, true, false, localStorage.getItem("auth-token-temp")).then(function(res) {
		...
		return (
			<div>
				<Card className="uiCard">
                    <CardHeader title={self.props.match.params.isCertificate=="true"?"Certificate ":"Application Info - " + decodeURIComponent(self.props.match.params.srn)}/>
                    <CardText>
                    	<Grid>
                    		<Row>
                    			<Col xs={12} sm={4} md={3}>
                    				<Col style={{textAlign:"left"}} xs={12}>
						              <label><span style={{"fontWeight":500, "fontSize": "13px"}}>{self.props.match.params.isCertificate=="true"?"Certificate ":"Application "} Date</span></label>
						            </Col>
                    			...
                    			<Col xs={12} sm={4} md={3}>
                    				<Col style={{textAlign:"left"}} xs={12}>
						              <label><span style={{"fontWeight":500, "fontSize": "13px"}}>{self.props.match.params.isCertificate=="true"?"Certificate ":"Application "} Type</span></label>
						            </Col>
                    			...
                    			<Col xs={12} sm={4} md={3}>
                    				<Col style={{textAlign:"left"}} xs={12}>
						              <label><span style={{"fontWeight":500, "fontSize": "13px"}}>{self.props.match.params.isCertificate=="true"?"Certificate ":"Application "} Status</span></label>
						            </Col>
				...
				<Dialog
		            ...
		            <div>
		            	{self.props.match.params.isCertificate=="true"?"Certificate not found":"Application number"} not found.
		            </div>
		        </Dialog>
						<div id="allCertificates">
						{
							self.props.match.params.isCertificate=="true" && (ServiceRequest.serviceCode == "PT_NODUES" || ServiceRequest.serviceCode == "WC_NODUES") && Receipt.length>0 &&  <Card className="uiCard">
			                    <CardHeader title={self.props.match.params.isCertificate=="true"?"Certificate ":"Application Info - " + decodeURIComponent(self.props.match.params.srn)}/>
			                    <CardText>
																		...
																		<tr>
																				...
																				<td style={{textAlign:"center"}}>
																						<b>Roha Municipal Council</b><br/>
																						 {ServiceRequest.serviceCode == "PT_NODUES" ? <span>Property Tax Department / करनिर्धारण विभाग</span> : <span>Water Department</span>}
																				</td>
																		...
																		<tr>
																				<td colSpan={3}>
																					...
																					<div style={{textAlign:"center"}}>
																						...
																						Reference / संदर्भ : {ServiceRequest ? ServiceRequest.serviceRequestId : ""} आपला अर्ज क्रमांक {Receipt[0].Bill[0].billDetails[0].applicationNo} दिनांक {getFullDate(Receipt[0].Bill[0].billDetails[0].receiptDate)}
						...
						{
						self.props.match.params.isCertificate=="true" && (ServiceRequest.serviceCode == "PT_EXTRACT") && Receipt.length>0 && <Card>
<CardHeader title={<strong>{"Certificate for: "+(ServiceRequest.serviceCode == "PT_EXTRACT"?"Property Tax":"Water Charge")+ " Extract"}</strong>}/>
<CardText>
					...
					<tbody>
							<tr>
									...
									<td style={{textAlign:"center"}} colSpan={4}>
										<b>Roha Municipal Council</b><br/>
										{ServiceRequest.serviceCode == "PT_EXTRACT" ? <span>Property Tax Department / करनिर्धारण विभाग</span> : <span>Water Department</span>}
									</td>
			...
			<span style={{textAlign:"right"}}>{translate("This is computer generated receipt no authorised signature required")}</span>
						...
						{
							self.props.match.params.isCertificate=="true" && (ServiceRequest.serviceCode == "PT_EXTRACT" || ServiceRequest.serviceCode == "PT_NODUES" || ServiceRequest.serviceCode == "WC_NODUES") && <div style={{"textAlign": "center"}}>
							<br/>
							 <UiButton handler={()=>{generatePdf("Receipt")}} item={{"label": "Download", "uiType":"button", "isDisabled": false}} ui="google"/>
							</div>
						}
