				...
				case 'google':
					return _react2.default.createElement(
						_RaisedButton2.default,
						{
							...
							label: item.label },
						_react2.default.createElement('input', { id: item.jsonPath.split(".").join("-"), type: 'file', multiple: true, style: { display: 'none' }, onChange: function onChange(e) {
								return _this.props.handler({ target: { value: e.target.files } }, item.jsonPath, item.isRequired ? true : false, '', item.requiredErrMsg, item.patternErrMsg);
							} })
					);
			}
		};
