...
var UiTextArea = function (_Component) {
	_inherits(UiTextArea, _Component);

	function UiTextArea(props) {
		_classCallCheck(this, UiTextArea);

		var _this = _possibleConstructorReturn(this, (UiTextArea.__proto__ || Object.getPrototypeOf(UiTextArea)).call(this, props));

		_this.renderTextArea = function (item) {
