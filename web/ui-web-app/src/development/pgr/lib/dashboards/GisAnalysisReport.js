...
export default class GisAnalysisReport extends Component {
  ...
  render(){
      ...
      let top3Complaints = this.state.topThreeComplaints &&
              ...
              <Card style={{marginBottom:15}}>
                <CardHeader
                 ...
                 <div style={{ width: '100%', height: 400}}>
                   <CommonGisReportView
                     kml={kml} cityLatLng={cityLatLng}
                     totalComplaints={complaintTypeObj.count} params={params}
        ...
        <Grid fluid={true}>
          ...
          <Row>
            <Col sm={6} md={6} lg={6} xs={12}>
              <Card>
                <CardHeader
                  title={translate("pgr.dashboard.gis.registered.title")}/>
                 <div style={{ width: '100%', height: 400}}>
                   <CommonGisReportView kml={kml} cityLatLng={cityLatLng} params={{type:"wardwiseregistered"}} color={"#F44336"}></CommonGisReportView>
                 </div>
              </Card>
            </Col>
            <Col sm={6} md={6} lg={6} xs={12}>
              <Card>
                <CardHeader
                  title={translate("pgr.dashboard.gis.redressed.title")}/>
                 <div style={{ width: '100%', height: 400}}>
                   <CommonGisReportView kml={kml} cityLatLng={cityLatLng} params={{type:"wardwiseresolved"}} color={"#4CAF50"}></CommonGisReportView>
                 </div>
              </Card>
            </Col>
          </Row>
