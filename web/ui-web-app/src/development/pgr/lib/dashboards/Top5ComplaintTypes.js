...
export default class Top5ComplaintTypes extends Component {
  ...
  componentDidMount(){
    ...
    let legends;
    Promise.all([
      Api.commonApiPost("pgr/dashboard/complainttype/topfive",{}, {tenantId:getTenantId()})
    ]).then((responses)=>{
       try{
       ...
       catch(e)
       {
         ...
         this.setState({isFetchingData:false, topFiveComplaintsData, legends});
       }
    }, (err)=> {
            ...
            title={translate("pgr.dashboard.top5.complaint.types")}/>
                <ResponsiveContainer width="100%" aspect={4.0/1.0}>
                  <LineChart data={data} margin={{top: 10, right: 30, left: 0, bottom: 0}}>
                   ...
                   <Legend content={<CustomizedLineChartLegend colors={COLORS} legends={legends} legendNameKey="complaintTypeName"/>} layout="horizontal" verticalAlign="top" align="left" />
