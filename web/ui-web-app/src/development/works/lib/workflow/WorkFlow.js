  ...
  render(){
    ...
    return(
      <Card style={styles.marginStyle}>
        <CardHeader style={{paddingTop:4,paddingBottom:0}} title={<div style={{color:"#354f57", fontSize:18,margin:'8px 0'}}>{translate('works.create.groups.label.workflowDetails')}</div>}/>
        <CardText>
            ...
            <Col xs={12} sm={6} md={4} lg={4}>
              <SelectField fullWidth={true} floatingLabelStyle={styles.floatingLabelStyle}
                ...
                >
                  ...
                  {this.state.workFlowDepartment && this.state.workFlowDepartment.map((department, index) => (
