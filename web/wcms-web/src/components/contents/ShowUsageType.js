    ...
    return (
      <div className="PropertyTaxSearch">
        <form onSubmit={(e) => {
          ...
          <Card>
            <CardHeader title={< strong style = {{color:"#5a3e1b"}} > Modify Usage Type < /strong>}/>
                  ...
                  <Grid>
                    ...
                    <Col xs={12} md={6}>
                      <TextField errorText={fieldErrors.name
                        ? fieldErrors.name
                        : ""} value={propertyTaxSearch.name?propertyTaxSearch.name:""} onChange={(e) => handleChange(e, "name", false, "")} hintText="Name" floatingLabelText="Name" />
                    </Col>
