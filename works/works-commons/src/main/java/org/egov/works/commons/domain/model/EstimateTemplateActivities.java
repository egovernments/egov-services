...
/**
 * An Object that holds Activities for a given Estimate template
 */
@ApiModel(description = "An Object that holds Activities for a given Estimate template")
...
public class EstimateTemplateActivities {
	...
	/**
	 * UOM for the Estimate Template
	 * 
	 * @return uom
	 **/
	@ApiModelProperty(required = true, value = "UOM for the Estimate Template")
	@NotNull
