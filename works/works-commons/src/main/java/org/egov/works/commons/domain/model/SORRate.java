...
/**
 * An Object that hold Rate Details for the given Schedule Of Rate.
 */
@ApiModel(description = "An Object that hold Rate Details for the given Schedule Of Rate.")
...
public class SORRate {
	...
	/**
	 * Rate to be applied for the given range of days
	 * 
	 * @return rate
	 **/
	@ApiModelProperty(required = true, value = "Rate to be applied for the given range of days")
	@NotNull
