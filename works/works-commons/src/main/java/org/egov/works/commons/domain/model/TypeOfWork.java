...
public class TypeOfWork {
	 ...
	 * @return active
	 **/
	@ApiModelProperty(value = "If status of Type Of Work is TRUE then the type of work is active else it is in-active")
	...
	public TypeOfWork parent(TypeOfWork parent) {
		this.parent = parent;
		return this;
	}
