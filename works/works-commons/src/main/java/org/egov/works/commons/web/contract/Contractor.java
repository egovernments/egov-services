...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2017-11-03T11:12:00.881Z")
...
public class Contractor   {
 ...
 @Pattern(regexp="[a-zA-Z0-9-\\\\]+") @Size(max=50)
   ...
   * @return accountCode
  **/
  @ApiModelProperty(value = "Chart of Account Code for the Contractor")
   ...
   * @return ifscCode
  **/
  @ApiModelProperty(value = "IFSC Code of the Bank Account for the Contractor")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, name, code, correspondenceAddress, paymentAddress, contactPerson, email, narration, mobileNumber, panNumber, tinNumber, bank, bankAccountNumber, pwdApprovalCode, exemptedFrom, pwdApprovalValidTill, epfRegistrationNumber, accountCode, ifscCode, contractorClass);
  }
