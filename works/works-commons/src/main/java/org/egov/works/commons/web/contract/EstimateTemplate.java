...
/**
 * An Object that holds Templates defined for Estimate based on Type of Works
...
public class EstimateTemplate {
	...
	/**
	 * If status of Estimate Template is TRUE then the Estimate Template is
	 * active else it is in-active. The default is active.
	 * 
	 * @return active
	 **/
	...
	/**
	 * Type of work for which this Estimate template is belongs to
	 * 
	 * @return typeOfWork
	 **/
	...
	/**
	 * Sub Type of work for which this Estimate template is belongs to
	 * 
	 * @return subTypeOfWork
	 **/
	@ApiModelProperty(value = "Sub Type of work for which this Estimate template is belongs to")
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, name, code, active, description, typeOfWork, subTypeOfWork,
				estimateTemplateActivities, auditDetails);
	}
