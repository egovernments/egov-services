...
public class ReferenceType   {
 ...
 @Pattern(regexp="[a-zA-Z0-9-\\\\]+") @Size(min=1,max=100)
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, referenceType.id) &&
        Objects.equals(this.tenantId, referenceType.tenantId) &&
        Objects.equals(this.name, referenceType.name) &&
        Objects.equals(this.code, referenceType.code);
  }
