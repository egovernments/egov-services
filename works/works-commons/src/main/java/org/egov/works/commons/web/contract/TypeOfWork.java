...
/**
 * An Object that holds Type of Work and Sub Type of work master data. The sub
 * type of work will have parent type of work reference.
 */
...
public class TypeOfWork {
	...
	/**
	 * If status of Type Of Work is TRUE then the type of work is active else it
	 * is in-active. The default is active.
	 * 
	 * @return active
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, typeOfWork.id) && Objects.equals(this.tenantId, typeOfWork.tenantId)
				&& Objects.equals(this.name, typeOfWork.name) && Objects.equals(this.code, typeOfWork.code)
				&& Objects.equals(this.description, typeOfWork.description)
				&& Objects.equals(this.active, typeOfWork.active) && Objects.equals(this.parent, typeOfWork.parent);
	}
