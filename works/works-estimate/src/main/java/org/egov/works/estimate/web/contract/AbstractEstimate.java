...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2017-12-28T06:25:44.665Z")
...
public class AbstractEstimate {
    ...
    private Contractor pmcName = null;
    ...
    /**
     * Epoch time of the Date of Proposal. Default the current date for new estimates and do not allow to modify. This field is
     * user entered for spillover works. Allowed to edit during rejected status or drafts for Spillover Estimates. Future date is
    ...
    /**
     * Unique number for the Abstract Estimate. If the work is spillover then the Abstract Estimate number is user entered.
     * Otherwise it is auto generated. This field is allowed to edit during rejected status or drafts for Spillover Estimates.
...
//    @Valid
    ...
    /**
     * Boolean value if bills created or not. Required only if Abstract Estimate is Spill Over. The grossAmountBilled field needs
     * to be shown in Works detail tab if the billsCreated flag is true for Abstract Estimate.
     * @return billsCreated
     **/
    ...
    /**
     * Epoch time of when the admin santion done. Future date is not allowed to enter in this field. Admin sanction date should be
     * on or after the Date of Proposal.
...
//    @Valid
    ...
    /**
     * Account code of the Abstract Estimate. This data comes from financials. This field is required only if Financial
     * Integration required flag is turned on and it should be mandatory.
     * @return accountCode
     **/
...
//    @Valid
    ...
    /**
     * Boolean value to capture whether the fund available to execute this work. True if Fund available. False if fund not
     * available.
    ...
    /**
     * Boolean vlaue to capture whether the PMC need to appoint or not. True if PMC needs to be appointed. Otherwise the value
     * will be false. The valid values are 'Yes' and 'No'.
     * @return pmcRequired
     **/
    ...
    public AbstractEstimate pmcName(Contractor pmcName) {
        this.pmcName = pmcName;
        return this;
    }

    /**
     * Name of the PMC for PMC type Panel. The PMC(Project Management Consultant) data will fetch from Contractor master based on
     * the boolean flag pmc=true. This field is not required if pmcType is 'New Appointment'.
     * @return pmcName
     **/
...
//    @Valid
    ...
    public Contractor getPmcName() {
        return pmcName;
    }

    public void setPmcName(Contractor pmcName) {
        this.pmcName = pmcName;
    }
    ...
    /**
     * Boolean value to capture whether the Land Asset required. True if Land Asset required. False if the Land Asset value is not
     * required. The values should be shown in UI are 'Yes' and 'No'. This field needs to be shown if Nature of work is 'New'.
    ...
    /**
     * No of Lands. This field needs to be shown if Nature of work is 'New'. If landAssetRequired=Yes then this field is
     * mandatory.
     * @return noOfLands
     **/
...
//    @Valid
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, tenantId, dateOfProposal, abstractEstimateNumber, subject, referenceType, referenceNumber,
                description, department, status, beneficiary, modeOfAllotment, typeOfWork, subTypeOfWork, natureOfWork, ward,
                locality, workCategory, councilResolutionNumber, councilResolutionDate, spillOverFlag, detailedEstimateCreated,
                workOrderCreated, billsCreated, cancellationReason, cancellationRemarks, adminSanctionNumber, adminSanctionDate,
                adminSanctionBy, financialSanctionNumber, financialSanctionDate, financialSanctionBy, workFlowDetails, stateId,
                implementationPeriod, fund, function, budgetGroup, accountCode, scheme, subScheme, fundAvailable,
                fundSanctioningAuthority, pmcRequired, pmcType, pmcName, workProposedAsPerDP, dpRemarks, landAssetRequired,
                noOfLands, otherAssetSpecificationRemarks, deleted, auditDetails, abstractEstimateDetails, sanctionDetails,
                assetDetails, documentDetails);
    }
