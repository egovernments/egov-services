...
public class DetailedEstimateResponse {
	...
	public DetailedEstimateResponse abstractEstimates(List<DetailedEstimate> abstractEstimates) {
		this.abstractEstimates = abstractEstimates;
		return this;
	}

	public DetailedEstimateResponse addAbstractEstimatesItem(DetailedEstimate abstractEstimatesItem) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.responseInfo, detailedEstimateResponse.responseInfo)
				&& Objects.equals(this.abstractEstimates, detailedEstimateResponse.abstractEstimates);
	}
