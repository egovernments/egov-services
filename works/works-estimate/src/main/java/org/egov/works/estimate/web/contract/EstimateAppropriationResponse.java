...
/**
 * Contract class to send response. Array of Estimate Appropriation items are used in case of search results, also multiple  Estimate Appropriation item is used for create and update
 */
...
public class EstimateAppropriationResponse   {
  ...
  **/
  ...
  public EstimateAppropriationResponse addEstimateAppropriationsItem(EstimateAppropriation estimateAppropriationsItem) {
