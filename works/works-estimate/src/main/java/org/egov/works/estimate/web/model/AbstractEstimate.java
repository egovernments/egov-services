...
import org.egov.works.commons.domain.enums.AbstractEstimateStatus;
...
import org.egov.works.commons.domain.model.NatureOfWork;
...
/**
 * Object holds the basic data for a AbstractEstimate
 */
@ApiModel(description = "Object holds the basic data for a AbstractEstimate")
...
public class AbstractEstimate {
	...
	public AbstractEstimate fund(String fund) {
		this.fund = fund;
		return this;
	}
	...
	public AbstractEstimate function(String function) {
	...
	public AbstractEstimate budgetHead(String budgetHead) {
	...
	public AbstractEstimate scheme(String scheme) {
		this.scheme = scheme;
		return this;
	}
	...
	public AbstractEstimate subScheme(String subScheme) {
	...
	public AbstractEstimate department(String department) {
	...
	public AbstractEstimate adminSanctionBy(String adminSanctionBy) {
	...
	public AbstractEstimate technicalSanctionBy(String technicalSanctionBy) {
		this.technicalSanctionBy = technicalSanctionBy;
		return this;
	}

	/**
	 * User who technical sanctioned
	 * 
	 * @return technicalSanctionBy
	 **/
	@ApiModelProperty(value = "User who technical sanctioned")
	...
	/**
	 * Boolean value if work order created or not, Required only if Abstract
	 * Estimate is Spill Over
	 * 
	...
	/**
	 * Boolean value if bills created or not. Required only if Abstract Estimate
	 * is Spill Over
	 * 
	 * @return billsCreated
	 **/
	@ApiModelProperty(value = "Boolean value if bills created or not. Required only if Abstract Estimate is Spill Over")
	...
	/**
	 * Boolean value if spill over or not. Required only if Abstract Estimate is
	 * Spill Over
	 * 
	...
	/**
	 * Reason for cancellation of the Abstract Estimate, Required only while
	 * cancelling Abstract Estimate
	 * 
	...
	/**
	 * Remarks for cancellation of the Abstract Estimate, Required only while
	 * cancelling Abstract Estimate
	 * 
	...
	/**
	 * Boolean value if the detailed estimate created or not. Required only if
	 * Abstract Estimate is Spill Over
	 * 
	...
	public AbstractEstimate asset(String asset) {
		this.asset = asset;
		return this;
	}

	/**
	 * Asset for which this Abstract Estimate created
	 * 
	 * @return asset
	 **/
	@ApiModelProperty(value = "Asset for which this Abstract Estimate created")
	...
	/**
	 * If PMC required is yes then to capture PMC is from Panel or New
	 * Appointment.
	 * 
	 * @return pmcType
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, abstractEstimate.id) && Objects.equals(this.tenantId, abstractEstimate.tenantId)
				...
				&& Objects.equals(this.budgetHead, abstractEstimate.budgetHead)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, abstractEstimateNumber, subject, fund, referenceType, referenceNumber,
				function, description, budgetHead, scheme, subScheme, dateOfProposal, department, adminSanctionNumber,
				adminSanctionDate, adminSanctionBy, abstractEstimateDetails, documentDetails, status, beneficiary,
				modeOfAllotment, typeOfWork, subTypeOfWork, natureOfWork, ward, technicalSanctionNumber,
				technicalSanctionDate, technicalSanctionBy, locality, workCategory, councilResolutionNumber,
				councilResolutionDate, workOrderCreated, billsCreated, spillOverFlag, cancellationReason,
				cancellationRemarks, detailedEstimateCreated, workFlowDetails, stateId, asset, implementationPeriod,
				fundAvailable, fundSanctioningAuthority, pmcRequired, pmcType, pmcName, auditDetails);
	}
