...
public class AbstractEstimateDetails {
    ...
    public static final String SEQUENCE_NAME = "seq_egw_abstractestimate_details";
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, abstractEstimate, nameOfWork, estimateAmount, estimateNumber,
				grossAmountBilled, projectCode, abstractEstimateAppropriations, estimatePhotographsList, auditDetails);
	}
