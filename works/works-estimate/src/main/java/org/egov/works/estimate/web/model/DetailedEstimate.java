...
public class DetailedEstimate {
	...
	private List<EstimatePhotographs> estimatePhotographsList = null;
	...
	/**
	 * Array of Detailed Estimate Details
	 * 
	 * @return abstractEstimateDetails
	 **/
	@ApiModelProperty(value = "Array of Detailed Estimate Details")
	...
	/**
	 * Asstet Values for Abstract Estimate
	 * 
	 * @return assetValues
	 **/
	@ApiModelProperty(value = "Asstet Values for Abstract Estimate")
	...
	public DetailedEstimate estimatePhotographsList(List<EstimatePhotographs> estimatePhotographsList) {
		this.estimatePhotographsList = estimatePhotographsList;
		return this;
	}

	public DetailedEstimate addEstimatePhotographsListItem(EstimatePhotographs estimatePhotographsListItem) {
		if (this.estimatePhotographsList == null) {
			this.estimatePhotographsList = new ArrayList<EstimatePhotographs>();
		}
	...
	public int hashCode() {
		return Objects.hash(id, tenantId, estimateNumber, estimateDate, nameOfWork, description, department,
				...
				grossAmountBilled, cancellationReason, cancellationRemarks, totalIncludingRE, abstractEstimateDetails,
				documentDetails, assetValues, overheadValues, estimatePhotographsList, workFlowDetails, stateId, fund,
				function, functionary, scheme, subScheme, budgetGroup, auditDetails);
	}
