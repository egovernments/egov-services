...
public class RemarksRequest   {
  ...
  public RemarksRequest requestInfo(RequestInfo requestInfo) {
  ...
  **/
  ...
  public RemarksRequest remarks(List<Remarks> remarks) {
    this.remarks = remarks;
    return this;
  }

  public RemarksRequest addRemarksItem(Remarks remarksItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RemarksRequest remarksRequest = (RemarksRequest) o;
    return Objects.equals(this.requestInfo, remarksRequest.requestInfo) &&
        Objects.equals(this.remarks, remarksRequest.remarks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestInfo, remarks);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemarksRequest {\n");
