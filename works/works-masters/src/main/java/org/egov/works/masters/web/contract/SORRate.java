...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2017-12-15T05:57:37.655Z")
...
public class SORRate   {
    ...
    public SORRate isMigrated(Boolean isMigrated) {
        this.isMigrated = isMigrated;
        return this;
    }

    /**
     * Boolean value to identify whether the object is migrated (loaded to system via data entry, excel upload or back end) from older system or created newly in new system.
     * @return isMigrated
     **/
    @ApiModelProperty(value = "Boolean value to identify whether the object is migrated (loaded to system via data entry, excel upload or back end) from older system or created newly in new system.")
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, soRRate.id) &&
                Objects.equals(this.tenantId, soRRate.tenantId) &&
                ...
                Objects.equals(this.isMigrated, soRRate.isMigrated) &&
                Objects.equals(this.auditDetails, soRRate.auditDetails);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, tenantId, scheduleOfRate, fromDate, toDate, rate, deleted, isMigrated, auditDetails);
    }
