package org.egov.works.measurementbook.common.persistence.repository;
...
public abstract class JdbcRepository {
	...
	public Object create(Object ob) {
		// System.out.println(allInsertQuery);
		// ((AuditDetails) ob).setCreatedDate(new Date());
		// ((AuditDetails) ob).setLastModifiedDate(new Date());
	...
	public Boolean uniqueCheck(String fieldName, Object ob) {
		...
		// batchValues.get(0).putAll(paramValues(ob,
		// allIdentitiferFields.get(obName)));
