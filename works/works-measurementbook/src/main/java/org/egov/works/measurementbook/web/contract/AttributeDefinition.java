...
public class AttributeDefinition {
	...
	/**
	 * type of the custom field. Valid types are ('string'[text box],'text'[text
	 * area],'number'[text box allow numbers
	 * only],'datetime'[calender],'singlevaluelist'[drop down for single value
	 * selection],'multivaluelist'[drop down for multi value
	...
	/**
	 * configure if field type are ('singlevaluelist','multivaluelist')
	 * and @values is null.
	 * 
	 * @return url
	 **/
