...
public class ChartOfAccount {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, chartOfAccount.id) && Objects.equals(this.glcode, chartOfAccount.glcode)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, glcode, name, accountCodePurpose, description, isActiveForPosting, parentId, type,
				classification, functionRequired, budgetCheckRequired, majorCode, isSubLedger, auditDetails);
	}
