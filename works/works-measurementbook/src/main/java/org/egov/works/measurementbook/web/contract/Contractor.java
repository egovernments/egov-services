...
public class Contractor {
	...
	/**
	 * Bank of the Contractor Agency/Firm. If Financial integration is true at
	 * state/ULB level configuation then bank is mandatory else its optional.
	 * 
	 * @return bank
	 **/
	...
	/**
	 * Bank Account Number of the Contractor Agency/Firm. If Financial
	 * integration is true at state/ULB level configuation then bank account
	 * number is mandatory else its optional.
	 * 
	...
	/**
	 * Chart of Account Code of the Contractor from Financials. If Financial
	 * integration is true at state/ULB level configuation then accountCode is
	...
	/**
	 * IFSC Code of the Bank Account for the Contractor Agency/Firm. If
	 * Financial integration is true at state/ULB level configuation then
	 * ifscCode is mandatory else its optional.
	 * 
	 * @return ifscCode
	 **/
	...
	/**
	 * The boolean value to indicate whether the contractor Agency/Firm is
	 * PMC(Project Management Consultant). The default value is false.
	 * 
	 * @return pmc
	 **/
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, contractor.id) && Objects.equals(this.tenantId, contractor.tenantId)
				&& Objects.equals(this.name, contractor.name) && Objects.equals(this.localName, contractor.localName)
				...
				&& Objects.equals(this.pmc, contractor.pmc) && Objects.equals(this.status, contractor.status)
				&& Objects.equals(this.auditDetails, contractor.auditDetails);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, name, localName, code, correspondenceAddress, paymentAddress, contactPerson,
				email, narration, mobileNumber, panNumber, tinNumber, bank, bankAccountNumber, pwdApprovalCode,
				exemptedFrom, pwdApprovalValidTill, epfRegistrationNumber, accountCode, ifscCode, contractorClass, pmc,
				status, auditDetails);
	}
