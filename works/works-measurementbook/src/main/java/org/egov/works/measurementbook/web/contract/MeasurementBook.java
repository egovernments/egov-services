...
public class MeasurementBook {
	...
	/**
	 * Reason for cancellation of the Measurement book, Required only while
	 * cancelling Measurement book
	 * 
	...
	/**
	 * Remarks for cancellation of the Measurement book, Required only while
	 * cancelling Measurement book
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, measurementBook.id) && Objects.equals(this.tenantId, measurementBook.tenantId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, mbRefNo, contractorComments, mbDate, mbIssuedDate, mbAbstract, fromPageNo,
				toPageNo, letterOfAcceptanceEstimate, mbContractorBills, status, measurementBookDetails, isLegacyMB,
				mbAmount, approvedDate, documentDetails, workFlowDetails, stateId, cancellationReason,
				cancellationRemarks, auditDetails);
	}
