...
/**
 * An Object that hold details for the given Measuremnet book. At least one data
 * should be given to create an Measurement book
 */
@ApiModel(description = "An Object that hold details for the given Measuremnet book. At least one data should be given to create an Measurement book")
...
public class MeasurementBookDetail {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, measurementBook, quantity, rate, remarks, amount, measurementSheets, partRate,
				reducedRate, auditDetails);
	}
