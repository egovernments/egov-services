...
public class OfflineStatus   {
  ...
  **/
  ...
  public OfflineStatus statusDate(Long statusDate) {
   ...
   /**
   * Epoch time of Offline Status Date. The status and dates order is maintained.  Future date is not allowed to enter in this field. The current row date should be on or after the previous row date of the offline status.
   * @return statusDate
  **/
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, objectType, objectNumber, status, statusDate, remarks, referenceNumber, deleted, auditDetails);
  }
