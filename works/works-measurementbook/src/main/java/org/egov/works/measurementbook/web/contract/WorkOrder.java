...
//    @Valid
 ...
 @Size(min=1)
  ...
  public WorkOrder workOrderDate(Long workOrderDate) {
   ...
   /**
   * Epoch time of Work Order Date. If the Work order is spillover then the Work Order Date is user entered. Otherwise it is default to current date. This field is allowed to edit during rejected status or drafts for Spillover Work Order.
  ...
  **/
  ...
  public WorkOrder workOrderNumber(String workOrderNumber) {
   ...
   /**
   * Work Order Number. Auto generated. If the Work order is spillover then the Work Order number is user entered. Otherwise it is auto generated. This field is allowed to edit during rejected status or drafts for Spillover Work Order.
