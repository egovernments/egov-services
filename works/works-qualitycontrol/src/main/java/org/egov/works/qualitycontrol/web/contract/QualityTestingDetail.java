...
public class QualityTestingDetail   {
  ...
  private QualityTesting qualityTesting = null;
 ...
 @Size(min=2,max=128)
  ...
  public QualityTestingDetail qualityTesting(QualityTesting qualityTesting) {
  ...
  **/
  ...
  public QualityTesting getQualityTesting() {
    return qualityTesting;
  }

  public void setQualityTesting(QualityTesting qualityTesting) {
    this.qualityTesting = qualityTesting;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, qualityTesting, materialName, testName, resultUnit, minimumValue, maximumValue, hodRemarks, coRemarks, auditDetails);
  }
