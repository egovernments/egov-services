...
public class EstimateAppropriationService {
	...
	public List<EstimateAppropriation> save(final EstimateAppropriationRequest estimateAppropriationRequest) {
		...
		for(EstimateAppropriation estimateAppropriation: estimateAppropriationRequest.getEstimateAppropriations()) {
            ...
            budgetRefNumber = idGenerationRepository
					.generateAppropriationNumber(estimateAppropriation.getTenantId(), estimateAppropriationRequest.getRequestInfo());
            estimateAppropriation.setBudgetRefNumber(propertiesManager.getAppropriationNumberPrefix() + budgetRefNumber);
		}
