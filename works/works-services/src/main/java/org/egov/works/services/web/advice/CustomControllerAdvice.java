...
public class CustomControllerAdvice {
	...
	public ErrorRes handleBindingErrors(CustomBindException ex) {
		...
		org.egov.works.services.web.contract.Error error = new org.egov.works.services.web.contract.Error();
		...
		if (errors.hasFieldErrors()) {
			...
			for (org.springframework.validation.FieldError errs : fieldErrors) {
				org.egov.works.services.web.contract.Error err = new org.egov.works.services.web.contract.Error();
	...
	public ErrorRes handleBindingErrors(InvalidDataException ex) {
		...
		List<org.egov.works.services.web.contract.Error> errors = new ArrayList<org.egov.works.services.web.contract.Error>();
		errors.add(error);
