...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2017-12-14T09:26:17.022Z")
...
public class OfflineStatus {
    ...
    /**
     * Referenece number for the particular object. For example the Tender number needs to be captures for Tender Notice document
     * release, Agreement number for Agreement order signed status.
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, tenantId, objectType, objectNumber, objectDate, status, statusDate, remarks, referenceNumber,
                deleted, auditDetails);
    }
