...
public class Overhead   {
 ...
 @Pattern(regexp="[a-zA-Z0-9-\\\\]") @Size(min=1,max=100)
  ...
  public Overhead accountCode(String accountCode) {
   ...
   /**
   * Account code list should be fetch from deduction master of Finance Management
   * @return accountCode
  **/
  @ApiModelProperty(required = true, value = "Account code list should be fetch from deduction master of Finance Management")
  @NotNull
 ...
 @Pattern(regexp="[0-9a-zA-Z_@./#&+-/!(){}\",^$%*|=;:<>?`~ ]") @Size(min=1,max=1024)
  ...
  public Overhead addOverheadRateItem(OverheadRate overheadRateItem) {
   ...
   /**
   * Array of Overhead Details
   * @return overheadRate
  **/
  @ApiModelProperty(required = true, value = "Array of Overhead Details")
  @NotNull
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, overhead.id) &&
        Objects.equals(this.tenantId, overhead.tenantId) &&
        Objects.equals(this.name, overhead.name) &&
        Objects.equals(this.code, overhead.code) &&
