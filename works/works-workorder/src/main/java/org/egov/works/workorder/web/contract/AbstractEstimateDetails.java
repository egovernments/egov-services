...
public class AbstractEstimateDetails {
	...
	/**
	 * Gross Billed amount of the Abstract Estimate Details. This attribute is
	 * required only if billsCreated flag is true for Abstract Estimate.
	 * 
	...
	/**
	 * Project code object refernce for the Abstract Estimate. If the work is
	 * spillover then the project code/Work Identification number is user
	 * entered. Otherwise it is auto generated at the time of Admin Sanction.
	 * 
	 * @return projectCode
	 **/
	 ...
	 * Appropriation required or not is based on whether the Financial
	 * Integration is required or not.
	 * 
	...
	/**
	 * This object holds Budget any documents attached while creating Abstract
	 * Estimate or any documents generated from the system or any photographs
	 * captured for the Abstract Estimate.
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, abstractEstimateDetails.id)
				...
				&& Objects.equals(this.abstractEstimateAppropriations,
						abstractEstimateDetails.abstractEstimateAppropriations)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, abstractEstimate, nameOfWork, estimateAmount, grossAmountBilled, projectCode,
				abstractEstimateAppropriations, documentDetails, auditDetails);
	}
	...
	public String toString() {
		...
		sb.append("    abstractEstimateAppropriations: ").append(toIndentedString(abstractEstimateAppropriations))
				.append("\n");
