...
public class AdvanceRequisition {
	...
	public AdvanceRequisition addAdvanceRequisitionDetailsItem(
			AdvanceRequisitionDetails advanceRequisitionDetailsItem) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, advanceRequisitionNumber, advanceRequisitionDate, arfType, amount, narration,
				status, field, subField, department, scheme, subScheme, fund, fundSource, functionary, voucherNumber,
				payTo, payByDate, referenceNumber, sourcePath, partyBillNumber, partyBillDate, function,
				advanceRequisitionDetails, workFlowDetails, stateId, auditDetails);
	}
