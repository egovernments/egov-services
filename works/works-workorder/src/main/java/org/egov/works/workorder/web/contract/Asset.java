...
public class Asset {
	...
	/**
	 * Anticipated life of asset, This value is being calculated by diving 100
	 * by the depreciation rate. for eg if the depreciation rate is 10%, then
	 * the anticiapted life will be 100/10 which equals 10years.
	 * 
	...
	/**
	 * If Warranty available for the given asset the value will be true, else it
	 * will be false.
	 * 
	...
	/**
	 * Date of the expiry of warranty. This will be required in case warranty
	 * available is true.
	 * 
	...
	/**
	 * value of the asset when it was created originally, will be same as gross
	 * value if the asset is being created from the system.
	 * 
	...
	/**
	 * Options are from the chart of account master for the account code purpose
	 * \"Fixed Asset\", this account field is mandatory only when the voucher
	 * enabled is true, the voucher enabled flag can be accesed from the
	 * mdms(master data service).
	 * 
	 * @return assetAccount
	 **/
	...
	/**
	 * Options are from the chart of account master for the account code purpose
	 * \"Accumulated Depreciation\", this account field is mandatory only when
	 * the voucher enabled is true, the voucher enabled flag can be accesed from
	 * the mdms(master data service).
	 * 
	...
	/**
	 * Options are from the chart of account master for the account code purpose
	 * \"Revaluation Reserve Account\", this account field is mandatory only
	 * when the voucher enabled is true, the voucher enabled flag can be accesed
	 * from the mdms(master data service).
	 * 
	...
	/**
	 * Options are from the chart of account master for the account code purpose
	 * \"Depreciation Expense Account\", this account field is mandatory only
	 * when the voucher enabled is true, the voucher enabled flag can be accesed
	 * from the mdms(master data service).
	 * 
	...
	/**
	 * names of the title documents available for the particular asset, values
	 * will be entered in comma separated format. For example- Fire NOC, Sale
	 * Deed
	 * 
	...
	/**
	 * Total area of Land on which the asset is located. This will be calculated
	 * based on the land asset that is associated with this. If one asset falls
	 * across multiple land, the the total area will be the sum total of all the
	 * areas of the respective land.
	 * 
	 * @return totalArea
	 **/
	...
	/**
	 * Unique code for the asset. This will be auto generated. The format of the
	 * code will be <ULB_NAME>/<Depratmentcode>/<assetCategoryCode>/running
	 * sequence (for eg- mh.roha/REV/Building/12).
	 * 
	 * @return code
	 **/
	...
	/**
	 * This is the asset code as per the legacy system. This will be applicable
	 * when doing legacy data entry.
	 * 
	 * @return oldCode
	 **/
	...
	/**
	 * current written down value of the asset when being created or brought in
	 * to the system. This will be same as the original value for the newly
	 * created assets.
	 * 
	 * @return grossValue
	 **/
	...
	/**
	 * Total value of the depreciation already applied on this asset will be the
	...
	/**
	 * version of the assetcategory for which asset is created. This is an
	 * internal field.
	 * 
	 * @return version
	 **/
	...
	/**
	 * Parent asset id of an asset. This will be used when we want to link all
	 * the shops inside a shopping complex. Here both shop and shopping complex
	 * are distict assets.
	 * 
	...
	/**
	 * Enable the year wise Depreciation for an asset. if the value is true then
	 * refer the Depreciation rate from yearWiseDepreciationRate object else
	 * refer to depreciationRate of asset.
	 * 
	...
	/**
	 * Multiple rows can be specified for each asset category, but there should
	 * not be an overlap in the rates for the same financial year.It is required
	 * if enableYearWiseDepreciation is true, if enableYearWiseDepreciation if
	 * false then refer Depreciation from depreciationRate of asset.
	 * 
	...
	/**
	 * The date on which the opening written down value is been captured. This
	 * will be applicable for legacy asset data entry. In case of new assets
	 * this date is not relevant. This will be same as the date of entry.
	 * 
	 * @return openingDate
	 **/
	...
	/**
	 * One asset can be located in one or more land. These land are assets
	 * captured in the same entity.
	 * 
	 * @return landDetails
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.anticipatedLife, asset.anticipatedLife)
				...
				&& Objects.equals(this.remarks, asset.remarks) && Objects.equals(this.version, asset.version)
				...
				&& Objects.equals(this.fundSource, asset.fundSource) && Objects.equals(this.location, asset.location)
	...
	@Override
	public int hashCode() {
		return Objects.hash(anticipatedLife, orderNumber, orderDate, wipReferenceNo, acquiredFrom, warrantyAvailable,
	...
	public String toString() {
		...
		sb.append("    accumulatedDepreciationAccount: ").append(toIndentedString(accumulatedDepreciationAccount))
				.append("\n");
