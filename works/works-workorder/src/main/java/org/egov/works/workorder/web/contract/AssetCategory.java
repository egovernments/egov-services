...
/**
 * Assets are calssified under various asset categories based on their
...
public class AssetCategory {
	...
	/**
	 * if value is true then we can add depreciaiton percentage will need to be
	 * captured.
	 * 
	...
	/**
	 * The unique cide of the unit of measurement that has to be used when
	 * referring any assets coming under this category. This will come from the
	 * UOM master in MDMS.
	 * 
	...
	/**
	 * Depreciation rate for a asset category. That will be always defined in
	 * percentage. This value is required for all categories other than the
	 * Asset category type \"Land\".
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.tenantId, assetCategory.tenantId) && Objects.equals(this.id, assetCategory.id)
				&& Objects.equals(this.name, assetCategory.name) && Objects.equals(this.code, assetCategory.code)
	...
	@Override
	public int hashCode() {
		return Objects.hash(tenantId, id, name, code, assetCategoryType, parent, isDepreciationApplicable,
				depreciationMethod, isAssetAllow, assetAccount, accumulatedDepreciationAccount,
				revaluationReserveAccount, depreciationExpenseAccount, unitOfMeasurement, version, depreciationRate,
