...
public class AssetsForEstimate {
	...
	/**
	 * Asset for which the Detailed Estimate is created. This field is required
	 * and to be shown if Nature of work is 'Repairs or Addition'.
	 * 
	 * @return asset
	 **/
	 ...
	 * and landAssetRequired=true from Abstract Estimate.
	 * 
	 * @return landAsset
	 **/
