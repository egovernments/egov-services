...
public class Boundary {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, boundary.id) && Objects.equals(this.name, boundary.name)
				&& Objects.equals(this.code, boundary.code) && Objects.equals(this.tenantId, boundary.tenantId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, name, code, tenantId, parent, boundaryNum, fromDate, toDate, isHistory, bndryId,
				localName, longitude, latitude, boundaryType, materializedPath, children);
	}
