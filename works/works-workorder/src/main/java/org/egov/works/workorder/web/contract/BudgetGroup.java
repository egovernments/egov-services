...
public class BudgetGroup {
	...
	/**
	 * Whether BudgetGroup is Active or not. If the value is TRUE, then
	 * BudgetGroup is active,If the value is FALSE then BudgetGroup is
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, budgetGroup.id) && Objects.equals(this.name, budgetGroup.name)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, name, description, majorCode, maxCode, minCode, accountType, budgetingType, active,
				auditDetails);
	}
