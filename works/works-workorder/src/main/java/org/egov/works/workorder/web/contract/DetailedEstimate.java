...
public class DetailedEstimate   {
  ...
  @JsonProperty("parent")
  private DetailedEstimate parent = null;
 ...
 @Size(min=2,max=128)
  ...
  public DetailedEstimate estimateNumber(String estimateNumber) {
   ...
   /**
   * Unique number for the Detailed Estimate. If the detailed estimate is spillover then the Detailed Estimate number is user entered. Otherwise it is auto generated.
   * @return estimateNumber
  **/
  @ApiModelProperty(required = true, value = "Unique number for the Detailed Estimate. If the detailed estimate is spillover then the Detailed Estimate number is user entered. Otherwise it is auto generated.")
  @NotNull
  ...
  **/
  ...
  public DetailedEstimate estimateValue(BigDecimal estimateValue) {
   ...
   /**
   * Estimate value (Sum of Schedule A and Schedule B) of the Detailed Estimate
   * @return estimateValue
  **/
  @ApiModelProperty(value = "Estimate value (Sum of Schedule A and Schedule B) of the Detailed Estimate")
  ...
  **/
  ...
  public DetailedEstimate parent(DetailedEstimate parent) {
    this.parent = parent;
    return this;
  }
  ...
  **/
  ...
  public DetailedEstimate getParent() {
    return parent;
  }

  public void setParent(DetailedEstimate parent) {
    this.parent = parent;
  }
  ...
  **/
  ...
  public DetailedEstimate copiedEstimate(Boolean copiedEstimate) {
   ...
   /**
   * Boolean value to identify whether the Detailed Estimate is copied from another estimate. Default value is false.
   * @return copiedEstimate
  **/
  @ApiModelProperty(value = "Boolean value to identify whether the Detailed Estimate is copied from another estimate. Default value is false.")
  ...
  **/
  ...
  public DetailedEstimate workOrderCreated(Boolean workOrderCreated) {
   ...
   /**
   * Boolean value to identify whether the work order created or not for spillover data. Default value is false.
   * @return workOrderCreated
  **/
  @ApiModelProperty(value = "Boolean value to identify whether the work order created or not for spillover data. Default value is false.")
  ...
  public DetailedEstimate billsCreated(Boolean billsCreated) {
   ...
   /**
   * Boolean value to identify whether the bills created or not for spillover data. Default value is false.
   * @return billsCreated
  **/
  @ApiModelProperty(value = "Boolean value to identify whether the bills created or not for spillover data. Default value is false.")
  ...
  public DetailedEstimate spillOverFlag(Boolean spillOverFlag) {
   ...
   /**
   * Boolean value to identify whether the spill over or not. Default value is false.
   * @return spillOverFlag
  **/
  @ApiModelProperty(value = "Boolean value to identify whether the spill over or not. Default value is false.")
