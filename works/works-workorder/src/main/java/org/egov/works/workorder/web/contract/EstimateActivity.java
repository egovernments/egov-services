...
public class EstimateActivity {
	...
	/**
	 * Schedule Of Rate reference of the Estimate Activity. Either Schedule Of
	 * Rate or Non SOR is mandatory for any activity.
	 * 
	...
	/**
	 * Parent Activity in case of Revision Estimate Activity (Additional/Reduced
	 * Quantity). Ref. is pk here.
	 * 
	 * @return parent
	 **/
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, scheduleOfRate, nonSor, uom, unitRate, estimateRate, quantity, serviceTaxPerc,
				revisionType, parent, detailedEstimate, estimateMeasurementSheets, auditDetails);
	}
