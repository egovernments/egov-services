...
public class EstimateMeasurementSheet {
	...
	/**
	 * Parent Estimate Measurement sheet reference for change in quantity of
	 * Revision Estimate
	 * 
	 * @return parent
	 **/
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, slNo, identifier, remarks, number, length, width, depthOrHeight, quantity,
