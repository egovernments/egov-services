...
public class LOAActivity {
	...
	/**
	 * Parent of the Letter Of Acceptance Activity. This is required for
	 * Revision Workrder parent activity.
	 * 
	 * @return parent
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, loAActivity.id) && Objects.equals(this.tenantId, loAActivity.tenantId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, letterOfAcceptanceEstimate, estimateActivity, parent, approvedRate,
				approvedQuantity, approvedAmount, remarks, loaMeasurements, auditDetails);
	}
