...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2018-02-12T12:07:06.082Z")
...
public class LetterOfAcceptance   {
  ...
  @JsonProperty("workOrderExists")
  private Boolean workOrderExists = false;

  @JsonProperty("withAllOfflineStatusAndWONotCreated")
...
//    @Valid
  ...
  **/
  ...
  public LetterOfAcceptance workOrderExists(Boolean workOrderExists) {
    this.workOrderExists = workOrderExists;
    return this;
  }

   /**
   * If WorkOrder is created for a this LOA, value will be updated to true.
   * @return workOrderExists
  **/
  @ApiModelProperty(value = "If WorkOrder is created for a this LOA, value will be updated to true.")


  public Boolean getWorkOrderExists() {
    return workOrderExists;
  }

  public void setWorkOrderExists(Boolean workOrderExists) {
    this.workOrderExists = workOrderExists;
  }

  public LetterOfAcceptance withAllOfflineStatusAndWONotCreated(Boolean withAllOfflineStatusAndWONotCreated) {
    this.withAllOfflineStatusAndWONotCreated = withAllOfflineStatusAndWONotCreated;
    return this;
  }

   /**
   * If Offline Status is created for a this LOA, value will be updated to true.
   * @return withAllOfflineStatusAndWONotCreated
  **/
  @ApiModelProperty(value = "If Offline Status is created for a this LOA, value will be updated to true.")


  public Boolean getWithAllOfflineStatusAndWONotCreated() {
    return withAllOfflineStatusAndWONotCreated;
  }

  public void setWithAllOfflineStatusAndWONotCreated(Boolean withAllOfflineStatusAndWONotCreated) {
    this.withAllOfflineStatusAndWONotCreated = withAllOfflineStatusAndWONotCreated;
  }

  public LetterOfAcceptance withoutOfflineStatus(Boolean withoutOfflineStatus) {
    this.withoutOfflineStatus = withoutOfflineStatus;
    return this;
  }

   /**
   * LOA created and not even one offline status is updated, value will be updated to true.
   * @return withoutOfflineStatus
  **/
  @ApiModelProperty(value = "LOA created and not even one offline status is updated, value will be updated to true.")
  ...
  public LetterOfAcceptance milestoneExists(Boolean milestoneExists) {
    this.milestoneExists = milestoneExists;
    return this;
  }

   /**
   * If Milestone is created for a this LOA, value will be updated to true.
   * @return milestoneExists
  **/
  @ApiModelProperty(value = "If Milestone is created for a this LOA, value will be updated to true.")
  ...
  public LetterOfAcceptance billExists(Boolean billExists) {
    this.billExists = billExists;
    return this;
  }

   /**
   * If bill is created for a this LOA, value will be updated to true.
   * @return billExists
  **/
  @ApiModelProperty(value = "If bill is created for a this LOA, value will be updated to true.")
  ...
  public LetterOfAcceptance contractorAdvanceExists(Boolean contractorAdvanceExists) {
    this.contractorAdvanceExists = contractorAdvanceExists;
    return this;
  }

   /**
   * If ARF is created for a this LOA, value will be updated to true.
   * @return contractorAdvanceExists
  **/
  @ApiModelProperty(value = "If ARF is created for a this LOA, value will be updated to true.")
  ...
  public LetterOfAcceptance mbExistsAndBillNotCreated(Boolean mbExistsAndBillNotCreated) {
    this.mbExistsAndBillNotCreated = mbExistsAndBillNotCreated;
    return this;
  }

   /**
   * If MB is created for a this LOA but bill not exists, value will be updated to true.
   * @return mbExistsAndBillNotCreated
  **/
  @ApiModelProperty(value = "If MB is created for a this LOA but bill not exists, value will be updated to true.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, letterOfAcceptance.id) &&
        ...
        Objects.equals(this.workOrderExists, letterOfAcceptance.workOrderExists) &&
        Objects.equals(this.withAllOfflineStatusAndWONotCreated, letterOfAcceptance.withAllOfflineStatusAndWONotCreated) &&
        Objects.equals(this.withoutOfflineStatus, letterOfAcceptance.withoutOfflineStatus) &&
        Objects.equals(this.milestoneExists, letterOfAcceptance.milestoneExists) &&
        Objects.equals(this.billExists, letterOfAcceptance.billExists) &&
        Objects.equals(this.contractorAdvanceExists, letterOfAcceptance.contractorAdvanceExists) &&
        Objects.equals(this.mbExistsAndBillNotCreated, letterOfAcceptance.mbExistsAndBillNotCreated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, contractor, loaDate, loaNumber, contractPeriod, emdAmountDeposited, stampPaperAmount, engineerIncharge, defectLiabilityPeriod, loaAmount, documentDetails, status, tenderFinalizedPercentage, approvedBy, approvedDate, fileNumber, fileDate, parent, stateId, cancellationReason, cancellationRemarks, councilResolutionNumber, councilResolutionDate, spillOverFlag, letterOfAcceptanceEstimates, securityDeposits, workFlowDetails, auditDetails, deleted, workOrderExists, withAllOfflineStatusAndWONotCreated, withoutOfflineStatus, milestoneExists, billExists, contractorAdvanceExists, mbExistsAndBillNotCreated);
  }
  ...
  public String toString() {
    ...
    sb.append("    workOrderExists: ").append(toIndentedString(workOrderExists)).append("\n");
    sb.append("    withAllOfflineStatusAndWONotCreated: ").append(toIndentedString(withAllOfflineStatusAndWONotCreated)).append("\n");
