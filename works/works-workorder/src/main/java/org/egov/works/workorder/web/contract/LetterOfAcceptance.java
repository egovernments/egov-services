...
public class LetterOfAcceptance   {
  ...
  **/
  ...
  public LetterOfAcceptance loaDate(Long loaDate) {
   ...
   /**
   * Epoch time of LOA Date. Default the current date for new LOA and do not allow to modify. This field is user entered for spillover LOA. Allowed to edit during rejected status or drafts for LOA. Future date is not allowed to enter in this field. LOA date should be on or after the L1 Tender Finalized status date of Detailed Estimate.
   * @return loaDate
  **/
  ...
  public LetterOfAcceptance loaNumber(String loaNumber) {
   ...
   /**
   * Unique LOA Number of the Letter Of Acceptance. If the LOA is spillover then the LOA number is user entered. Otherwise it is auto generated. This field is allowed to edit during rejected status or drafts for Spillover LOA.
   * @return loaNumber
  **/
...
//  @NotNull
  ...
  **/
  ...
  public LetterOfAcceptance approvedDate(Long approvedDate) {
   ...
   /**
   * Epoch time of Date on which Letter Of Acceptance approved. Future date is not allowed. LOA Approved date should be on or after the LOA date.
   * @return approvedDate
  **/
 ...
 @Pattern(regexp="[0-9a-zA-Z-/]+") @Size(max=50)
  ...
  public LetterOfAcceptance councilResolutionDate(Long councilResolutionDate) {
   ...
   /**
   * Epoch time of the council resolution date of the Letter Of Acceptance. The future date is now allowed. This field is required on final approval of LOA.
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, contractor, loaDate, loaNumber, contractPeriod, emdAmountDeposited, stampPaperAmount, engineerIncharge, defectLiabilityPeriod, loaAmount, documentDetails, status, tenderFinalizedPercentage, approvedDate, fileNumber, fileDate, parent, stateId, cancellationReason, cancellationRemarks, councilResolutionNumber, councilResolutionDate, spillOverFlag, letterOfAcceptanceEstimates, securityDeposits, workFlowDetails, auditDetails, deleted);
  }
