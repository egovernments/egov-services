...
public class LetterOfAcceptance   {
  ...
  **/
  ...
  public LetterOfAcceptance loaDate(Long loaDate) {
   ...
   /**
   * Epoch time of LOA Date
   * @return loaDate
  **/
  @ApiModelProperty(required = true, value = "Epoch time of LOA Date")
  @NotNull
  ...
  public LetterOfAcceptance loaNumber(String loaNumber) {
   ...
   /**
   * LOA Number of the Letter Of Acceptance. Manually enetered in case of Spillover LOA and autogenerated in case of regular LOA.
   * @return loaNumber
  **/
  @ApiModelProperty(required = true, value = "LOA Number of the Letter Of Acceptance. Manually enetered in case of Spillover LOA and autogenerated in case of regular LOA.")
  @NotNull
  ...
  **/
  ...
  public LetterOfAcceptance engineerIncharge(String engineerIncharge) {
   ...
   /**
   * User who is incharge of the work, primary key is ref. here.
   * @return engineerIncharge
  **/
  @ApiModelProperty(required = true, value = "User who is incharge of the work, primary key is ref. here.")
  @NotNull
  ...
  **/
  ...
  public LetterOfAcceptance approvedDate(Long approvedDate) {
   ...
   /**
   * Epoch time of Date on which Letter Of Acceptance approved.
   * @return approvedDate
  **/
  @ApiModelProperty(value = "Epoch time of Date on which Letter Of Acceptance approved.")
  ...
  **/
  ...
  public LetterOfAcceptance fileDate(Long fileDate) {
   ...
   /**
   * Epoch time of File Date of the Letter Of Acceptance.
   * @return fileDate
  **/
  @ApiModelProperty(required = true, value = "Epoch time of File Date of the Letter Of Acceptance.")
  @NotNull
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, contractor, loaDate, loaNumber, contractPeriod, emdAmountDeposited, engineerIncharge, defectLiabilityPeriod, loaAmount, documentDetails, status, tenderFinalizedPercentage, approvedDate, fileNumber, fileDate, parent, stateId, cancellationReason, cancellationRemarks, letterOfAcceptanceEstimates, securityDeposits, workFlowDetails, auditDetails);
  }
