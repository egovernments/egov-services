...
public class LetterOfAcceptanceEstimate   {
 ...
 @Size(min=2,max=128)
  ...
  public LetterOfAcceptanceEstimate letterOfAcceptance(String letterOfAcceptance) {
   ...
   /**
   * reference of 'LetterOfAcceptance'. Pimary key is ref. here.
   * @return letterOfAcceptance
  **/
  @ApiModelProperty(required = true, value = "reference of 'LetterOfAcceptance'. Pimary key is ref. here.")
  @NotNull
  ...
  public LetterOfAcceptanceEstimate detailedEstimate(String detailedEstimate) {
   ...
   /**
   * Detailed Estimate reference. estimate number is ref. here.
   * @return detailedEstimate
  **/
  @ApiModelProperty(required = true, value = "Detailed Estimate reference. estimate number is ref. here.")
  @NotNull
