...
public class Milestone   {
  ...
  **/
  ...
  public Milestone status(WorksStatus status) {
    this.status = status;
    return this;
  }
 ...
 @Pattern(regexp="[0-9a-zA-Z_@./#&+-/!(){}\",^$%*|=;:<>?`~ ]+") @Size(max=512)
  ...
  public Milestone deleted(Boolean deleted) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, milestone.id) &&
        ...
        Objects.equals(this.deleted, milestone.deleted) &&
        Objects.equals(this.auditDetails, milestone.auditDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, letterOfAcceptanceEstimate, status, milestoneActivities, trackMilestones, cancellationReason, cancellationRemarks, deleted, auditDetails);
  }
