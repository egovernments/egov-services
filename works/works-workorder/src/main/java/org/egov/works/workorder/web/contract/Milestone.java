...
public class Milestone {
	...
	/**
	 * Reason for cancellation of the Milestone, Required only while cancelling
	 * Milestone
	 * 
	...
	/**
	 * Remarks for cancellation of the Milestone, Required only while cancelling
	 * Milestone
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, milestone.id) && Objects.equals(this.tenantId, milestone.tenantId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, letterOfAcceptanceEstimate, status, milestoneActivities, trackMilestones,
				cancellationReason, cancellationRemarks, auditDetails);
	}
