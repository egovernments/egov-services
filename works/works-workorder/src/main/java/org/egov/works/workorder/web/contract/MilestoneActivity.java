...
/**
 * An Object that holds Activity for the given Milestone. At least one data
...
public class MilestoneActivity {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, milestone, scheduleStartDate, scheduleEndDate, percentage, description,
				stageOrderNumber, auditDetails);
	}
