...
public class TrackMilestone {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, trackMilestone.id) && Objects.equals(this.tenantId, trackMilestone.tenantId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, milestone, status, totalPercentage, projectCompleted,
				trackMilestoneActivities, auditDetails);
	}
