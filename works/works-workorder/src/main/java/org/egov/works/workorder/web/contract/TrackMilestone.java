...
public class TrackMilestone   {
  ...
  **/
  ...
  public TrackMilestone status(WorksStatus status) {
    this.status = status;
    return this;
  }
 ...
 @Size(min=1)
  ...
  public TrackMilestone deleted(Boolean deleted) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, trackMilestone.id) &&
        ...
        Objects.equals(this.deleted, trackMilestone.deleted) &&
        Objects.equals(this.auditDetails, trackMilestone.auditDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, milestone, status, totalPercentage, projectCompleted, trackMilestoneActivities, deleted, auditDetails);
  }
