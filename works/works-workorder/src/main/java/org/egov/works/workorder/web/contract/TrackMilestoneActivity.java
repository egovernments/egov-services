...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2017-12-20T11:45:51.707Z")
...
public class TrackMilestoneActivity   {
 ...
 @Pattern(regexp="[0-9a-zA-Z_@./#&+-/!(){}\",^$%*|=;:<>?`~ ]+") @Size(min=4,max=1024)
  ...
  **/
  ...
  public TrackMilestoneActivity actualStartDate(Long actualStartDate) {
    this.actualStartDate = actualStartDate;
    return this;
  }

   /**
   * Epoch time of the actual stat date for the milestone.
   * @return actualStartDate
  **/
  @ApiModelProperty(required = true, value = "Epoch time of the actual stat date for the milestone.")
  @NotNull
  ...
  public TrackMilestoneActivity actualEndDate(Long actualEndDate) {
    this.actualEndDate = actualEndDate;
    return this;
  }

   /**
   * Epoch time of the actual end date for the milestone.
   * @return actualEndDate
  **/
  @ApiModelProperty(value = "Epoch time of the actual end date for the milestone.")
  ...
  public TrackMilestoneActivity status(WorksStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, trackMilestoneActivity.id) &&
        ...
        Objects.equals(this.actualStartDate, trackMilestoneActivity.actualStartDate) &&
        Objects.equals(this.actualEndDate, trackMilestoneActivity.actualEndDate) &&
        Objects.equals(this.status, trackMilestoneActivity.status) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, trackMilestone, milestoneActivity, remarks, percentage, actualStartDate, actualEndDate, status, auditDetails, deleted);
  }
