...
public class LetterofacceptancesApiController implements LetterofacceptancesApi {
    ...
    public ResponseEntity<LetterOfAcceptanceResponse> letterofacceptancesCreatePost(@ApiParam(value = "Details of new Letter Of Acceptance(s) + RequestInfo meta data." ,required=true )  @Valid @RequestBody LetterOfAcceptanceRequest letterOfAcceptanceRequest) {
        // do some magic!
    ...
    public ResponseEntity<LetterOfAcceptanceResponse> letterofacceptancesUpdatePost(@ApiParam(value = "Details of Letter Of Acceptance(s) + RequestInfo meta data." ,required=true )  @Valid @RequestBody LetterOfAcceptanceRequest letterOfAcceptanceRequest) {
        // do some magic!
        return new ResponseEntity<LetterOfAcceptanceResponse>(HttpStatus.OK);
    }
