...
public interface NoticesApi {
    ...
    ResponseEntity<NoticeResponse> noticesCreatePost(@ApiParam(value = "Details of new Notice(s) + RequestInfo meta data." ,required=true )  @Valid @RequestBody NoticeRequest noticeRequest);
    ...
    @RequestMapping(value = "/notices/_update",
        method = RequestMethod.POST)
    ResponseEntity<NoticeResponse> noticesUpdatePost(@ApiParam(value = "Details of Notice(s) + RequestInfo meta data." ,required=true )  @Valid @RequestBody NoticeRequest noticeRequest);
