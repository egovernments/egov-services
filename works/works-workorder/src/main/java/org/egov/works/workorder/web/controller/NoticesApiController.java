...
public class NoticesApiController implements NoticesApi {
    ...
    public ResponseEntity<NoticeResponse> noticesSearchPost( @NotNull@ApiParam(value = "Unique id for a tenant.", required = true) @RequestParam(value = "tenantId", required = true) String tenantId,
		...
		NoticeSearchContract noticeSearchContract = NoticeSearchContract.builder().contractorCodes(contractorCodes)
				...
				.workIdentificationNumbers(workIdentificationNumbers).workOrderNumbers(workOrderNumbers).build();
