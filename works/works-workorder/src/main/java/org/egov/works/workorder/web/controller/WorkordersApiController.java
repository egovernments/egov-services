...
public class WorkordersApiController implements WorkordersApi {
    ...
    public ResponseEntity<WorkOrderResponse> workordersCreatePost(@ApiParam(value = "Details of new Work Order(s) + RequestInfo meta data." ,required=true )  @Valid @RequestBody WorkOrderRequest workOrderRequest) {
